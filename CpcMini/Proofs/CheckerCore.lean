...
by
  ...
  cases h with
  | intro_true _ hEval =>
      rw [Smtm.__smtx_model_eval.eq_Boolean] at hEval
      cases hEval
  ...
  | intro_true htyImp hEvalImp =>
      ...
      | intro_true htyA hEvalA =>
          have htyB : __smtx_typeof (__eo_to_smt B) = SmtType.Bool := by
            ...
            exact
              (bool_binop_args_bool_of_non_none
                (op := SmtTerm.imp) (Smtm.__smtx_typeof.eq_imp (__eo_to_smt A) (__eo_to_smt B)) hNN).2
          have hEvalB : __smtx_model_eval M (__eo_to_smt B) = SmtValue.Boolean true := by
            rw [Smtm.__smtx_model_eval.eq_imp] at hEvalImp
            cases hBeval : __smtx_model_eval M (__eo_to_smt B) <;>
...
by
  ...
  | intro_true htyA hEvalA =>
      ...
      | intro_true htyB hEvalB =>
          apply smt_interprets.intro_true
          · simp [Smtm.__smtx_typeof.eq_imp, htyA, htyB, native_Teq, native_ite]
          · simp [Smtm.__smtx_model_eval.eq_imp, __smtx_model_eval_imp, __smtx_model_eval_or,
...
by
  ...
  | intro_false htyImp hEvalImp =>
      have htyA : __smtx_typeof (__eo_to_smt A) = SmtType.Bool := by
        ...
        exact
          (bool_binop_args_bool_of_non_none
            (op := SmtTerm.imp) (Smtm.__smtx_typeof.eq_imp (__eo_to_smt A) (__eo_to_smt B)) hNN).1
      have hEvalA : __smtx_model_eval M (__eo_to_smt A) = SmtValue.Boolean true := by
        rw [Smtm.__smtx_model_eval.eq_imp] at hEvalImp
        cases hAeval : __smtx_model_eval M (__eo_to_smt A) <;>
          cases hBeval : __smtx_model_eval M (__eo_to_smt B) <;>
          ...
          have htyB : __smtx_typeof (__eo_to_smt B) = SmtType.Bool := by
            ...
            exact
              (bool_binop_args_bool_of_non_none
                (op := SmtTerm.and) (Smtm.__smtx_typeof.eq_and (__eo_to_smt A) (__eo_to_smt B)) hNN).2
          have hEvalB : __smtx_model_eval M (__eo_to_smt B) = SmtValue.Boolean true := by
            rw [Smtm.__smtx_model_eval.eq_and] at hEvalAnd
            cases hBeval : __smtx_model_eval M (__eo_to_smt B) <;>
