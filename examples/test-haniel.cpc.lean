...
(Term.Boolean true))))))
(CCmdList.cons (CCmd.and_elim (Term.Numeral 0) (Term.Numeral 2))
(CCmdList.cons (CCmd.check_proven t8)
(CCmdList.cons (CCmd.chain_m_resolution t10 t15 (Term.Apply (Term.Apply Term.__eo_List_cons t8) Term.__eo_List_nil) (CIndexList.cons (Term.Numeral 2) (CIndexList.cons (Term.Numeral 0) CIndexList.nil)))
...
(CCmdList.cons (CCmd.reordering t17 (Term.Numeral 0))
(CCmdList.cons (CCmd.check_proven t17)
(CCmdList.cons (CCmd.chain_m_resolution t9 t15 (Term.Apply (Term.Apply Term.__eo_List_cons t10) Term.__eo_List_nil) (CIndexList.cons (Term.Numeral 0) (CIndexList.cons (Term.Numeral 2) CIndexList.nil)))
(CCmdList.cons (CCmd.check_proven t9)
(CCmdList.cons (CCmd.chain_m_resolution t14 t15 (Term.Apply (Term.Apply Term.__eo_List_cons t9) Term.__eo_List_nil) (CIndexList.cons (Term.Numeral 5) (CIndexList.cons (Term.Numeral 0) CIndexList.nil)))
(CCmdList.cons (CCmd.check_proven t14)
(CCmdList.cons (CCmd.assume_push t4)
(CCmdList.cons (CCmd.assume_push t7)
(CCmdList.cons (CCmd.cong t12 (CIndexList.cons (Term.Numeral 12) (CIndexList.cons (Term.Numeral 11) CIndexList.nil)))
(CCmdList.cons (CCmd.check_proven t13)
(CCmdList.cons (CCmd.scope (Term.Numeral 0))
(CCmdList.cons (CCmd.scope (Term.Numeral 0))
(CCmdList.cons (CCmd.process_scope t13 (Term.Numeral 0))
(CCmdList.cons (CCmd.check_proven (Term.Apply (Term.Apply Term.imp t18) t13))
(CCmdList.cons (CCmd.implies_elim (Term.Numeral 0))
...
(CCmdList.cons (CCmd.resolution (Term.Boolean true) t18 (Term.Numeral 0) (Term.Numeral 1))
...
(CCmdList.cons (CCmd.reordering t21 (Term.Numeral 0))
(CCmdList.cons (CCmd.check_proven t21)
(CCmdList.cons (CCmd.chain_m_resolution (Term.Boolean false) (Term.Apply (Term.Apply Term.__eo_List_cons (Term.Boolean true)) (Term.Apply (Term.Apply Term.__eo_List_cons (Term.Boolean false)) (Term.Apply (Term.Apply Term.__eo_List_cons (Term.Boolean false)) Term.__eo_List_nil))) (Term.Apply (Term.Apply Term.__eo_List_cons t13) (Term.Apply (Term.Apply Term.__eo_List_cons t7) (Term.Apply (Term.Apply Term.__eo_List_cons t4) Term.__eo_List_nil))) (CIndexList.cons (Term.Numeral 0) (CIndexList.cons (Term.Numeral 6) (CIndexList.cons (Term.Numeral 15) (CIndexList.cons (Term.Numeral 16) CIndexList.nil)))))
