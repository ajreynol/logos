...
(Eo.CCmdList.cons (Eo.CCmd.chain_m_resolution t10 t15 (Eo.Term.Apply (Eo.Term.Apply Eo.Term.__eo_List_cons t8) Eo.Term.__eo_List_nil) (CIndexList.cons (Eo.Term.Numeral 2) (CIndexList.cons (Eo.Term.Numeral 0) CIndexList.nil)))
...
(Eo.CCmdList.cons (Eo.CCmd.chain_m_resolution t9 t15 (Eo.Term.Apply (Eo.Term.Apply Eo.Term.__eo_List_cons t10) Eo.Term.__eo_List_nil) (CIndexList.cons (Eo.Term.Numeral 0) (CIndexList.cons (Eo.Term.Numeral 2) CIndexList.nil)))
(Eo.CCmdList.cons (Eo.CCmd.check_proven t9)
(Eo.CCmdList.cons (Eo.CCmd.chain_m_resolution t14 t15 (Eo.Term.Apply (Eo.Term.Apply Eo.Term.__eo_List_cons t9) Eo.Term.__eo_List_nil) (CIndexList.cons (Eo.Term.Numeral 5) (CIndexList.cons (Eo.Term.Numeral 0) CIndexList.nil)))
(Eo.CCmdList.cons (Eo.CCmd.check_proven t14)
(Eo.CCmdList.cons (Eo.CCmd.assume_push t4)
(Eo.CCmdList.cons (Eo.CCmd.assume_push t7)
(Eo.CCmdList.cons (Eo.CCmd.cong t12 (CIndexList.cons (Eo.Term.Numeral 12) (CIndexList.cons (Eo.Term.Numeral 11) CIndexList.nil)))
...
(Eo.CCmdList.cons (Eo.CCmd.chain_m_resolution (Eo.Term.Boolean false) (Eo.Term.Apply (Eo.Term.Apply Eo.Term.__eo_List_cons (Eo.Term.Boolean true)) (Eo.Term.Apply (Eo.Term.Apply Eo.Term.__eo_List_cons (Eo.Term.Boolean false)) (Eo.Term.Apply (Eo.Term.Apply Eo.Term.__eo_List_cons (Eo.Term.Boolean false)) Eo.Term.__eo_List_nil))) (Eo.Term.Apply (Eo.Term.Apply Eo.Term.__eo_List_cons t13) (Eo.Term.Apply (Eo.Term.Apply Eo.Term.__eo_List_cons t7) (Eo.Term.Apply (Eo.Term.Apply Eo.Term.__eo_List_cons t4) Eo.Term.__eo_List_nil))) (CIndexList.cons (Eo.Term.Numeral 0) (CIndexList.cons (Eo.Term.Numeral 6) (CIndexList.cons (Eo.Term.Numeral 15) (CIndexList.cons (Eo.Term.Numeral 16) CIndexList.nil)))))
