...
Logos is a proof checker for SMT, written in Lean, with a corresponding correctness specification.
This specification involves a complete definition of the semantics of SMT-LIB in Lean.
