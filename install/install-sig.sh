...
;
; The calculus it records is defined by the cvc5 project
; (https://github.com/cvc5/cvc5) and the copyright of the signature is held by
; the cvc5 authors. See the files COPYING and AUTHORS.
;
