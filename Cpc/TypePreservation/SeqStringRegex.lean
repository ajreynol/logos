...
theorem set_binop_args_of_non_none
  ...
  | Map A B =>
      ...
      | Map C D =>
          cases B <;> cases D <;>
            simp [hTy, __smtx_typeof_sets_op_2, smt_lit_ite, smt_lit_Teq, h1, h2] at ht
          have hEq : A = C := by
...
theorem set_binop_ret_args_of_non_none
  ...
  | Map A B =>
      ...
      | Map C D =>
          cases B <;> cases D <;>
            simp [hTy, __smtx_typeof_sets_op_2_ret, smt_lit_ite, smt_lit_Teq, h1, h2] at ht
...
theorem set_member_args_of_non_none
  ...
  | Map A B =>
      ...
      | _ =>
          simp [__smtx_typeof, __smtx_typeof_set_member, smt_lit_ite, smt_lit_Teq, h2] at ht
  | _ =>
      simp [__smtx_typeof, __smtx_typeof_set_member, smt_lit_ite, smt_lit_Teq, h2] at ht
...
theorem seq_cons_typed_of_typeof_seq_value
  ...
  by_cases hEq :
      smt_lit_Teq (SmtType.Seq (__smtx_typeof_value v)) (__smtx_typeof_seq_value vs)
