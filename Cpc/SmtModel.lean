...
def __smtx_dtc_num_sels : SmtDatatypeCons -> smt_lit_Int
  | (SmtDatatypeCons.cons U c) => (smt_lit_zplus (__smtx_dtc_num_sels c) 1)
  | SmtDatatypeCons.unit => 0


def __smtx_dt_num_sels : SmtDatatype -> smt_lit_Int -> smt_lit_Int
...
def __smtx_model_eval_rotate_left : SmtValue -> SmtValue -> SmtValue
  | (SmtValue.Numeral x1), x2 => (smt_lit_ite (smt_lit_zleq 0 x1) (__smtx_model_eval_rotate_left_rec (smt_lit_int_to_nat x1) x2) SmtValue.NotValue)
  | t1, t2 => SmtValue.NotValue
...
def __smtx_model_eval_rotate_right : SmtValue -> SmtValue -> SmtValue
  | (SmtValue.Numeral x1), x2 => (smt_lit_ite (smt_lit_zleq 0 x1) (__smtx_model_eval_rotate_right_rec (smt_lit_int_to_nat x1) x2) SmtValue.NotValue)
  | t1, t2 => SmtValue.NotValue
...
def __smtx_model_eval_re_exp : SmtValue -> SmtValue -> SmtValue
  | (SmtValue.Numeral x1), (SmtValue.RegLan x2) => (smt_lit_ite (smt_lit_zleq 1 x1) (__smtx_model_eval_re_exp_rec (smt_lit_int_to_nat x1) (SmtValue.RegLan x2)) SmtValue.NotValue)
  | t1, t2 => SmtValue.NotValue
...
def __smtx_model_eval_re_loop : SmtValue -> SmtValue -> SmtValue -> SmtValue
  | (SmtValue.Numeral x1), (SmtValue.Numeral x2), (SmtValue.RegLan x3) => (smt_lit_ite (smt_lit_zleq 1 x1) (smt_lit_ite (smt_lit_zleq 1 x2) (__smtx_model_eval_ite (__smtx_model_eval_gt (SmtValue.Numeral x1) (SmtValue.Numeral x2)) (SmtValue.RegLan smt_lit_re_none) (__smtx_model_eval_re_loop_rec (smt_lit_int_to_nat (smt_lit_zplus x2 (smt_lit_zneg x1))) (SmtValue.Numeral x1) (SmtValue.Numeral x2) (SmtValue.RegLan x3))) SmtValue.NotValue) SmtValue.NotValue)
  | t1, t2, t3 => SmtValue.NotValue
