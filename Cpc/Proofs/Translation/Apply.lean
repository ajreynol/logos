...
private theorem eo_to_smt_array_deq_diff_fun_like_domains_field_wf
  ...
  all_goals
    ...
    | exact smtx_typeof_map_diff_fun_like_domains_field_wf_of_non_none
        ...
        (by simpa [__eo_to_smt_array_deq_diff, hy, hz] using hNN)
    | exfalso
      unfold term_has_non_none_type at hNN
      exact hNN (by simp [__eo_to_smt_array_deq_diff, hy, hz])
...
private theorem eo_to_smt_sets_deq_diff_fun_like_domains_field_wf
  ...
  all_goals
    ...
    | exact smtx_typeof_map_diff_fun_like_domains_field_wf_of_non_none
        (__eo_to_smt y) (__eo_to_smt z)
        (by simpa [__eo_to_smt_sets_deq_diff, hy, hz] using hNN)
    | exfalso
      unfold term_has_non_none_type at hNN
...
private theorem eo_to_smt_type_tuple_eq_tuple_datatype_of_wf
  ...
  case Datatype s d =>
      ...
      | sum c rest =>
          ...
          | null =>
              ...
              · exact ⟨
                  ...
                  by
                    simp [__eo_to_smt_type_tuple, hComp, native_streq,
    ...
    · cases d with
      | null =>
          simp [__eo_to_smt_type_tuple, hs, __smtx_type_wf,
            __smtx_type_wf_rec, native_and] at hWf
      | sum c rest =>
          cases rest <;> simp [__eo_to_smt_type_tuple, hs, __smtx_type_wf,
            __smtx_type_wf_rec, native_streq, native_and, native_ite] at hWf
...
private theorem eo_to_smt_typeof_matches_translation_apply_tuple_of_tail_type
  ...
  have hEo :
    ...
    simp [__eo_requires, hXTailLenOk, hYNotStuck, hXNotStuck, native_ite,
      native_teq, native_not, SmtEval.native_not]
    rw [← hYEq]
    simp [headTy, hRaw, hRawWf, hFullWf, native_ite]
  exact hSmt.trans hEo.symm
    ...
    case _at_witness_string_length =>
      ...
      exact eo_to_smt_typeof_matches_translation_apply_generic_from_ih_of_valid
        ...
        (generic_apply_type_of_non_special_head _ _
          (by
            intro s d i j h
            change native_ite (native_Teq (__smtx_typeof (__eo_to_smt w)) SmtType.Int)
