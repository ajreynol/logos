...
private theorem __eo_to_smt_guard_closed_eq_of_ne_none
    {x : Term} {body target : SmtTerm}
    (h : __eo_to_smt_guard_closed x body = target)
    (hTarget : target ≠ SmtTerm.None) :
    body = target := by
  cases hx : native_eo_to_smt_closed x
  · exfalso
    apply hTarget
    simpa [__eo_to_smt_guard_closed, native_ite, hx] using h.symm
  · simpa [__eo_to_smt_guard_closed, native_ite, hx] using h

private theorem smtx_typeof_guard_closed_eq_of_non_none
    {x : Term} {body : SmtTerm}
    (hNN : __smtx_typeof (__eo_to_smt_guard_closed x body) ≠
      SmtType.None) :
  ...
  · exfalso
    apply hNN
    simp [__eo_to_smt_guard_closed, native_ite, hx, smtx_typeof_none]
  · simp [__eo_to_smt_guard_closed, native_ite, hx]

private theorem smtx_typeof_body_non_none_of_guard_closed
    {x : Term} {body : SmtTerm}
    (hNN : __smtx_typeof (__eo_to_smt_guard_closed x body) ≠
      SmtType.None) :
    __smtx_typeof body ≠ SmtType.None := by
  intro hNone
  have hEq := smtx_typeof_guard_closed_eq_of_non_none (x := x) (body := body) hNN
  exact hNN (by simpa [hEq] using hNone)

private theorem __eo_to_smt_guard_closed_eq_body_of_non_none
    {x : Term} {body : SmtTerm}
    (hNN : __smtx_typeof (__eo_to_smt_guard_closed x body) ≠
      SmtType.None) :
    __eo_to_smt_guard_closed x body = body := by
  cases hx : native_eo_to_smt_closed x
  · exfalso
    apply hNN
    simp [__eo_to_smt_guard_closed, native_ite, hx, smtx_typeof_none]
...
private theorem eo_to_smt_distinct_ne_dt_sel
  ...
  intro h
  unfold __eo_to_smt_distinct at h
...
private theorem eo_to_smt_array_deq_diff_ne_dt_sel
    (a b : SmtTerm) (s : native_String) (d : SmtDatatype)
    (i j : native_Nat) :
...
private theorem eo_to_smt_tuple_prepend_of_type_ne_dt_sel
    ...
    (tail : SmtTerm) (s : native_String) (d : SmtDatatype)
    (i j : native_Nat) :
  ...
  case Datatype sTail dTail =>
    by_cases hs : sTail = (native_string_lit "@Tuple")
    · subst sTail
      cases dTail with
      | null =>
          simp at h
                  ...
                  __smtx_type_wf
                    (SmtType.Datatype (native_string_lit "@Tuple")
                      (SmtDatatype.sum (SmtDatatypeCons.cons headTy c)
                        SmtDatatype.null)) <;>
                  simp [native_streq,
                    native_and, native_ite, hWf] at h
              exact
                eo_to_smt_tuple_prepend_rec_ne_dt_sel
                  ...
                  (SmtTerm.Apply
                    ...
                    head)
                  (by intro s0 d0 i0 j0 hSeed; cases hSeed)
                  s d i j h
          | sum cRest restRest =>
              simp at h
    · cases dTail with
          ...
          | null =>
              cases hWf :
                ...
                simp [native_streq,
                  native_and, native_ite, hWf] at h
              exact
                eo_to_smt_tuple_prepend_rec_ne_dt_tester
                  (SmtDatatype.sum c SmtDatatype.null) tail
                  (__smtx_dt_num_sels (SmtDatatype.sum c SmtDatatype.null)
                    native_nat_zero)
                  (SmtTerm.Apply
                    (SmtTerm.DtCons (native_string_lit "@Tuple")
                      (SmtDatatype.sum (SmtDatatypeCons.cons headTy c)
                        SmtDatatype.null) native_nat_zero)
                    head)
                  (by intro s0 d0 i0 hSeed; cases hSeed)
                  s d i h
          | sum cRest restRest =>
              simp at h
    · cases dTail with
          ...
          | null =>
              cases hWf :
                ...
                simp [native_streq,
                  native_and, native_ite, hWf] at h
              exact
                eo_to_smt_tuple_prepend_rec_ne_dt_cons
                  (SmtDatatype.sum c SmtDatatype.null) tail
                  (__smtx_dt_num_sels (SmtDatatype.sum c SmtDatatype.null)
                    native_nat_zero)
                  (SmtTerm.Apply
  ...
  case Apply f arg =>
    ...
    case Apply g vars =>
      ...
      case UOp op =>
        ...
        case «forall» =>
          cases hst : __eo_to_smt (Term.Apply (Term.Apply (Term.UOp UserOp.forall) vars) arg) <;>
            simp [__eo_to_smt_qs_choice, hst] at h
          case not t =>
            cases t <;> cases h
...
private theorem eo_to_smt_set_insert_top_ne_dt_sel
  ...
  intro h
  unfold __eo_to_smt at h
  unfold __eo_to_smt_set_insert at h
  cases xs <;> try cases h
  case Apply f tail =>
    cases f <;> try cases h
    case Apply g head =>
...
private theorem eo_to_smt_exists_top_ne_dt_sel
  ...
  intro h
  unfold __eo_to_smt at h
  unfold __eo_to_smt_exists at h
  cases xs <;> try cases h
  case Apply f vs =>
    cases f <;> try cases h
    case Apply g v =>
...
private theorem eo_to_smt_quant_skolemize_top_ne_dt_sel
  ...
  unfold __eo_to_smt at h
  have hBody :=
    __eo_to_smt_guard_closed_eq_of_ne_none h
...
theorem eo_to_smt_apply_ne_dt_sel
  ...
  case UOp op =>
    cases op <;> try cases h
    case distinct =>
      exact eo_to_smt_distinct_top_ne_dt_sel x s d i j (by
        unfold __eo_to_smt
        exact h)
    case _at_bvsize =>
  ...
  case Apply g y =>
    ...
    case UOp op =>
      cases op <;> try cases h
      case set_insert =>
        exact eo_to_smt_set_insert_top_ne_dt_sel _ _ _ _ _ _ (by
          unfold __eo_to_smt
          exact h)
      case «forall» =>
        exact eo_to_smt_forall_top_ne_dt_sel _ _ _ _ _ _ (by
          unfold __eo_to_smt
          exact h)
      case «exists» =>
        exact eo_to_smt_exists_top_ne_dt_sel _ _ _ _ _ _ (by
          unfold __eo_to_smt
          exact h)
      case tuple =>
        exact eo_to_smt_tuple_ne_dt_sel x y s d i j (by
          unfold __eo_to_smt
          exact h)
    case Apply k z =>
      cases k <;> try cases h
...
theorem eo_to_smt_apply_ne_dt_tester
  ...
  case UOp op =>
    cases op <;> try cases h
    case distinct =>
      exact eo_to_smt_distinct_top_ne_dt_tester x s d i (by
        unfold __eo_to_smt
        exact h)
    case _at_bvsize =>
      change native_ite (native_zleq 0 (__smtx_bv_sizeof_type (__smtx_typeof (__eo_to_smt x))))
  ...
  case Apply g y =>
    ...
    case UOp op =>
      cases op <;> try cases h
      case set_insert =>
        exact eo_to_smt_set_insert_top_ne_dt_tester _ _ _ _ _ (by
          unfold __eo_to_smt
          exact h)
      case «forall» =>
        exact eo_to_smt_forall_top_ne_dt_tester _ _ _ _ _ (by
          unfold __eo_to_smt
          exact h)
      case «exists» =>
        exact eo_to_smt_exists_top_ne_dt_tester _ _ _ _ _ (by
          unfold __eo_to_smt
          exact h)
      case tuple =>
        exact eo_to_smt_tuple_ne_dt_tester x y s d i (by
          unfold __eo_to_smt
          exact h)
    case Apply k z =>
      cases k <;> try cases h
...
private theorem eo_to_smt_apply_ne_dt_cons
  ...
  case UOp op =>
    cases op <;> try cases h
    case distinct =>
      exact eo_to_smt_distinct_top_ne_dt_cons x s d i (by
        unfold __eo_to_smt
        exact h)
    case _at_bvsize =>
      change native_ite (native_zleq 0 (__smtx_bv_sizeof_type (__smtx_typeof (__eo_to_smt x))))
  ...
  case Apply g y =>
    ...
    case UOp op =>
      cases op <;> try cases h
      case set_insert =>
        exact eo_to_smt_set_insert_top_ne_dt_cons _ _ _ _ _ (by
          unfold __eo_to_smt
          exact h)
      case «forall» =>
        exact eo_to_smt_forall_top_ne_dt_cons _ _ _ _ _ (by
          unfold __eo_to_smt
          exact h)
      case «exists» =>
        exact eo_to_smt_exists_top_ne_dt_cons _ _ _ _ _ (by
          unfold __eo_to_smt
          exact h)
      case tuple =>
        exact eo_to_smt_tuple_ne_dt_cons x y s d i (by
          unfold __eo_to_smt
          exact h)
    case Apply k z =>
      cases k <;> try cases h
...
private theorem typeof_apply_guard_closed_eq_none
    (x : Term) (body arg : SmtTerm)
    (hBody : __smtx_typeof (SmtTerm.Apply body arg) = SmtType.None) :
    __smtx_typeof (SmtTerm.Apply (__eo_to_smt_guard_closed x body) arg) =
      SmtType.None := by
  cases hx : native_eo_to_smt_closed x <;>
    simp [__eo_to_smt_guard_closed, native_ite, hx, hBody, typeof_apply_none_eq]
...
private theorem choice_nth_fun_like_arg_field_wf_any
  ...
  induction n generalizing s T body with
    ...
    | succ n ih =>
        cases body <;> try
          (exfalso
           exact smtx_typeof_none_not_fun_like (A := A) (B := B) (by
             rw [__smtx_typeof.eq_137] at hHead
             simpa [__smtx_typeof_choice_nth] using hHead))
...
/-- `__eo_to_smt_qs_choice` is either a `choice_nth` or `none`, so function-like results have well-formed arguments. -/
private theorem eo_to_smt_qs_choice_fun_like_arg_field_wf
    (body : SmtTerm) (n : native_Nat) {A B : SmtType}
    (hHead :
      __smtx_typeof (__eo_to_smt_qs_choice body n) = SmtType.FunType A B ∨
        __smtx_typeof (__eo_to_smt_qs_choice body n) = SmtType.DtcAppType A B) :
    smtx_type_field_wf_rec A native_reflist_nil := by
  cases body with
  | not body =>
      cases body with
      | «exists» s T body' =>
          exact choice_nth_fun_like_arg_field_wf_any s T body' n
            (by
              simpa [__eo_to_smt_qs_choice] using hHead)
      | _ =>
          exfalso
          rcases hHead with hHead | hHead <;>
            simp [__eo_to_smt_qs_choice] at hHead
  | _ =>
      exfalso
      rcases hHead with hHead | hHead
      · simp [__eo_to_smt_qs_choice] at hHead
...
private theorem eo_to_smt_quantifiers_skolemize_fun_like_arg_field_wf
    (body : Term) (n : native_Nat) {A B : SmtType}
    (hHead :
  ...
  case Apply f arg =>
    ...
    case Apply g vars =>
      ...
      case UOp op =>
        cases op
        case «forall» =>
          exact eo_to_smt_qs_choice_fun_like_arg_field_wf
            (__eo_to_smt (Term.Apply (Term.Apply (Term.UOp UserOp.forall) vars) arg))
            n
            (by simpa [__eo_to_smt_quantifiers_skolemize] using hHead)
        all_goals
          exact False.elim (smtx_typeof_none_not_fun_like (A := A) (B := B)
            (by simpa [__eo_to_smt_quantifiers_skolemize] using hHead))
      all_goals
        exact False.elim (smtx_typeof_none_not_fun_like (A := A) (B := B)
          (by simpa [__eo_to_smt_quantifiers_skolemize] using hHead))
...
private theorem eo_to_smt_quantifiers_skolemize_top_fun_like_arg_field_wf
    ...
    smtx_type_field_wf_rec A native_reflist_nil := by
  unfold __eo_to_smt at hHead
  have hNN :
      __smtx_typeof
          (__eo_to_smt_guard_closed q
            (native_ite (__eo_to_smt_nat_is_valid idx)
              (__eo_to_smt_quantifiers_skolemize q (__eo_to_smt_nat idx))
  ...
  have hHead' :
      __smtx_typeof
          (native_ite (__eo_to_smt_nat_is_valid idx)
            (__eo_to_smt_quantifiers_skolemize q (__eo_to_smt_nat idx))
            SmtTerm.None) = SmtType.FunType A B ∨
        __smtx_typeof
          (native_ite (__eo_to_smt_nat_is_valid idx)
            (__eo_to_smt_quantifiers_skolemize q (__eo_to_smt_nat idx))
            SmtTerm.None) = SmtType.DtcAppType A B := by
    rcases hHead with hHead | hHead
...
private theorem eo_to_smt_array_deq_diff_fun_like_domains_field_wf
  ...
  unfold __eo_to_smt at hNN ⊢
  change
    smtx_type_fun_like_domains_field_wf
      (__smtx_typeof
        (__eo_to_smt_guard_closed y
          (__eo_to_smt_guard_closed z
            (__eo_to_smt_array_deq_diff (__eo_to_smt y)
    ...
    term_has_non_none_type
      (__eo_to_smt_guard_closed y
        (__eo_to_smt_guard_closed z
          (__eo_to_smt_array_deq_diff (__eo_to_smt y)
            (__smtx_typeof (__eo_to_smt y)) (__eo_to_smt z)
            (__smtx_typeof (__eo_to_smt z))))) at hNN
  have hOuterEq :=
    smtx_typeof_guard_closed_eq_of_non_none
      (x := y)
      (body := __eo_to_smt_guard_closed z
        (__eo_to_smt_array_deq_diff (__eo_to_smt y)
          (__smtx_typeof (__eo_to_smt y)) (__eo_to_smt z)
          (__smtx_typeof (__eo_to_smt z))))
      hNN
      ...
      term_has_non_none_type
        (__eo_to_smt_guard_closed z
          (__eo_to_smt_array_deq_diff (__eo_to_smt y)
            (__smtx_typeof (__eo_to_smt y)) (__eo_to_smt z)
            (__smtx_typeof (__eo_to_smt z)))) :=
    smtx_typeof_body_non_none_of_guard_closed hNN
  have hInnerEq :=
    smtx_typeof_guard_closed_eq_of_non_none
      (x := z)
      (body := __eo_to_smt_array_deq_diff (__eo_to_smt y)
        (__smtx_typeof (__eo_to_smt y)) (__eo_to_smt z)
        (__smtx_typeof (__eo_to_smt z)))
      hInnerNN
  rw [hInnerEq]
  have hBodyNN :
      term_has_non_none_type
        (__eo_to_smt_array_deq_diff (__eo_to_smt y)
          (__smtx_typeof (__eo_to_smt y)) (__eo_to_smt z)
          (__smtx_typeof (__eo_to_smt z))) :=
    smtx_typeof_body_non_none_of_guard_closed hInnerNN
  ...
  all_goals
    ...
    | exact smtx_typeof_map_diff_fun_like_domains_field_wf_of_non_none
        ...
        (by simpa [__eo_to_smt_array_deq_diff, hy, hz] using hBodyNN)
    | exfalso
      unfold term_has_non_none_type at hBodyNN
      exact hBodyNN (by simp [__eo_to_smt_array_deq_diff, hy, hz])
...
private theorem eo_to_smt_sets_deq_diff_fun_like_domains_field_wf
  ...
  change
    smtx_type_fun_like_domains_field_wf
      (__smtx_typeof
        (__eo_to_smt_guard_closed y
          (__eo_to_smt_guard_closed z
            (__eo_to_smt_sets_deq_diff (__eo_to_smt y)
              (__smtx_typeof (__eo_to_smt y)) (__eo_to_smt z)
              (__smtx_typeof (__eo_to_smt z))))))
  change
    term_has_non_none_type
  ...
  have hInnerEq :=
    smtx_typeof_guard_closed_eq_of_non_none
      (x := z)
      (body := __eo_to_smt_sets_deq_diff (__eo_to_smt y)
        (__smtx_typeof (__eo_to_smt y)) (__eo_to_smt z)
        (__smtx_typeof (__eo_to_smt z)))
      hInnerNN
  rw [hInnerEq]
  ...
  all_goals
    ...
    | exact smtx_typeof_map_diff_fun_like_domains_field_wf_of_non_none
        (__eo_to_smt y) (__eo_to_smt z)
        (by simpa [__eo_to_smt_sets_deq_diff, hy, hz] using hBodyNN)
    | exfalso
      unfold term_has_non_none_type at hBodyNN
      exact hBodyNN (by simp [__eo_to_smt_sets_deq_diff, hy, hz])
...
private theorem eo_to_smt_typeof_matches_translation_apply_at_strings_stoi_result
  ...
  have hTranslate :
    ...
    conv =>
      lhs
      unfold __eo_to_smt
    change __eo_to_smt_guard_closed y (SmtTerm.str_to_int sub) =
      SmtTerm.str_to_int sub
    exact __eo_to_smt_guard_closed_eq_body_of_non_none
      (by
        unfold __eo_to_smt at hNonNone
        simpa [sub] using hNonNone)
...
private theorem eo_to_smt_typeof_matches_translation_apply_at_strings_itos_result
  ...
  have hTranslate :
    ...
    conv =>
      lhs
      unfold __eo_to_smt
    change __eo_to_smt_guard_closed y rhs = rhs
    exact __eo_to_smt_guard_closed_eq_body_of_non_none
      (by
        unfold __eo_to_smt at hNonNone
        simpa [rhs] using hNonNone)
...
theorem eo_to_smt_typeof_matches_translation_apply_at_strings_deq_diff
  ...
  have hTranslate :
    ...
    conv =>
      lhs
      unfold __eo_to_smt
    change __eo_to_smt_guard_closed y
        (__eo_to_smt_guard_closed x
          (SmtTerm.choice_nth (native_string_lit "@x") SmtType.Int body native_nat_zero)) =
      SmtTerm.choice_nth (native_string_lit "@x") SmtType.Int body native_nat_zero
    have hOuterNN :
        __smtx_typeof
            (__eo_to_smt_guard_closed y
          ...
          SmtType.None := by
      unfold __eo_to_smt at hNonNone
      simpa [one, idx, ySub, xSub, body] using hNonNone
    rw [__eo_to_smt_guard_closed_eq_body_of_non_none hOuterNN]
    exact __eo_to_smt_guard_closed_eq_body_of_non_none
      (smtx_typeof_body_non_none_of_guard_closed hOuterNN)
  have hChoiceNN :
...
theorem eo_to_smt_eq_dt_cons_cases
  ...
  case UOp1 op z =>
    ...
    case _at_purify =>
      exfalso
      have hyBody :=
        __eo_to_smt_guard_closed_eq_of_ne_none hy
          (by intro hNone; cases hNone)
      cases hyBody
  ...
  case UOp2 op q idx =>
    ...
    case _at_array_deq_diff =>
      have hyInner :=
        __eo_to_smt_guard_closed_eq_of_ne_none hy
          (by intro hNone; cases hNone)
      have hyBody :=
        __eo_to_smt_guard_closed_eq_of_ne_none hyInner
          (by intro hNone; cases hNone)
      exact (eo_to_smt_array_deq_diff_ne_dt_cons
        (__eo_to_smt q) (__eo_to_smt idx) s d i hyBody).elim
    ...
    case _at_quantifiers_skolemize =>
      exact (eo_to_smt_quant_skolemize_top_ne_dt_cons q idx s d i
        (by
          unfold __eo_to_smt
          exact hy)).elim
  case UOp3 op t r idx =>
    ...
    case _at_re_unfold_pos_component =>
      exfalso
      change __eo_to_smt_guard_closed t
          (__eo_to_smt_guard_closed r
            (native_ite (__eo_to_smt_nat_is_valid idx)
      ...
      have hyBody :=
        __eo_to_smt_guard_closed_eq_of_ne_none hyInner
          (by intro hNone; cases hNone)
      unfold native_ite at hyBody
      split at hyBody <;> try cases hyBody
      exact eo_to_smt_re_unfold_ne_dt_cons _ _ _ _ _ _ hyBody
    case _at_witness_string_length =>
      exfalso
      change __eo_to_smt_guard_closed r
          (__eo_to_smt_guard_closed idx
            (native_ite (native_Teq (__smtx_typeof (__eo_to_smt idx)) SmtType.Int)
  ...
  case UOp2 op q idx =>
    ...
    case _at_array_deq_diff =>
      ...
      exact (eo_to_smt_array_deq_diff_ne_dt_sel
        (__eo_to_smt q) (__eo_to_smt idx) s d i j hyBody).elim
    case _at_strings_deq_diff =>
      exfalso
      have hyInner :=
        __eo_to_smt_guard_closed_eq_of_ne_none hy
    ...
    case _at_quantifiers_skolemize =>
      exact (eo_to_smt_quant_skolemize_top_ne_dt_sel q idx s d i j
        (by
          unfold __eo_to_smt
          exact hy)).elim
  case UOp3 op t r idx =>
    ...
    case _at_re_unfold_pos_component =>
      ...
      unfold native_ite at hyBody
      split at hyBody <;> try cases hyBody
      exact eo_to_smt_re_unfold_ne_dt_sel _ _ _ _ _ _ _ hyBody
    case _at_witness_string_length =>
      exfalso
      change __eo_to_smt_guard_closed r
          (__eo_to_smt_guard_closed idx
...
theorem eo_to_smt_ne_dt_tester
  ...
  case UOp2 op q idx =>
    ...
    case _at_quantifiers_skolemize =>
      exact (eo_to_smt_quant_skolemize_top_ne_dt_tester q idx s d i
        (by
          unfold __eo_to_smt
          exact hy)).elim
  case UOp3 op t r idx =>
    ...
    case _at_re_unfold_pos_component =>
      ...
      unfold native_ite at hyBody
      split at hyBody <;> try cases hyBody
      exact eo_to_smt_re_unfold_ne_dt_tester _ _ _ _ _ _ hyBody
    case _at_witness_string_length =>
      exfalso
      change __eo_to_smt_guard_closed r
          (__eo_to_smt_guard_closed idx
  ...
  have hGeneric :
    ...
    exact generic_apply_type_of_non_special_head _ _
      ...
      (by
        ...
        cases hyBody)
  exact eo_to_smt_typeof_matches_translation_apply_generic_from_ih_of_valid
    (Term._at_purify y) x ihPurify ihX hGeneric
    (by
      conv =>
        lhs
        unfold __eo_to_smt)
  ...
  change
    __smtx_typeof
        (SmtTerm.Apply
          ...
          (__eo_to_smt x)) =
      SmtType.None
  cases ht : native_eo_to_smt_closed t <;>
    simp [__eo_to_smt_guard_closed, native_ite, ht, typeof_apply_none_eq]
  cases hr : native_eo_to_smt_closed r <;>
    simp [__eo_to_smt_guard_closed, native_ite, hr, typeof_apply_none_eq]
...
private theorem re_unfold_pos_component_zero_args_of_non_none
  ...
  let v2 := SmtTerm.Var (native_string_lit "@x") v0
  ...
  have hChoiceNN : term_has_non_none_type (SmtTerm.choice_nth (native_string_lit "@x") v0 body native_nat_zero) := by
  ...
  have hTranslate :
      __eo_to_smt (Term.Apply (Term.UOp UserOp.distinct) xs) =
        native_ite
          ...
          SmtTerm.None (__eo_to_smt_distinct xs) := by
    conv =>
      lhs
      unfold __eo_to_smt
  rw [hTranslate]
...
theorem smtx_ret_typeof_tuple_sel_eq_eo_list_nth_rec_nat
    ...
    __smtx_ret_typeof_sel (native_string_lit "@Tuple") d native_nat_zero j =
...
private theorem smtx_tuple_prepend_rec_apply_head
    ...
    ∀ (k : native_Nat) (acc : SmtTerm),
      smtx_apply_head (__eo_to_smt_tuple_prepend_rec tailD tail k acc) =
        smtx_apply_head acc
  ...
  | native_nat_succ k, acc => by
      simp [__eo_to_smt_tuple_prepend_rec, smtx_apply_head,
        smtx_tuple_prepend_rec_apply_head tailD tail k acc]

private theorem smtx_tuple_prepend_rec_num_apply_args
    (tailD : SmtDatatype) (tail : SmtTerm) :
    ∀ (k : native_Nat) (acc : SmtTerm),
      smtx_num_apply_args (__eo_to_smt_tuple_prepend_rec tailD tail k acc) =
        k + smtx_num_apply_args acc
  | native_nat_zero, acc => by
      simp [__eo_to_smt_tuple_prepend_rec]
  | native_nat_succ k, acc => by
      simp [__eo_to_smt_tuple_prepend_rec, smtx_num_apply_args,
        smtx_tuple_prepend_rec_num_apply_args tailD tail k acc, Nat.succ_add]
  ...
  | native_nat_succ k, acc, hAccSel, hAccTester, hNN => by
      have hRecNN :
        ...
        smtx_apply_head_non_none_of_generic_apply_non_none
          ...
          (eo_to_smt_tuple_prepend_rec_ne_dt_sel tailD tail k acc hAccSel)
          (eo_to_smt_tuple_prepend_rec_ne_dt_tester tailD tail k acc hAccTester)
...
theorem smtx_tuple_prepend_typeof_of_tail_tuple_type
  ...
  have hTerm :
    ...
    simp [__eo_to_smt_tuple_prepend_of_type, tailD, fullD, seed,
      native_streq, native_and, native_ite, hFullWf]
  have hRecNN :
      __smtx_typeof
          (__eo_to_smt_tuple_prepend_rec tailD tail
  ...
  have hCount :
      smtx_num_apply_args
          (__eo_to_smt_tuple_prepend_rec tailD tail
            (__smtx_dt_num_sels tailD native_nat_zero) seed) =
        __smtx_dt_num_sels (__smtx_dt_substitute (native_string_lit "@Tuple") fullD fullD)
          native_nat_zero := by
    rw [hCountPlain]
    exact (dt_num_sels_substitute (native_string_lit "@Tuple") fullD fullD native_nat_zero).symm
  have hRecTy :
      __smtx_typeof
          (__eo_to_smt_tuple_prepend_rec tailD tail
            (__smtx_dt_num_sels tailD native_nat_zero) seed) =
  ...
  have hTranslateBase :
      __eo_to_smt (Term.Apply (Term.UOp1 UserOp1.tuple_select y) x) =
        __eo_to_smt_tuple_select
          (__smtx_typeof (__eo_to_smt x)) (__eo_to_smt y) (__eo_to_smt x) := by
    conv =>
      lhs
      unfold __eo_to_smt
        ...
        | Numeral n =>
            ...
            · have hTranslate :
              ...
              have hSmt :
                  __smtx_typeof
                      (__eo_to_smt (Term.Apply (Term.UOp1 UserOp1.tuple_select y) x)) =
                    __smtx_ret_typeof_sel (native_string_lit "@Tuple") d native_nat_zero (native_int_to_nat n) := by
                rw [hTranslate]
                exact dt_sel_term_typeof_of_non_none hApplyNN
              have hArgTy :
                  __smtx_typeof (__eo_to_smt x) = SmtType.Datatype (native_string_lit "@Tuple") d :=
                dt_sel_arg_datatype_of_non_none hApplyNN
              have hXNN : __smtx_typeof (__eo_to_smt x) ≠ SmtType.None := by
                rw [hArgTy]
                simp
              have hTyFromIH :
                  __eo_to_smt_type (__eo_typeof x) = SmtType.Datatype (native_string_lit "@Tuple") d := by
                exact (ihX hXNN).symm.trans hArgTy
              have hTNonNone :
                  __smtx_ret_typeof_sel (native_string_lit "@Tuple") d native_nat_zero (native_int_to_nat n) ≠
                    SmtType.None := by
                rw [← hSmt]
                exact hNonNone
              ...
              have hTupleWf :
                  __smtx_type_wf (SmtType.Datatype (native_string_lit "@Tuple") d) = true :=
                Smtm.smt_datatype_wf_of_non_none_type
                  (__eo_to_smt x) (native_string_lit "@Tuple") d hArgTy
          ...
          (by
            ...
            change
              __smtx_typeof
                ...
                SmtType.None
            rw [hTy]
            cases __eo_to_smt y <;> simp [__eo_to_smt_tuple_select, hTuple,
...
private theorem eo_to_smt_typeof_matches_translation_apply_tuple_of_tail_type
  ...
  have hTranslate :
      __eo_to_smt (Term.Apply (Term.Apply (Term.UOp UserOp.tuple) y) x) =
        __eo_to_smt_tuple_prepend (__eo_to_smt y) headTy (__eo_to_smt x) := by
    dsimp [headTy]
    conv =>
      lhs
      unfold __eo_to_smt
  ...
  | Datatype s d =>
      ...
      · exact False.elim (hPrependNN (by
          ...
          | null =>
              simp [hTail, __eo_to_smt_tuple_prepend_of_type]
          | sum c rest =>
              cases rest <;> simp [hTail, __eo_to_smt_tuple_prepend_of_type,
...
private theorem eo_to_smt_typeof_matches_translation_apply_uop_application_head_obligation
  ...
  case not =>
    exact eo_to_smt_typeof_matches_translation_apply_apply_generic_of_head_from_ih
      UserOp.not y x (SmtTerm.not (__eo_to_smt y)) ihFAll ihXAll
      (by
        conv =>
          lhs
          unfold __eo_to_smt)
  ...
  case to_real =>
    exact eo_to_smt_typeof_matches_translation_apply_apply_generic_of_head_from_ih
      UserOp.to_real y x (SmtTerm.to_real (__eo_to_smt y)) ihFAll ihXAll
      (by
        conv =>
          lhs
          unfold __eo_to_smt)
  ...
  case to_int =>
    exact eo_to_smt_typeof_matches_translation_apply_apply_generic_of_head_from_ih
      UserOp.to_int y x (SmtTerm.to_int (__eo_to_smt y)) ihFAll ihXAll
      (by
        conv =>
          lhs
          unfold __eo_to_smt)
  ...
  case is_int =>
    exact eo_to_smt_typeof_matches_translation_apply_apply_generic_of_head_from_ih
      UserOp.is_int y x (SmtTerm.is_int (__eo_to_smt y)) ihFAll ihXAll
      (by
        conv =>
          lhs
          unfold __eo_to_smt)
  ...
  case abs =>
    exact eo_to_smt_typeof_matches_translation_apply_apply_generic_of_head_from_ih
      UserOp.abs y x (SmtTerm.abs (__eo_to_smt y)) ihFAll ihXAll
      (by
        conv =>
          lhs
          unfold __eo_to_smt)
  ...
  case str_to_re =>
    exact eo_to_smt_typeof_matches_translation_apply_apply_generic_of_head_from_ih
      UserOp.str_to_re y x (SmtTerm.str_to_re (__eo_to_smt y)) ihFAll ihXAll
      (by
        conv =>
          lhs
          unfold __eo_to_smt)
  ...
  case re_mult =>
    exact eo_to_smt_typeof_matches_translation_apply_apply_generic_of_head_from_ih
      UserOp.re_mult y x (SmtTerm.re_mult (__eo_to_smt y)) ihFAll ihXAll
      (by
        conv =>
          lhs
          unfold __eo_to_smt)
  ...
  case re_plus =>
    exact eo_to_smt_typeof_matches_translation_apply_apply_generic_of_head_from_ih
      UserOp.re_plus y x (SmtTerm.re_plus (__eo_to_smt y)) ihFAll ihXAll
      (by
        conv =>
          lhs
          unfold __eo_to_smt)
  ...
  case re_opt =>
    exact eo_to_smt_typeof_matches_translation_apply_apply_generic_of_head_from_ih
      UserOp.re_opt y x (SmtTerm.re_opt (__eo_to_smt y)) ihFAll ihXAll
      (by
        conv =>
          lhs
          unfold __eo_to_smt)
  ...
  case re_comp =>
    exact eo_to_smt_typeof_matches_translation_apply_apply_generic_of_head_from_ih
      UserOp.re_comp y x (SmtTerm.re_comp (__eo_to_smt y)) ihFAll ihXAll
      (by
        conv =>
          lhs
          unfold __eo_to_smt)
  ...
  case set_singleton =>
    exact eo_to_smt_typeof_matches_translation_apply_apply_generic_of_head_from_ih
      UserOp.set_singleton y x (SmtTerm.set_singleton (__eo_to_smt y)) ihFAll ihXAll
      (by
        conv =>
          lhs
          unfold __eo_to_smt)
  ...
  case set_is_empty =>
    exact eo_to_smt_typeof_matches_translation_apply_apply_generic_of_head_from_ih
      ...
      (let _v0 := __eo_to_smt y
       SmtTerm.eq _v0 (SmtTerm.set_empty (__smtx_typeof _v0))) ihFAll ihXAll
      (by
        conv =>
          lhs
          unfold __eo_to_smt)
       ...
       SmtTerm.eq _v0
         (SmtTerm.set_singleton
           (SmtTerm.map_diff _v0
             (SmtTerm.set_empty (__eo_to_smt_set_elem_type (__smtx_typeof _v0)))))) ihFAll ihXAll
      (by
        conv =>
          lhs
          unfold __eo_to_smt)
  ...
  case str_contains =>
    exact eo_to_smt_typeof_matches_translation_apply_seq_ret_binop
      UserOp.str_contains SmtTerm.str_contains SmtType.Bool x y ihY ihX
      (by
        conv =>
          lhs
          unfold __eo_to_smt)
  ...
  case str_prefixof =>
    exact eo_to_smt_typeof_matches_translation_apply_seq_char_binop
        UserOp.str_prefixof SmtTerm.str_prefixof SmtType.Bool x y
        (by
          conv =>
            lhs
            unfold __eo_to_smt)
  ...
  case str_suffixof =>
    exact eo_to_smt_typeof_matches_translation_apply_seq_char_binop
        UserOp.str_suffixof SmtTerm.str_suffixof SmtType.Bool x y
        (by
          conv =>
            lhs
            unfold __eo_to_smt)
  ...
  case str_lt =>
    exact eo_to_smt_typeof_matches_translation_apply_seq_char_binop
        UserOp.str_lt SmtTerm.str_lt SmtType.Bool x y
        (by
          conv =>
            lhs
            unfold __eo_to_smt)
  ...
  case str_leq =>
    exact eo_to_smt_typeof_matches_translation_apply_seq_char_binop
        UserOp.str_leq SmtTerm.str_leq SmtType.Bool x y
        (by
          conv =>
            lhs
            unfold __eo_to_smt)
  ...
  case str_concat =>
    exact eo_to_smt_typeof_matches_translation_apply_seq_binop
        UserOp.str_concat SmtTerm.str_concat x y ihY ihX
        (by
          conv =>
            lhs
            unfold __eo_to_smt)
  ...
  case re_range =>
    exact eo_to_smt_typeof_matches_translation_apply_seq_char_binop
        UserOp.re_range SmtTerm.re_range SmtType.RegLan x y
        (by
          conv =>
            lhs
            unfold __eo_to_smt)
  ...
  case re_concat =>
    exact eo_to_smt_typeof_matches_translation_apply_reglan_binop
        UserOp.re_concat SmtTerm.re_concat x y
        (by
          conv =>
            lhs
            unfold __eo_to_smt)
  ...
  case re_inter =>
    exact eo_to_smt_typeof_matches_translation_apply_reglan_binop
        UserOp.re_inter SmtTerm.re_inter x y
        (by
          conv =>
            lhs
            unfold __eo_to_smt)
  ...
  case re_union =>
    exact eo_to_smt_typeof_matches_translation_apply_reglan_binop
        UserOp.re_union SmtTerm.re_union x y
        (by
          conv =>
            lhs
            unfold __eo_to_smt)
  ...
  case re_diff =>
    exact eo_to_smt_typeof_matches_translation_apply_reglan_binop
        UserOp.re_diff SmtTerm.re_diff x y
        (by
          conv =>
            lhs
            unfold __eo_to_smt)
  ...
  case str_in_re =>
    exact eo_to_smt_typeof_matches_translation_apply_seq_char_reglan_binop
        UserOp.str_in_re SmtTerm.str_in_re SmtType.Bool x y
        (by
          conv =>
            lhs
            unfold __eo_to_smt)
  ...
  case div =>
    exact eo_to_smt_typeof_matches_translation_apply_int_binop
          UserOp.div SmtTerm.div SmtType.Int x y
          (by
            conv =>
              lhs
              unfold __eo_to_smt)
  ...
  case mod =>
    exact eo_to_smt_typeof_matches_translation_apply_int_binop
          UserOp.mod SmtTerm.mod SmtType.Int x y
          (by
            conv =>
              lhs
              unfold __eo_to_smt)
  ...
  case multmult =>
    exact eo_to_smt_typeof_matches_translation_apply_int_binop
          UserOp.multmult SmtTerm.multmult SmtType.Int x y
          (by
            conv =>
              lhs
              unfold __eo_to_smt)
  ...
  case divisible =>
    exact eo_to_smt_typeof_matches_translation_apply_int_binop
          UserOp.divisible SmtTerm.divisible SmtType.Bool x y
          (by
            conv =>
              lhs
              unfold __eo_to_smt)
  ...
  case div_total =>
    exact eo_to_smt_typeof_matches_translation_apply_int_binop
          UserOp.div_total SmtTerm.div_total SmtType.Int x y
          (by
            conv =>
              lhs
              unfold __eo_to_smt)
  ...
  case mod_total =>
    exact eo_to_smt_typeof_matches_translation_apply_int_binop
          UserOp.mod_total SmtTerm.mod_total SmtType.Int x y
          (by
            conv =>
              lhs
              unfold __eo_to_smt)
  ...
  case multmult_total =>
    exact eo_to_smt_typeof_matches_translation_apply_int_binop
          UserOp.multmult_total SmtTerm.multmult_total SmtType.Int x y
          (by
            conv =>
              lhs
              unfold __eo_to_smt)
  ...
  case qdiv =>
    exact eo_to_smt_typeof_matches_translation_apply_arith_ret_binop
        UserOp.qdiv SmtTerm.qdiv SmtType.Real x y
        (by
          conv =>
            lhs
            unfold __eo_to_smt)
  ...
  case qdiv_total =>
    exact eo_to_smt_typeof_matches_translation_apply_arith_ret_binop
        UserOp.qdiv_total SmtTerm.qdiv_total SmtType.Real x y
        (by
          conv =>
            lhs
            unfold __eo_to_smt)
  ...
  case set_union =>
    exact eo_to_smt_typeof_matches_translation_apply_set_binop
      UserOp.set_union SmtTerm.set_union x y ihY ihX
      (by
        conv =>
          lhs
          unfold __eo_to_smt)
  ...
  case set_inter =>
    exact eo_to_smt_typeof_matches_translation_apply_set_binop
      UserOp.set_inter SmtTerm.set_inter x y ihY ihX
      (by
        conv =>
          lhs
          unfold __eo_to_smt)
  ...
  case set_minus =>
    exact eo_to_smt_typeof_matches_translation_apply_set_binop
      UserOp.set_minus SmtTerm.set_minus x y ihY ihX
      (by
        conv =>
          lhs
          unfold __eo_to_smt)
  ...
  case set_subset =>
    exact eo_to_smt_typeof_matches_translation_apply_set_pred_binop
      UserOp.set_subset SmtTerm.set_subset x y ihY ihX
      (by
        conv =>
          lhs
          unfold __eo_to_smt)
  ...
  case _at__at_TypedList_cons =>
    exact eo_to_smt_typeof_matches_translation_apply_apply_none_head
      UserOp._at__at_TypedList_cons y x
      (by
        conv =>
          lhs
          unfold __eo_to_smt
...
theorem eo_to_smt_typeof_matches_translation_apply_apply_apply_at_witness_string_length
  ...
  have hTranslate :
      __eo_to_smt
          (Term.UOp3 UserOp3._at_witness_string_length z y x) =
        native_ite (native_Teq (__smtx_typeof (__eo_to_smt x)) SmtType.Int)
          (SmtTerm.choice_nth (native_string_lit "@x") T body native_nat_zero) SmtTerm.None := by
    conv =>
      lhs
      unfold __eo_to_smt
    change __eo_to_smt_guard_closed y
        (__eo_to_smt_guard_closed x
          (native_ite (native_Teq (__smtx_typeof (__eo_to_smt x)) SmtType.Int)
            (SmtTerm.choice_nth (native_string_lit "@x") T body native_nat_zero) SmtTerm.None)) =
      native_ite (native_Teq (__smtx_typeof (__eo_to_smt x)) SmtType.Int)
        (SmtTerm.choice_nth (native_string_lit "@x") T body native_nat_zero) SmtTerm.None
    have hOuterNN :
        __smtx_typeof
          ...
          SmtType.None := by
      unfold __eo_to_smt at hNonNone
      simpa [T, body] using hNonNone
    rw [__eo_to_smt_guard_closed_eq_body_of_non_none hOuterNN]
    exact __eo_to_smt_guard_closed_eq_body_of_non_none
      (smtx_typeof_body_non_none_of_guard_closed hOuterNN)
  have hXIntSmt : __smtx_typeof (__eo_to_smt x) = SmtType.Int := by
    cases hTest : native_Teq (__smtx_typeof (__eo_to_smt x)) SmtType.Int
    · exfalso
      apply hNonNone
      rw [hTranslate]
  ...
  have hChoiceNN : term_has_non_none_type (SmtTerm.choice_nth (native_string_lit "@x") T body 0) := by
    ...
    simpa [hXIntSmt, native_Teq, native_ite] using hTermNN
  have hBodyBool : __smtx_typeof body = SmtType.Bool :=
    choice_nth_body_bool_of_non_none hChoiceNN
  have hEqNN :
      __smtx_typeof_eq
          (__smtx_typeof (SmtTerm.str_len (SmtTerm.Var (native_string_lit "@x") T)))
  ...
  have hEqArgs := smtx_typeof_eq_non_none hEqNN
  have hStrLenNN : term_has_non_none_type (SmtTerm.str_len (SmtTerm.Var (native_string_lit "@x") T)) := by
    unfold term_has_non_none_type
    exact hEqArgs.2
  rcases seq_arg_of_non_none_ret (op := SmtTerm.str_len)
      (typeof_str_len_eq (SmtTerm.Var (native_string_lit "@x") T)) hStrLenNN with
    ⟨A, hVarSeq⟩
  have hStrLenTy :
      __smtx_typeof (SmtTerm.str_len (SmtTerm.Var (native_string_lit "@x") T)) = SmtType.Int := by
    rw [typeof_str_len_eq (SmtTerm.Var (native_string_lit "@x") T), hVarSeq]
  ...
  have hSmt :
      __smtx_typeof
        ...
        T := by
    rw [hTranslate]
    simpa [hXIntSmt, native_Teq, native_ite] using hChoiceTy
  have hChoiceGuard :
...
theorem eo_to_smt_typeof_matches_translation_apply_apply_apply_re_unfold_pos_component
  ...
  | Numeral n =>
      have hTranslate :
        ...
        conv =>
          lhs
          unfold __eo_to_smt
        change __eo_to_smt_guard_closed z
            (__eo_to_smt_guard_closed y
              (native_ite (__eo_to_smt_nat_is_valid (Term.Numeral n))
                (__eo_to_smt_re_unfold_pos_component
                  (__eo_to_smt z) (__eo_to_smt y) (__eo_to_smt_nat (Term.Numeral n)))
  ...
  | _ =>
      ...
      cases hyClosed : native_eo_to_smt_closed y <;>
        simp [__eo_to_smt_guard_closed, native_ite, hzClosed, hyClosed,
          __eo_to_smt_nat_is_valid, smtx_typeof_none]
  ...
  case DtSel s d i j =>
    ...
    have hzNonStuck : __eo_typeof z ≠ Term.Stuck := by
      ...
      · subst z
        ...
        cases hStuck
      · subst z
        unfold __eo_to_smt at hz
        have hzBody :=
          __eo_to_smt_guard_closed_eq_of_ne_none hz
            (by intro hNone; cases hNone)
        cases hzBody
    have hEo :
    ...
    case Numeral n =>
      ...
      · subst s
        ...
        have hGe : native_zleq 0 n = true := by
          ...
          · simp [__eo_to_smt_tuple_update, hTest, native_streq, native_and,
              native_ite] at hTupleNN
          · rfl
        have hUpdaterNN :
            __smtx_typeof
                (__eo_to_smt_updater
                  ...
                  (__eo_to_smt y) (__eo_to_smt x)) ≠
              SmtType.None := by
          simpa [__eo_to_smt_tuple_update, hGe, native_streq, native_and,
            native_ite] using hTupleNN
        have hIdx :
            native_zlt
              ...
              true := by
          exact eo_to_smt_updater_dt_sel_guard_of_non_none
            (native_string_lit "@Tuple") d native_nat_zero (native_int_to_nat n) (__eo_to_smt y) (__eo_to_smt x)
            hUpdaterNN
        have hIteNN :
            term_has_non_none_type
              (SmtTerm.ite
                (SmtTerm.Apply (SmtTerm.DtTester (native_string_lit "@Tuple") d native_nat_zero) (__eo_to_smt y))
                (__eo_to_smt_updater_rec
                  (SmtTerm.DtSel (native_string_lit "@Tuple") d native_nat_zero (native_int_to_nat n))
                  (__smtx_dt_num_sels d native_nat_zero) (__eo_to_smt y)
                  (__eo_to_smt x) (SmtTerm.DtCons (native_string_lit "@Tuple") d native_nat_zero))
                (__eo_to_smt y)) := by
          unfold term_has_non_none_type
          simpa [__eo_to_smt_updater, native_ite, hIdx] using hUpdaterNN
        rcases ite_args_of_non_none hIteNN with ⟨T, hCond, hThen, hElse, _hT⟩
        have hCondNN :
            term_has_non_none_type
              (SmtTerm.Apply (SmtTerm.DtTester (native_string_lit "@Tuple") d native_nat_zero) (__eo_to_smt y)) := by
          unfold term_has_non_none_type
          rw [hCond]
          simp
        have hYTy : __smtx_typeof (__eo_to_smt y) = SmtType.Datatype (native_string_lit "@Tuple") d :=
          dt_tester_arg_datatype_of_non_none hCondNN
        have hYNN : __smtx_typeof (__eo_to_smt y) ≠ SmtType.None := by
          rw [hYTy]
          simp
        have hYTypeFromIH :
            __eo_to_smt_type (__eo_typeof y) = SmtType.Datatype (native_string_lit "@Tuple") d :=
          (ihY hYNN).symm.trans hYTy
        have hTTy : T = SmtType.Datatype (native_string_lit "@Tuple") d :=
          hElse.symm.trans hYTy
        have hInnerTy :
            __smtx_typeof
                (__eo_to_smt_updater
          ...
          rw [typeof_ite_eq, hCond, hThen, hElse, hTTy]
          simp [__smtx_typeof_ite, native_ite, native_Teq]
        have hSmt : __smtx_typeof (__eo_to_smt t) = SmtType.Datatype (native_string_lit "@Tuple") d := by
          rw [hTranslate]
        ...
        have hNthValidRec :
          ...
          eo_type_valid_rec_tuple_list_nth_rec_nat
            (T := __eo_typeof y) (d := d) (j := native_int_to_nat n)
            hYTypeFromIH hYValidRec hIdxNat
        have hNthValid :
            eo_type_valid_rec []
              (__eo_list_nth (Term.UOp UserOp.Tuple) (__eo_typeof y)
                (Term.Numeral n)) := by
        ...
        have hNthNN :
          ...
          rw [← hRetNth]
          exact hRetNN
        have hEo : __eo_to_smt_type (__eo_typeof t) = SmtType.Datatype (native_string_lit "@Tuple") d := by
          have hCore :=
  ...
  case UOp op =>
    ...
    case str_replace =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_seq_triop
        UserOp.str_replace SmtTerm.str_replace x y z ihZ ihY ihX
        (by
          conv =>
            lhs
            unfold __eo_to_smt)
    ...
    case str_replace_all =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_seq_triop
        UserOp.str_replace_all SmtTerm.str_replace_all x y z ihZ ihY ihX
        (by
          conv =>
            lhs
            unfold __eo_to_smt)
    ...
    case str_replace_re =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_str_replace_re_like
        UserOp.str_replace_re SmtTerm.str_replace_re x y z
        (by
          conv =>
            lhs
            unfold __eo_to_smt)
    ...
    case str_replace_re_all =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_str_replace_re_like
        UserOp.str_replace_re_all SmtTerm.str_replace_re_all x y z
        (by
          conv =>
            lhs
            unfold __eo_to_smt)
    ...
    case or =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.or (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
              unfold __eo_to_smt) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case and =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.and (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case imp =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.imp (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case xor =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.xor (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case eq =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.eq (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case plus =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.plus (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case neg =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.neg (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case mult =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.mult (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case lt =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.lt (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case leq =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.leq (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case gt =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.gt (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case geq =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.geq (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case div =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.div (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case mod =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.mod (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case multmult =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.multmult (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case divisible =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.divisible (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case div_total =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.div_total (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case mod_total =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.mod_total (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case multmult_total =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.multmult_total (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case concat =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.concat (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvand =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvand (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvor =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvor (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvnand =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvnand (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvnor =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvnor (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvxor =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvxor (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvxnor =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvxnor (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvcomp =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvcomp (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvadd =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvadd (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvmul =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvmul (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvudiv =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvudiv (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvurem =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvurem (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvsub =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvsub (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvsdiv =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvsdiv (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvsrem =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvsrem (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvsmod =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvsmod (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvult =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvult (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvule =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvule (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvugt =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvugt (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvuge =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvuge (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvslt =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvslt (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvsle =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvsle (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvsgt =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvsgt (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvsge =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvsge (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvshl =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvshl (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvlshr =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvlshr (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvashr =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvashr (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvuaddo =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvuaddo (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvsaddo =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvsaddo (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvumulo =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvumulo (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvsmulo =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvsmulo (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvusubo =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvusubo (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvssubo =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvssubo (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvsdivo =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.bvsdivo (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case select =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.select (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case str_concat =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.str_concat (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case str_contains =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.str_contains (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case str_at =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.str_at (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case str_prefixof =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.str_prefixof (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case str_suffixof =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.str_suffixof (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case str_lt =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.str_lt (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case str_leq =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.str_leq (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case re_range =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.re_range (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case re_concat =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.re_concat (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case re_inter =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.re_inter (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case re_union =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.re_union (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case re_diff =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.re_diff (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case str_in_re =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.str_in_re (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case seq_nth =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.seq_nth (__eo_to_smt z) (__eo_to_smt y)) (by
          first
          | rfl
          | conv =>
              lhs
    ...
    case bvultbv =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_bv_cmp_to_bv1_applied
        UserOp.bvultbv SmtTerm.bvult x y z
        (by
          conv =>
            lhs
            unfold __eo_to_smt
    ...
    case bvsltbv =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_bv_cmp_to_bv1_applied
        UserOp.bvsltbv SmtTerm.bvslt x y z
        (by
          conv =>
            lhs
            unfold __eo_to_smt
    ...
    case set_inter =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.set_inter (__eo_to_smt z) (__eo_to_smt y))
        (by
          conv =>
            lhs
            unfold __eo_to_smt)
    ...
    case set_minus =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_non_special_head
        ...
        (SmtTerm.set_minus (__eo_to_smt z) (__eo_to_smt y))
        (by
          conv =>
            lhs
            unfold __eo_to_smt)
    ...
    case set_choose =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_generic_application_head
        (Term.UOp UserOp.set_choose) z y x ihFAll ihXAll
        (by
          conv =>
            lhs
            unfold __eo_to_smt)
    ...
    case _at_strings_occur_index =>
      exact eo_to_smt_typeof_matches_translation_apply_apply_apply_none_head
        UserOp._at_strings_occur_index z y x
        (by
          conv =>
            lhs
            unfold __eo_to_smt
    ...
    case _at_strings_stoi_non_digit =>
      ...
      change
        __smtx_typeof
          ...
          SmtType.None
      exact
        typeof_apply_guard_closed_eq_none y
          (SmtTerm.str_indexof_re (__eo_to_smt y)
            (SmtTerm.re_comp
              (SmtTerm.re_range (SmtTerm.String (native_string_lit "0"))
                (SmtTerm.String (native_string_lit "9"))))
        ...
        typeof_apply_guard_closed_eq_none y
          (__eo_to_smt_guard_closed z
            (SmtTerm.choice_nth (native_string_lit "@x") SmtType.Int
              ...
              native_nat_zero))
          (__eo_to_smt x)
          (typeof_apply_guard_closed_eq_none z
            (SmtTerm.choice_nth (native_string_lit "@x") SmtType.Int
              (SmtTerm.not
                (SmtTerm.eq
                  (SmtTerm.str_substr (__eo_to_smt y)
            ...
            (by
              ...
              have hInner :=
                __eo_to_smt_guard_closed_eq_of_ne_none h
                  (by intro hNone; cases hNone)
              have hBody :=
                __eo_to_smt_guard_closed_eq_of_ne_none hInner
                  (by intro hNone; cases hNone)
              unfold native_ite at hBody
              split at hBody <;> cases hBody)
            (by
              intro s d i h
              unfold __eo_to_smt at h
              have hInner :=
