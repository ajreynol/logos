...
theorem eo_to_smt_typeof_matches_translation_apply
    ...
    case Apply f z =>
      ...
      case bvite =>
        ...
        have hSmt :
          ...
          change
            __smtx_typeof_ite
              (__smtx_typeof (SmtTerm.eq (__eo_to_smt z) (SmtTerm.Binary 1 1)))
              (__smtx_typeof (__eo_to_smt y))
      ...
      case bvultbv =>
        ...
        rcases hHead with hHead | hHead <;> cases (hBitVec1.symm.trans (hHeadTy.symm.trans hHead))
      case bvsltbv =>
        let head :=
          SmtTerm.ite
      ...
      case set_member =>
        ...
        rcases hHead with hHead | hHead <;> cases (hHeadTy.symm.trans hHead)
      case set_subset =>
        have hHeadTranslate :
  ...
  case set_empty T =>
    ...
    | Set U =>
        ...
        cases hWf : __smtx_type_wf U <;>
          simp [__eo_to_smt_set_empty, __smtx_typeof_apply,
            __smtx_typeof_guard_wf, hInh, hWf, native_ite]
    | None
    | Bool
    | Int
    | Real
