...
private theorem eo_to_smt_re_mult_str_empty :
    __eo_to_smt (Term.Apply Term.re_mult (Term.Apply Term.str_to_re (Term.String ""))) =
      SmtTerm.re_mult (SmtTerm.str_to_re (SmtTerm.String "")) := by
  rfl
...
private theorem typed___eo_prog_re_star_emp :
  ...
  exact RuleProofs.eo_has_bool_type_eq_of_same_smt_type
    ...
    (Term.Apply Term.str_to_re (Term.String ""))
    (by
      rw [eo_to_smt_re_mult_str_empty, eo_to_smt_str_to_re_empty]
      simp [__smtx_typeof, native_ite, native_Teq])
    (by
      rw [eo_to_smt_re_mult_str_empty]
      simp [__smtx_typeof, native_ite, native_Teq])
...
private theorem facts___eo_prog_re_star_emp (M : SmtModel) :
  ...
  · have hEvalEq :
      ...
      simp [__smtx_model_eval, __smtx_model_eval_re_mult, __smtx_model_eval_str_to_re,
        native_re_mult, native_re_mk_star, native_str_to_re, native_re_of_list,
