          ...
          | UOp op =>
              ...
              · cases hNTy : __eo_typeof n1 with
                | UOp nop =>
                    ...
                    · have hReqTy :
                          __eo_typeof_eq
                              (__eo_requires (__eo_eq w n1) (Term.Boolean true) Term.Bool)
                              Term.Bool =
                            Term.Bool := by
                      ...
                      have hEq : n1 = w :=
                        eq_of_requires_eq_true_not_stuck w n1 Term.Bool hReqNN
                      subst n1
...
private theorem eval_bvult_zero_2_false
  ...
  rw [__smtx_model_eval.eq_55, hEvalX1, hZeroEval]
  simp [__eo_to_smt__at_bv, native_ite, hNonneg, __smtx_model_eval_bvult,
