...
theorem eo_has_bool_type_not_of_bool_arg (t : Term) :
  ...
  simp [hTy, smt_lit_ite, smt_lit_Teq]
...
theorem eo_has_bool_type_not_arg (t : Term) :
  ...
  · have : False := by
      ...
      simp [hT, smt_lit_ite, smt_lit_Teq] at hTy
      ...
      | intro_true htyB hEvalB =>
          ...
          · change smt_lit_ite (smt_lit_Teq (__smtx_typeof (__eo_to_smt A)) SmtType.Bool)
                (smt_lit_ite (smt_lit_Teq (__smtx_typeof (__eo_to_smt B)) SmtType.Bool)
                  SmtType.Bool SmtType.None)
                SmtType.None = SmtType.Bool
            simp [htyA, htyB, smt_lit_Teq, smt_lit_ite]
          · change __smtx_model_eval_and
                (__smtx_model_eval M (__eo_to_smt A))
                (__smtx_model_eval M (__eo_to_smt B)) = SmtValue.Boolean true
            rw [hEvalA, hEvalB]
            simp [__smtx_model_eval_and, SmtEval.smt_lit_and]
          ...
          have hEvalB : __smtx_model_eval M (__eo_to_smt B) = SmtValue.Boolean true := by
            ...
            cases hBeval : __smtx_model_eval M (__eo_to_smt B) <;>
              simp [hEvalA, hBeval, __smtx_model_eval_imp, __smtx_model_eval_or,
                __smtx_model_eval_not, SmtEval.smt_lit_or, SmtEval.smt_lit_not] at hEvalImp
            case Boolean a =>
      ...
      | intro_true htyB hEvalB =>
          ...
          · change __smtx_model_eval_imp
            ...
            simp [__smtx_model_eval_imp, __smtx_model_eval_or,
              __smtx_model_eval_not, SmtEval.smt_lit_or, SmtEval.smt_lit_not]
...
theorem eo_interprets_not_of_false (M : SmtModel) (t : Term) :
  ...
  | intro_false hTy hEval =>
      ...
      · change __smtx_model_eval_not (__smtx_model_eval M (__eo_to_smt t)) =
        ...
        rw [hEval]
        simp [__smtx_model_eval_not, SmtEval.smt_lit_not]
...
theorem eo_interprets_not_true_implies_false (M : SmtModel) (t : Term) :
  ...
  | intro_true hty hEval =>
      have htyt : __smtx_typeof (__eo_to_smt t) = SmtType.Bool := by
        change smt_lit_ite (smt_lit_Teq (__smtx_typeof (__eo_to_smt t)) SmtType.Bool)
            SmtType.Bool SmtType.None = SmtType.Bool at hty
        simpa [smt_lit_Teq, smt_lit_ite] using hty
      change __smtx_model_eval_not (__smtx_model_eval M (__eo_to_smt t)) =
          SmtValue.Boolean true at hEval
      cases ht : __smtx_model_eval M (__eo_to_smt t) with
      | NotValue =>
          exfalso
          simpa [__smtx_model_eval_not, ht, SmtEval.smt_lit_not] using hEval
      | Boolean b =>
          cases b with
          | false =>
