...
private theorem typeof_arg_of_prog_arith_int_div_total_zero_bool
  ...
  cases hT1 : __eo_typeof t1 <;>
    simp [__eo_prog_arith_int_div_total_zero, hT1] at h
...
private theorem typed___eo_prog_arith_int_div_total_zero_impl
  ...
  have hT1Ty : __eo_typeof t1 = Term.Int :=
    typeof_arg_of_prog_arith_int_div_total_zero_bool t1 hResultTy
...
private theorem facts___eo_prog_arith_int_div_total_zero_impl
  ...
  have hEvalLhs :
    ...
    rw [eo_to_smt_div_total_eq]
    simp [__smtx_model_eval, hEvalT1, hEval0, __smtx_model_eval_div_total]
  ...
  | cons a1 args =>
      ...
      | nil =>
          ...
          | nil =>
              ...
              · change RuleProofs.eo_has_bool_type (__eo_prog_arith_int_div_total_zero T1)
                exact typed___eo_prog_arith_int_div_total_zero_impl T1 hT1Trans hResultTy
          | cons _ _ =>
              change Term.Stuck ≠ Term.Stuck at hProg
              exact False.elim (hProg rfl)
      | cons _ _ =>
