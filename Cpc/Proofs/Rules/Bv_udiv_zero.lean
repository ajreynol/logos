    ...
    __eo_prog_bv_udiv_zero x1 n1 =
      Term.Apply (Term.Apply (Term.UOp UserOp.eq)
        (Term.Apply (Term.Apply (Term.UOp UserOp.bvudiv) x1)
          (Term.UOp2 UserOp2._at_bv (Term.Numeral 0) n1)))
          ...
          | UOp op =>
              ...
              · exfalso
                simpa [__eo_typeof_eq, __eo_typeof_bvand, __eo_typeof_bvnot,
                  __eo_typeof__at_bv, __eo_requires, __eo_eq, native_ite,
              ...
              · cases hNTy : __eo_typeof n1 with
                | UOp nop =>
                    ...
                    · have hReqTy :
                          __eo_typeof_eq
                              (__eo_requires (__eo_eq w n1) (Term.Boolean true)
                                (Term.Apply (Term.UOp UserOp.BitVec) w))
                              (Term.Apply (Term.UOp UserOp.BitVec) n1) =
                            Term.Bool := by
                        simpa [__eo_typeof_bvand, __eo_typeof_bvnot,
                          __eo_typeof__at_bv, hXTy, hNTy] using hTy
                      have hReqNN :
                          __eo_requires (__eo_eq w n1) (Term.Boolean true)
                              (Term.Apply (Term.UOp UserOp.BitVec) w) ≠
                            Term.Stuck := by
                      ...
                      have hEq : n1 = w :=
                        eq_of_requires_eq_true_not_stuck w n1
...
private theorem eval_bvudiv_zero_eq_bvnot_zero
  ...
  rw [show __smtx_model_eval M
      ...
      __smtx_model_eval_bvudiv
        ...
        (__smtx_model_eval M
          (__eo_to_smt (Term.UOp2 UserOp2._at_bv (Term.Numeral 0) (Term.Numeral n)))) by
