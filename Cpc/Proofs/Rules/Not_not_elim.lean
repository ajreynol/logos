          ...
          | nil =>
              ...
              · exact eoHasSmtTranslation.of_has_bool_type
                  ...
                  (by
                    ...
                    change eoUOpIndicesClosed (__eo_prog_not_not_elim (Proof.pf X1))
                    ...
                    | Apply f inner =>
                        ...
                        cases f with
                        | UOp op =>
                            cases op <;> simp [__eo_prog_not_not_elim, eoUOpIndicesClosed]
                            case not =>
                              cases inner with
                              | Apply f' F =>
                                  cases f' with
                                  | UOp op' =>
                                      ...
                                      case not =>
                                        ...
                                        exact hX1Closed
                                  | _ =>
                                      simp [__eo_prog_not_not_elim, eoUOpIndicesClosed]
                              | _ =>
                                  simp [__eo_prog_not_not_elim, eoUOpIndicesClosed]
                        | _ =>
                            simp [__eo_prog_not_not_elim, eoUOpIndicesClosed]
