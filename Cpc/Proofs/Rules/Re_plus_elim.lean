...
private theorem typed___eo_prog_re_plus_elim_impl
  ...
  simpa [lhs, rhs, __eo_prog_re_plus_elim] using hBoolEq
...
private theorem facts___eo_prog_re_plus_elim_impl
  ...
  have hBool :
      RuleProofs.eo_has_bool_type (Term.Apply (Term.Apply Term.eq lhs) rhs) := by
    simpa [lhs, rhs, __eo_prog_re_plus_elim] using
      typed___eo_prog_re_plus_elim_impl a1 hA1Trans hA1Ty
  apply RuleProofs.eo_interprets_eq_of_rel M lhs rhs hBool
  cases hEval : __smtx_model_eval M (__eo_to_smt a1) <;>
    simp [RuleProofs.smt_value_rel, lhs, rhs, __eo_to_smt.eq_def, hEval,
      __smtx_model_eval, __smtx_model_eval_re_plus, __smtx_model_eval_re_concat,
      __smtx_model_eval_re_mult, __smtx_model_eval_str_to_re, native_re_plus,
      native_re_concat, native_re_mult, native_str_to_re, native_re_of_list,
      native_re_mk_concat, native_re_mk_star, native_veq, native_pack_string,
      native_pack_seq, native_unpack_string, __smtx_ssm_string_of_char_values,
      __smtx_ssm_char_values_of_string, native_unpack_seq]
          ...
          | nil =>
              ...
              have hA1Ty : __eo_typeof a1 = Term.RegLan := by
                cases hTy : __eo_typeof a1 <;>
                  simp [__eo_prog_re_plus_elim, hTy] at hResultTy
                exact hTy
