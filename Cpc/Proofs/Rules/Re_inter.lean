...
private theorem re_inter_result_has_bool_type_of_premises_bool
  ...
  simp [hArgsXR.1, hArgsXR.2, hArgsXT.2, __smtx_typeof.eq_re_all,
...
private theorem facts_re_inter
  ...
  | intro_true _ hEvalXR =>
      ...
      | intro_true _ hEvalXT =>
          ...
          rw [__smtx_model_eval.eq_str_in_re, __smtx_model_eval.eq_re_inter,
            __smtx_model_eval.eq_re_inter, __smtx_model_eval.eq_re_all]
          change __smtx_model_eval M
          ...
          rw [__smtx_model_eval.eq_str_in_re] at hEvalXR hEvalXT
