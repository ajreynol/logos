...
private theorem typeof_arg_of_prog_arith_int_div_total_one_bool
  ...
  cases hT1 : __eo_typeof t1 <;>
    simp [__eo_prog_arith_int_div_total_one, hT1] at h
...
private theorem typed___eo_prog_arith_int_div_total_one_impl
  ...
  have hT1Ty : __eo_typeof t1 = Term.Int :=
    typeof_arg_of_prog_arith_int_div_total_one_bool t1 hResultTy
  ...
  | cons a1 args =>
      ...
      | nil =>
          ...
          | nil =>
              ...
              · change RuleProofs.eo_has_bool_type (__eo_prog_arith_int_div_total_one T1)
                exact typed___eo_prog_arith_int_div_total_one_impl T1 hT1Trans hResultTy
          | cons _ _ =>
              change Term.Stuck ≠ Term.Stuck at hProg
              exact False.elim (hProg rfl)
      | cons _ _ =>
