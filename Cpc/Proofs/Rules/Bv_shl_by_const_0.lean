    ...
    __eo_prog_bv_shl_by_const_0 x1 sz1 =
      Term.Apply (Term.Apply (Term.UOp UserOp.eq)
        (Term.Apply (Term.Apply (Term.UOp UserOp.bvshl) x1)
          (Term.UOp2 UserOp2._at_bv (Term.Numeral 0) sz1))) x1 := by
  intro hX1 hSz1
  ...
  · by_cases hSz1 : sz1 = Term.Stuck
    ...
    · rw [prog_bv_shl_by_const_0_eq_of_ne_stuck x1 sz1 hX1 hSz1] at hTy
      change __eo_typeof_eq
          (__eo_typeof_bvand
            (__eo_typeof x1)
            (__eo_typeof__at_bv (Term.UOp UserOp.Int) (__eo_typeof sz1) sz1))
          (__eo_typeof x1) =
        Term.Bool at hTy
...
private theorem smt_typeof_bvshl_const_zero_eq_self
    ...
    __smtx_typeof
        (__eo_to_smt
          (Term.Apply (Term.Apply (Term.UOp UserOp.bvshl) x1)
            (Term.UOp2 UserOp2._at_bv (Term.Numeral 0) sz1))) =
