  ...
  | String s =>
      ...
      · subst hs
        ...
        · intro M
          ...
          simp [native_pack_string, native_pack_seq, __smtx_ssm_char_values_of_string]
                    ...
                    · refine ⟨__eo_to_smt_type U, ?_, ?_⟩
                      · have hGuard :
                        ...
                        have hTranslate :
                            __eo_to_smt
                                (Term.seq_empty (Term.Apply (Term.UOp UserOp.Seq) U)) =
                              SmtTerm.seq_empty (__eo_to_smt_type U) := by
                          change __eo_to_smt_seq_empty
                            (__eo_to_smt_type (Term.Apply (Term.UOp UserOp.Seq) U)) =
                            SmtTerm.seq_empty (__eo_to_smt_type U)
                          rw [TranslationProofs.eo_to_smt_type_seq, hGuard]
                          rfl
                          ...
                          | eq =>
                              ...
                              have hLenTy :
                                  __smtx_typeof (__eo_to_smt (Term.Apply Term.str_len s)) =
                                    SmtType.Int := by
                                change __smtx_typeof (SmtTerm.str_len (__eo_to_smt s)) =
                                  SmtType.Int
                              ...
                              | cons v vs =>
                                  ...
                                  let lenEq :=
                                    Term.Apply
                                      ...
                                      (Term.Numeral 0)
                                  have hEqLenBool :
                                      RuleProofs.eo_has_bool_type lenEq := by
                                    dsimp [lenEq]
                                    exact RuleProofs.eo_has_bool_type_eq_of_same_smt_type
                                        (Term.Apply Term.str_len s) (Term.Numeral 0)
                                        (by rw [hLenTy, hNumTy])
                                  ...
                                  have hEqLenFalse :
                                      eo_interprets M lenEq false := by
                                    exact RuleProofs.eo_interprets_of_bool_eval M lenEq false hEqLenBool <| by
                                      dsimp [lenEq]
                                      ...
                                      simp [__smtx_model_eval_eq, __smtx_value_eq, native_veq,
                                  ...
                                  simpa [__eo_prog_string_length_non_empty, hEmpty, __eo_requires,
                                    native_ite, native_teq, native_not, lenEq] using
                                    RuleProofs.eo_interprets_not_of_false M lenEq hEqLenFalse
                            ·
                              have hStuck :
                                  __eo_prog_string_length_non_empty
                                      (Proof.pf
                                        (Term.Apply (Term.UOp UserOp.not)
                                          (Term.Apply (Term.Apply (Term.UOp op') s) t))) =
                                    Term.Stuck := by
                                simp [__eo_prog_string_length_non_empty, hop]
