...
private theorem eo_typeof_set_member_eq_bool_info
    {A B : Term}
...
private theorem map_cons_head_key_type
...
private theorem map_cons_head_value_type
    {k v : SmtValue} {m : SmtMap} {A B : SmtType}
    (hTy : __smtx_typeof_map_value (SmtMap.cons k v m) = SmtType.Map A B) :
...
private theorem map_cons_tail_type
    {k v : SmtValue} {m : SmtMap} {A B : SmtType}
    (hTy : __smtx_typeof_map_value (SmtMap.cons k v m) = SmtType.Map A B) :
...
private theorem map_cons_tail_canonical
...
private theorem map_cons_head_key_canonical
    {k v : SmtValue} {m : SmtMap}
    (hCan : __smtx_map_canonical (SmtMap.cons k v m) = true) :
...
private theorem map_cons_tail_ordered
    {k v : SmtValue} {m : SmtMap}
    (hCan : __smtx_map_canonical (SmtMap.cons k v m) = true) :
...
private theorem set_map_cons_entry_true
