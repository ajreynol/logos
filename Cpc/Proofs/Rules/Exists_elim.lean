...
private theorem eo_to_smt_exists_body_bool_of_bool
  ...
  exact TranslationProofs.eo_to_smt_exists_body_bool_of_bool xs body
      ...
      case __eo_List_cons =>
        ...
        case Var name T =>
          ...
          case String s =>
            ...
            · simp [__eo_to_smt_exists, hWF, native_ite, __smtx_model_eval]
            · classical
              let P : Prop :=
                ∃ v : SmtValue,
              ...
              simp [P, Q, __eo_to_smt_exists, hWF, native_ite, __smtx_model_eval, hPropEq]
          all_goals
            subst hname
