...
private theorem typed_bv_mult_pow2_term
    (z size n exponent u : Term) :
    RuleProofs.eo_has_smt_translation z ->
    RuleProofs.eo_has_smt_translation size ->
    RuleProofs.eo_has_smt_translation n ->
...
private theorem bvmul_bitvec_values_mult_pow2
    (W : Nat) (x y : BitVec W) :
...
private theorem concat_zero_bitvec_value_mult_pow2
    (D E : Nat) (x : BitVec D) :
...
private theorem facts_bv_mult_pow2_term
    (M : SmtModel) (hM : model_total_typed M)
    (z size n exponent u : Term) :
    RuleProofs.eo_has_smt_translation z ->
    RuleProofs.eo_has_smt_translation size ->
...
private def bvMultPow2UpperPremRefs
...
private theorem bv_mult_pow2_guard_refs
    {size n exponent u sizeRef1 nRef1 exponentRef sizeRef2 nRef2 uRef
