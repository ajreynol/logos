...
private theorem typed___eo_prog_dt_collapse_tester_impl
    (a1 : Term) :
  ...
  · rcases hDt with ⟨d0, hCd, hCEq, hReserved⟩
    ...
    | Boolean bv =>
        ...
        | true =>
            ...
            have hHead :
                __vsm_apply_head (__smtx_model_eval M (__eo_to_smt t)) =
                  SmtValue.DtCons cs (__eo_to_smt_datatype d0) ci :=
...
private theorem facts___eo_prog_dt_collapse_tester_impl
