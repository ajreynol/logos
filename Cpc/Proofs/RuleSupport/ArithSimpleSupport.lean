...
private theorem eval_lt_not_geq_rel
  ...
  · have hEvalTValTy :
    ...
    rw [__smtx_model_eval.eq_lt, __smtx_model_eval.eq_not, __smtx_model_eval.eq_geq]
    rw [hEvalT, hEvalS]
...
private theorem eval_gt_not_geq_swap_rel
  ...
  · have hEvalTValTy :
    ...
    rw [__smtx_model_eval.eq_gt, __smtx_model_eval.eq_not, __smtx_model_eval.eq_geq]
    rw [hEvalT, hEvalS]
...
private theorem eval_int_lt_geq_succ_rel
  ...
  rw [__smtx_model_eval.eq_lt, __smtx_model_eval.eq_geq]
...
private theorem eval_int_gt_geq_succ_rel
  ...
  rw [__smtx_model_eval.eq_gt, __smtx_model_eval.eq_geq]
  rw [hEvalT, hEvalS, hEvalSucc]
  simp [__smtx_model_eval_gt, __smtx_model_eval_lt, __smtx_model_eval_geq,
...
private theorem eval_int_leq_not_geq_succ_rel
  ...
  rw [show __eo_to_smt
    ...
    rfl]
  rw [__smtx_model_eval.eq_leq, __smtx_model_eval.eq_not, __smtx_model_eval.eq_geq]
  rw [hEvalT, hEvalS, hEvalSucc]
...
private theorem eval_int_not_geq_geq_succ_rel
  ...
  rw [show __eo_to_smt
    ...
    rfl]
  rw [eo_to_smt_geq_eq]
  rw [__smtx_model_eval.eq_not, __smtx_model_eval.eq_geq, __smtx_model_eval.eq_geq]
  rw [hEvalT, hEvalS, hEvalSucc]
...
private theorem eval_eq_geq_leq_and_rel
  ...
  · have hSmtT : __smtx_typeof (__eo_to_smt t) = SmtType.Int :=
    ...
    rw [show __eo_to_smt (eqElimRhs t s) =
      ...
      rfl]
    rw [smtx_eval_eq_term_eq, __smtx_model_eval.eq_and,
      __smtx_model_eval.eq_geq, __smtx_model_eval.eq_and,
      __smtx_model_eval.eq_leq, __smtx_model_eval.eq_Boolean]
    rw [hEvalT, hEvalS]
...
theorem facts_arith_elim_leq
  ...
  exact RuleProofs.eo_interprets_eq_of_rel M
    ...
    hBool' <| by
      ...
      rw [__smtx_model_eval.eq_leq, __smtx_model_eval.eq_geq]
...
private theorem eval_geq_sub_zero_int_rel
  ...
  rw [__smtx_model_eval.eq_geq, __smtx_model_eval.eq_geq,
    __smtx_model_eval.eq_neg, __smtx_model_eval.eq_Numeral]
  rw [hEvalT, hEvalS]
...
private theorem eval_geq_sub_zero_real_rel
  ...
  rw [__smtx_model_eval.eq_geq, __smtx_model_eval.eq_geq,
    __smtx_model_eval.eq_neg, __smtx_model_eval.eq_Rational]
  rw [hEvalT, hEvalS]
  simp [__smtx_model_eval_geq, __smtx_model_eval_leq, __smtx_model_eval__]
  change __smtx_model_eval_eq
...
private theorem eval_to_int_to_real_rel
  ...
  rw [__smtx_model_eval.eq_to_int, __smtx_model_eval.eq_to_real, hEvalT]
...
private theorem eval_min_lt1_rel
  ...
  · have hSmtT : __smtx_typeof (__eo_to_smt t) = SmtType.Int :=
    ...
    rw [__smtx_model_eval.eq_leq, smtx_eval_ite_term_eq,
      __smtx_model_eval.eq_lt, __smtx_model_eval.eq_Boolean]
    rw [hEvalT, hEvalS]
  ...
  · have hSmtT : __smtx_typeof (__eo_to_smt t) = SmtType.Int :=
    ...
    rw [show __eo_to_smt (relTerm UserOp.geq (maxGeqTerm t s) t) =
        SmtTerm.geq
          ...
          (__eo_to_smt t) by rfl]
    rw [show __eo_to_smt (Term.Boolean true) = SmtTerm.Boolean true by rfl]
    rw [__smtx_model_eval.eq_geq, smtx_eval_ite_term_eq,
      __smtx_model_eval.eq_geq, __smtx_model_eval.eq_Boolean]
    rw [hEvalT, hEvalS]
