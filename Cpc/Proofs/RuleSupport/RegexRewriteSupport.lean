...
theorem nativeListInRe_mk_star_swap
  ...
  | char c => simpa' [native_re_mk_star] using nativeListInRe_raw_star_swap xs (SmtRegLan.char c)
  | range lo hi => simpa' [native_re_mk_star] using nativeListInRe_raw_star_swap xs (SmtRegLan.range lo hi)
  | allchar => simpa' [native_re_mk_star] using nativeListInRe_raw_star_swap xs SmtRegLan.allchar
  | concat r s => simpa' [native_re_mk_star] using nativeListInRe_raw_star_swap xs (SmtRegLan.concat r s)
  | union r s => simpa' [native_re_mk_star] using nativeListInRe_raw_star_swap xs (SmtRegLan.union r s)
  | inter r s => simpa' [native_re_mk_star] using nativeListInRe_raw_star_swap xs (SmtRegLan.inter r s)
  | comp r => simpa' [native_re_mk_star] using nativeListInRe_raw_star_swap xs (SmtRegLan.comp r)
...
theorem native_includes_star_epsilon (r : SmtRegLan) :
  ...
  simpa' [native_str_in_re, native_string_valid, native_re_mult, nativeListInRe] using hNil
