...
theorem eo_prog_concat_split_premise_shapes_of_ne_stuck
    (rev x1 x2 : Term)
    (hProg :
...
theorem concat_split_lengths_ne_of_not_len_eq
    (M : SmtModel) (hM : model_total_typed M)
    (x y : Term) (T : SmtType)
    (hxTy : __smtx_typeof (__eo_to_smt x) = SmtType.Seq T)
    (hyTy : __smtx_typeof (__eo_to_smt y) = SmtType.Seq T)
...
theorem concat_split_lengths_ne_of_not_len_eq_eval
...
theorem facts_concat_split_false_formula
    (M : SmtModel) (hM : model_total_typed M)
...
theorem facts_concat_split_true_formula
    (M : SmtModel) (hM : model_total_typed M)
...
theorem step_concat_split_core
    (M : SmtModel) (hM : model_total_typed M)
    (rev t s tc sc : Term)
