...
partial def __eo_to_smt : Term -> SmtTerm
  ...
  | (Term.Apply Term.int_ispow2 x1) => (__eo_to_smt (Term.Apply (Term.Apply Term.and (Term.Apply (Term.Apply Term.geq x1) (Term.Numeral 0))) (Term.Apply (Term.Apply Term.eq x1) (Term.Apply Term.int_pow2 (Term.Apply Term.int_log2 x1)))))
  ...
  | (Term.Apply Term._at_div_by_zero x1) => (__eo_to_smt (Term.Apply (Term.Apply Term.qdiv x1) (Term.Rational (eo_lit_mk_rational 0 1))))
