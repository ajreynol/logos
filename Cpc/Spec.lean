...
def __eo_to_smt : Term -> SmtTerm
  ...
  | (Term.Apply (Term.Apply (Term.Apply Term.bvite x1) x2) x3) => (SmtTerm.Apply (SmtTerm.Apply (SmtTerm.Apply SmtTerm.bvite (__eo_to_smt x1)) (__eo_to_smt x2)) (__eo_to_smt x3))
