...
def __eo_to_smt : Term -> SmtTerm
  ...
  | (Term.Apply (Term.Apply (Term.Apply (Term.UOp UserOp._at_strings_occur_index) x1) x2) x3) => 
    let _v0 := (__eo_to_smt x3)
    let _v1 := (SmtTerm.Numeral 0)
    let _v2 := (SmtTerm.Numeral 1)
    let _v4 := (SmtTerm.Var (native_string_lit "@x") SmtType.Int)
    let _v5 := (__eo_to_smt x1)
    let _v6 := (SmtTerm.str_substr _v5 _v1 (SmtTerm.neg _v4 _v2))
    let _v7 := (__eo_to_smt x2)
    let _v8 := (SmtTerm.str_substr _v5 _v1 _v4)
    (SmtTerm.choice (native_string_lit "@x") SmtType.Int (SmtTerm.and (SmtTerm.geq _v4 _v1) (SmtTerm.and (SmtTerm.eq (SmtTerm.neg (SmtTerm.str_len (SmtTerm.str_replace_all _v8 _v7 (SmtTerm.str_substr _v8 _v1 _v2))) (SmtTerm.str_len (SmtTerm.str_replace_all _v8 _v7 (SmtTerm.str_substr _v8 _v1 _v1)))) _v0) (SmtTerm.or (SmtTerm.eq _v4 _v1) (SmtTerm.lt (SmtTerm.neg (SmtTerm.str_len (SmtTerm.str_replace_all _v6 _v7 (SmtTerm.str_substr _v6 _v1 _v2))) (SmtTerm.str_len (SmtTerm.str_replace_all _v6 _v7 (SmtTerm.str_substr _v6 _v1 _v1)))) _v0)))))
  | (Term.Apply (Term.Apply (Term.Apply (Term.UOp UserOp._at_strings_occur_index_re) x1) x2) x3) => 
    ...
    let _v7 := (__eo_to_smt x2)
    let _v8 := (SmtTerm.str_substr _v5 _v1 _v4)
    (SmtTerm.choice (native_string_lit "@x") SmtType.Int (SmtTerm.and (SmtTerm.geq _v4 _v1) (SmtTerm.and (SmtTerm.eq (SmtTerm.neg (SmtTerm.str_len (SmtTerm.str_replace_re_all _v8 _v7 (SmtTerm.str_substr _v8 _v1 _v2))) (SmtTerm.str_len (SmtTerm.str_replace_re_all _v8 _v7 (SmtTerm.str_substr _v8 _v1 _v1)))) _v0) (SmtTerm.or (SmtTerm.eq _v4 _v1) (SmtTerm.lt (SmtTerm.neg (SmtTerm.str_len (SmtTerm.str_replace_re_all _v6 _v7 (SmtTerm.str_substr _v6 _v1 _v2))) (SmtTerm.str_len (SmtTerm.str_replace_re_all _v6 _v7 (SmtTerm.str_substr _v6 _v1 _v1)))) _v0)))))
  | (Term.Apply (Term.Apply (Term.Apply (Term.Apply (Term.UOp UserOp._at_strings_replace_all_result) x1) x2) x3) x4) => 
    let _v0 := (__eo_to_smt x2)
    let _v1 := (__eo_to_smt x1)
    let _v2 := (__eo_to_smt x4)
    let _v3 := (SmtTerm.Numeral 0)
    let _v4 := (SmtTerm.Numeral 1)
    let _v6 := (SmtTerm.Var (native_string_lit "@x") SmtType.Int)
    let _v7 := (SmtTerm.str_substr _v1 _v3 (SmtTerm.neg _v6 _v4))
    let _v8 := (SmtTerm.str_substr _v1 _v3 _v6)
    (SmtTerm.str_replace_all (SmtTerm.str_substr _v1 (SmtTerm.choice (native_string_lit "@x") SmtType.Int (SmtTerm.and (SmtTerm.geq _v6 _v3) (SmtTerm.and (SmtTerm.eq (SmtTerm.neg (SmtTerm.str_len (SmtTerm.str_replace_all _v8 _v0 (SmtTerm.str_substr _v8 _v3 _v4))) (SmtTerm.str_len (SmtTerm.str_replace_all _v8 _v0 (SmtTerm.str_substr _v8 _v3 _v3)))) _v2) (SmtTerm.or (SmtTerm.eq _v6 _v3) (SmtTerm.lt (SmtTerm.neg (SmtTerm.str_len (SmtTerm.str_replace_all _v7 _v0 (SmtTerm.str_substr _v7 _v3 _v4))) (SmtTerm.str_len (SmtTerm.str_replace_all _v7 _v0 (SmtTerm.str_substr _v7 _v3 _v3)))) _v2))))) (SmtTerm.str_len _v1)) _v0 (__eo_to_smt x3))
  | (Term.Apply (Term.Apply (Term.Apply (Term.Apply (Term.UOp UserOp._at_strings_replace_re_all_result) x1) x2) x3) x4) => 
    ...
    let _v7 := (SmtTerm.str_substr _v1 _v3 (SmtTerm.neg _v6 _v4))
    let _v8 := (SmtTerm.str_substr _v1 _v3 _v6)
    (SmtTerm.str_replace_re_all (SmtTerm.str_substr _v1 (SmtTerm.choice (native_string_lit "@x") SmtType.Int (SmtTerm.and (SmtTerm.geq _v6 _v3) (SmtTerm.and (SmtTerm.eq (SmtTerm.neg (SmtTerm.str_len (SmtTerm.str_replace_re_all _v8 _v0 (SmtTerm.str_substr _v8 _v3 _v4))) (SmtTerm.str_len (SmtTerm.str_replace_re_all _v8 _v0 (SmtTerm.str_substr _v8 _v3 _v3)))) _v2) (SmtTerm.or (SmtTerm.eq _v6 _v3) (SmtTerm.lt (SmtTerm.neg (SmtTerm.str_len (SmtTerm.str_replace_re_all _v7 _v0 (SmtTerm.str_substr _v7 _v3 _v4))) (SmtTerm.str_len (SmtTerm.str_replace_re_all _v7 _v0 (SmtTerm.str_substr _v7 _v3 _v3)))) _v2))))) (SmtTerm.str_len _v1)) _v0 (__eo_to_smt x3))
