...
def __eo_to_smt : Term -> SmtTerm
  ...
  | (Term.UOp2 UserOp2._at_array_deq_diff x1 x2) =>
    ...
    (native_ite (native_Teq _v0 SmtType.None) SmtTerm.None (SmtTerm.map_diff (__eo_to_smt x1) (__eo_to_smt x2)))
  ...
  | (Term.Apply (Term.UOp UserOp.set_choose) x1) =>
    ...
    (SmtTerm.map_diff (__eo_to_smt x1) (SmtTerm.set_empty _v0))
