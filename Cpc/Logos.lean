...
partial def __eo_extract : Term -> Term -> Term -> Term
  ...
  | (Term.Binary w n1), (Term.Numeral n2), (Term.Numeral n3) => (eo_lit_ite (eo_lit_or (eo_lit_zlt n2 0) (eo_lit_zlt (eo_lit_zplus n3 (eo_lit_zneg n2)) 0)) (Term.Binary 0 0) (__eo_mk_binary (eo_lit_zplus (eo_lit_zplus n3 (eo_lit_zneg n2)) 1) (eo_lit_binary_extract w n1 n2 n3)))
  | _, _, _ => Term.Stuck
...
def __eo_invoke_cmd : CState -> CCmd -> CState
  ...
  | S, (CCmd.step CRule.scope CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_invoke_cmd_pop_scope S (Proof.pf (__eo_state_proven_nth S n1)))
  | S, (CCmd.step CRule.process_scope (CArgList.cons a1 CArgList.nil) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_process_scope a1 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.ite_eq (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_ite_eq a1) S)
  | S, (CCmd.step CRule.split (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_split a1) S)
  | S, (CCmd.step CRule.resolution (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_resolution a1 a2 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.chain_resolution (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) premises) => (__eo_push_proven (__eo_prog_chain_resolution a1 a2 (Proof.pf (__eo_mk_premise_list Term.and premises S))) S)
  | S, (CCmd.step CRule.chain_m_resolution (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) premises) => (__eo_push_proven (__eo_prog_chain_m_resolution a1 a2 a3 (Proof.pf (__eo_mk_premise_list Term.and premises S))) S)
  | S, (CCmd.step CRule.factoring CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_factoring (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.reordering (CArgList.cons a1 CArgList.nil) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_reordering a1 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.eq_resolve CArgList.nil (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_eq_resolve (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.modus_ponens CArgList.nil (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_modus_ponens (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.not_not_elim CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_not_not_elim (Proof.pf (__eo_state_proven_nth S n1))) S)
  ...
  | S, (CCmd.step CRule.and_elim (CArgList.cons a1 CArgList.nil) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_and_elim a1 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.and_intro CArgList.nil premises) => (__eo_push_proven (__eo_prog_and_intro (Proof.pf (__eo_mk_premise_list Term.and premises S))) S)
  | S, (CCmd.step CRule.not_or_elim (CArgList.cons a1 CArgList.nil) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_not_or_elim a1 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.implies_elim CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_implies_elim (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.not_implies_elim1 CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_not_implies_elim1 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.not_implies_elim2 CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_not_implies_elim2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.equiv_elim1 CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_equiv_elim1 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.equiv_elim2 CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_equiv_elim2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.not_equiv_elim1 CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_not_equiv_elim1 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.not_equiv_elim2 CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_not_equiv_elim2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.xor_elim1 CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_xor_elim1 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.xor_elim2 CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_xor_elim2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.not_xor_elim1 CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_not_xor_elim1 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.not_xor_elim2 CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_not_xor_elim2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.ite_elim1 CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_ite_elim1 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.ite_elim2 CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_ite_elim2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.not_ite_elim1 CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_not_ite_elim1 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.not_ite_elim2 CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_not_ite_elim2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.not_and CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_not_and (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.cnf_and_pos (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_cnf_and_pos a1 a2) S)
  | S, (CCmd.step CRule.cnf_and_neg (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_cnf_and_neg a1) S)
  | S, (CCmd.step CRule.cnf_or_pos (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_cnf_or_pos a1) S)
  | S, (CCmd.step CRule.cnf_or_neg (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_cnf_or_neg a1 a2) S)
  | S, (CCmd.step CRule.cnf_implies_pos (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_cnf_implies_pos a1) S)
  | S, (CCmd.step CRule.cnf_implies_neg1 (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_cnf_implies_neg1 a1) S)
  | S, (CCmd.step CRule.cnf_implies_neg2 (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_cnf_implies_neg2 a1) S)
  | S, (CCmd.step CRule.cnf_equiv_pos1 (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_cnf_equiv_pos1 a1) S)
  | S, (CCmd.step CRule.cnf_equiv_pos2 (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_cnf_equiv_pos2 a1) S)
  | S, (CCmd.step CRule.cnf_equiv_neg1 (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_cnf_equiv_neg1 a1) S)
  | S, (CCmd.step CRule.cnf_equiv_neg2 (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_cnf_equiv_neg2 a1) S)
  | S, (CCmd.step CRule.cnf_xor_pos1 (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_cnf_xor_pos1 a1) S)
  | S, (CCmd.step CRule.cnf_xor_pos2 (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_cnf_xor_pos2 a1) S)
  | S, (CCmd.step CRule.cnf_xor_neg1 (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_cnf_xor_neg1 a1) S)
  | S, (CCmd.step CRule.cnf_xor_neg2 (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_cnf_xor_neg2 a1) S)
  | S, (CCmd.step CRule.cnf_ite_pos1 (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_cnf_ite_pos1 a1) S)
  | S, (CCmd.step CRule.cnf_ite_pos2 (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_cnf_ite_pos2 a1) S)
  | S, (CCmd.step CRule.cnf_ite_pos3 (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_cnf_ite_pos3 a1) S)
  | S, (CCmd.step CRule.cnf_ite_neg1 (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_cnf_ite_neg1 a1) S)
  | S, (CCmd.step CRule.cnf_ite_neg2 (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_cnf_ite_neg2 a1) S)
  | S, (CCmd.step CRule.cnf_ite_neg3 (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_cnf_ite_neg3 a1) S)
  | S, (CCmd.step CRule.arrays_read_over_write (CArgList.cons a1 CArgList.nil) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_arrays_read_over_write a1 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.arrays_read_over_write_contra CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_arrays_read_over_write_contra (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.arrays_read_over_write_1 (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_arrays_read_over_write_1 a1) S)
  | S, (CCmd.step CRule.arrays_ext CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_arrays_ext (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.refl (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_refl a1) S)
  ...
  | S, (CCmd.step CRule.trans CArgList.nil premises) => (__eo_push_proven (__eo_prog_trans (Proof.pf (__eo_mk_premise_list Term.and premises S))) S)
  | S, (CCmd.step CRule.cong (CArgList.cons a1 CArgList.nil) premises) => (__eo_push_proven (__eo_prog_cong a1 (Proof.pf (__eo_mk_premise_list Term.and premises S))) S)
  | S, (CCmd.step CRule.nary_cong (CArgList.cons a1 CArgList.nil) premises) => (__eo_push_proven (__eo_prog_nary_cong a1 (Proof.pf (__eo_mk_premise_list Term.and premises S))) S)
  | S, (CCmd.step CRule.pairwise_cong (CArgList.cons a1 CArgList.nil) premises) => (__eo_push_proven (__eo_prog_pairwise_cong a1 (Proof.pf (__eo_mk_premise_list Term.and premises S))) S)
  | S, (CCmd.step CRule.true_intro CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_true_intro (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.true_elim CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_true_elim (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.false_intro CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_false_intro (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.false_elim CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_false_elim (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.ho_cong CArgList.nil premises) => (__eo_push_proven (__eo_prog_ho_cong (Proof.pf (__eo_mk_premise_list Term.and premises S))) S)
  | S, (CCmd.step CRule.distinct_elim (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_distinct_elim a1) S)
  | S, (CCmd.step CRule.distinct_true (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_distinct_true a1) S)
  | S, (CCmd.step CRule.distinct_false (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_distinct_false a1) S)
  | S, (CCmd.step CRule.lambda_elim (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_lambda_elim a1) S)
  | S, (CCmd.step CRule.arith_sum_ub CArgList.nil premises) => (__eo_push_proven (__eo_prog_arith_sum_ub (Proof.pf (__eo_mk_premise_list Term.and premises S))) S)
  | S, (CCmd.step CRule.arith_mult_pos (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_mult_pos a1 a2) S)
  | S, (CCmd.step CRule.arith_mult_neg (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_mult_neg a1 a2) S)
  | S, (CCmd.step CRule.arith_trichotomy CArgList.nil (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_arith_trichotomy (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.int_tight_ub CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_int_tight_ub (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.int_tight_lb CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_int_tight_lb (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.arith_mult_tangent (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_mult_tangent a1 a2 a3 a4 a5) S)
  | S, (CCmd.step CRule.arith_mult_sign (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_mult_sign a1 a2) S)
  | S, (CCmd.step CRule.arith_mult_abs_comparison CArgList.nil premises) => (__eo_push_proven (__eo_prog_arith_mult_abs_comparison (Proof.pf (__eo_mk_premise_list Term.and premises S))) S)
  | S, (CCmd.step CRule.arith_reduction (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_reduction a1) S)
  | S, (CCmd.step CRule.arith_poly_norm (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_poly_norm a1) S)
  | S, (CCmd.step CRule.arith_poly_norm_rel (CArgList.cons a1 CArgList.nil) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_arith_poly_norm_rel a1 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bv_repeat_elim (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_repeat_elim a1) S)
  | S, (CCmd.step CRule.bv_smulo_elim (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_smulo_elim a1) S)
  | S, (CCmd.step CRule.bv_umulo_elim (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_umulo_elim a1) S)
  | S, (CCmd.step CRule.bv_bitwise_slicing (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_bitwise_slicing a1) S)
  | S, (CCmd.step CRule.bv_bitblast_step (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_bitblast_step a1) S)
  | S, (CCmd.step CRule.bv_poly_norm (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_poly_norm a1) S)
  | S, (CCmd.step CRule.bv_poly_norm_eq (CArgList.cons a1 CArgList.nil) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bv_poly_norm_eq a1 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.string_length_pos (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_string_length_pos a1) S)
  | S, (CCmd.step CRule.string_length_non_empty CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_string_length_non_empty (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.concat_eq (CArgList.cons a1 CArgList.nil) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_concat_eq a1 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.concat_unify (CArgList.cons a1 CArgList.nil) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_concat_unify a1 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.concat_csplit (CArgList.cons a1 CArgList.nil) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_concat_csplit a1 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.concat_split (CArgList.cons a1 CArgList.nil) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_concat_split a1 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.concat_lprop (CArgList.cons a1 CArgList.nil) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_concat_lprop a1 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.concat_cprop (CArgList.cons a1 CArgList.nil) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_concat_cprop a1 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.string_decompose (CArgList.cons a1 CArgList.nil) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_string_decompose a1 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.exists_string_length (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) CIndexList.nil) => (__eo_push_proven (__eo_prog_exists_string_length a1 a2 a3) S)
  | S, (CCmd.step CRule.string_code_inj (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_string_code_inj a1 a2) S)
  | S, (CCmd.step CRule.string_seq_unit_inj CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_string_seq_unit_inj (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.re_inter CArgList.nil (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_re_inter (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.re_concat CArgList.nil premises) => (__eo_push_proven (__eo_prog_re_concat (Proof.pf (__eo_mk_premise_list Term.and premises S))) S)
  | S, (CCmd.step CRule.re_unfold_pos CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_re_unfold_pos (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.re_unfold_neg_concat_fixed (CArgList.cons a1 CArgList.nil) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_re_unfold_neg_concat_fixed a1 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.re_unfold_neg CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_re_unfold_neg (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.string_ext CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_string_ext (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.string_reduction (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_string_reduction a1) S)
  | S, (CCmd.step CRule.string_eager_reduction (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_string_eager_reduction a1) S)
  | S, (CCmd.step CRule.arith_string_pred_entail (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_string_pred_entail a1) S)
  | S, (CCmd.step CRule.arith_string_pred_safe_approx (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_string_pred_safe_approx a1) S)
  | S, (CCmd.step CRule.str_in_re_eval (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_in_re_eval a1) S)
  | S, (CCmd.step CRule.str_in_re_consume (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_in_re_consume a1) S)
  | S, (CCmd.step CRule.re_loop_elim (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_re_loop_elim a1) S)
  | S, (CCmd.step CRule.re_eq_elim (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_re_eq_elim a1) S)
  | S, (CCmd.step CRule.re_inter_inclusion (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_re_inter_inclusion a1) S)
  | S, (CCmd.step CRule.re_union_inclusion (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_re_union_inclusion a1) S)
  | S, (CCmd.step CRule.str_in_re_concat_star_char (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_in_re_concat_star_char a1) S)
  | S, (CCmd.step CRule.str_in_re_sigma (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_in_re_sigma a1) S)
  | S, (CCmd.step CRule.str_in_re_sigma_star (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_in_re_sigma_star a1) S)
  | S, (CCmd.step CRule.str_ctn_multiset_subset (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_ctn_multiset_subset a1) S)
  | S, (CCmd.step CRule.str_overlap_split_ctn (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_overlap_split_ctn a1) S)
  | S, (CCmd.step CRule.str_overlap_endpoints_ctn (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_overlap_endpoints_ctn a1) S)
  | S, (CCmd.step CRule.str_overlap_endpoints_indexof (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_overlap_endpoints_indexof a1) S)
  | S, (CCmd.step CRule.str_overlap_endpoints_replace (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_overlap_endpoints_replace a1) S)
  | S, (CCmd.step CRule.str_indexof_re_eval (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_indexof_re_eval a1) S)
  | S, (CCmd.step CRule.str_replace_re_eval (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_replace_re_eval a1) S)
  | S, (CCmd.step CRule.str_replace_re_all_eval (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_replace_re_all_eval a1) S)
  | S, (CCmd.step CRule.seq_eval_op (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_seq_eval_op a1) S)
  | S, (CCmd.step CRule.sets_singleton_inj CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_sets_singleton_inj (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.sets_ext CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_sets_ext (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.sets_eval_op (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_sets_eval_op a1) S)
  | S, (CCmd.step CRule.sets_insert_elim (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_sets_insert_elim a1) S)
  | S, (CCmd.step CRule.ubv_to_int_elim (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_ubv_to_int_elim a1) S)
  | S, (CCmd.step CRule.int_to_bv_elim (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_int_to_bv_elim a1) S)
  | S, (CCmd.step CRule.instantiate (CArgList.cons a1 CArgList.nil) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_instantiate a1 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.skolemize CArgList.nil (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_skolemize (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.skolem_intro (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_skolem_intro a1) S)
  | S, (CCmd.step CRule.alpha_equiv (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) CIndexList.nil) => (__eo_push_proven (__eo_prog_alpha_equiv a1 a2 a3) S)
  | S, (CCmd.step CRule.beta_reduce (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_beta_reduce a1) S)
  | S, (CCmd.step CRule.quant_var_reordering (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_quant_var_reordering a1) S)
  | S, (CCmd.step CRule.exists_elim (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_exists_elim a1) S)
  | S, (CCmd.step CRule.quant_unused_vars (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_quant_unused_vars a1) S)
  | S, (CCmd.step CRule.quant_merge_prenex (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_quant_merge_prenex a1) S)
  | S, (CCmd.step CRule.quant_miniscope_and (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_quant_miniscope_and a1) S)
  | S, (CCmd.step CRule.quant_miniscope_or (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_quant_miniscope_or a1) S)
  | S, (CCmd.step CRule.quant_miniscope_ite (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_quant_miniscope_ite a1) S)
  | S, (CCmd.step CRule.quant_var_elim_eq (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_quant_var_elim_eq a1) S)
  | S, (CCmd.step CRule.quant_dt_split (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_quant_dt_split a1) S)
  | S, (CCmd.step CRule.dt_split (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_dt_split a1) S)
  | S, (CCmd.step CRule.dt_inst (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_dt_inst a1) S)
  | S, (CCmd.step CRule.dt_collapse_selector (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_dt_collapse_selector a1) S)
  | S, (CCmd.step CRule.dt_collapse_tester (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_dt_collapse_tester a1) S)
  | S, (CCmd.step CRule.dt_collapse_tester_singleton (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_dt_collapse_tester_singleton a1) S)
  | S, (CCmd.step CRule.dt_cons_eq (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_dt_cons_eq a1) S)
  | S, (CCmd.step CRule.dt_cons_eq_clash (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_dt_cons_eq_clash a1) S)
  | S, (CCmd.step CRule.dt_cycle (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_dt_cycle a1) S)
  | S, (CCmd.step CRule.dt_collapse_updater (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_dt_collapse_updater a1) S)
  | S, (CCmd.step CRule.dt_updater_elim (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_dt_updater_elim a1) S)
  | S, (CCmd.step CRule.arith_div_total_zero_real (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_div_total_zero_real a1) S)
  | S, (CCmd.step CRule.arith_div_total_zero_int (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_div_total_zero_int a1) S)
  | S, (CCmd.step CRule.arith_int_div_total (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_arith_int_div_total a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.arith_int_div_total_one (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_int_div_total_one a1) S)
  | S, (CCmd.step CRule.arith_int_div_total_zero (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_int_div_total_zero a1) S)
  | S, (CCmd.step CRule.arith_int_div_total_neg (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_arith_int_div_total_neg a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.arith_int_mod_total (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_arith_int_mod_total a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.arith_int_mod_total_one (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_int_mod_total_one a1) S)
  | S, (CCmd.step CRule.arith_int_mod_total_zero (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_int_mod_total_zero a1) S)
  | S, (CCmd.step CRule.arith_int_mod_total_neg (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_arith_int_mod_total_neg a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.arith_elim_gt (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_elim_gt a1 a2) S)
  | S, (CCmd.step CRule.arith_elim_lt (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_elim_lt a1 a2) S)
  | S, (CCmd.step CRule.arith_elim_int_gt (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_elim_int_gt a1 a2) S)
  | S, (CCmd.step CRule.arith_elim_int_lt (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_elim_int_lt a1 a2) S)
  | S, (CCmd.step CRule.arith_elim_leq (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_elim_leq a1 a2) S)
  | S, (CCmd.step CRule.arith_leq_norm (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_leq_norm a1 a2) S)
  | S, (CCmd.step CRule.arith_geq_tighten (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_geq_tighten a1 a2) S)
  | S, (CCmd.step CRule.arith_geq_norm1_int (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_geq_norm1_int a1 a2) S)
  | S, (CCmd.step CRule.arith_geq_norm1_real (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_geq_norm1_real a1 a2) S)
  | S, (CCmd.step CRule.arith_eq_elim_real (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_eq_elim_real a1 a2) S)
  | S, (CCmd.step CRule.arith_eq_elim_int (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_eq_elim_int a1 a2) S)
  | S, (CCmd.step CRule.arith_to_int_elim (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_to_int_elim a1) S)
  | S, (CCmd.step CRule.arith_to_int_elim_to_real (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_to_int_elim_to_real a1) S)
  | S, (CCmd.step CRule.arith_div_elim_to_real1 (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_div_elim_to_real1 a1 a2) S)
  | S, (CCmd.step CRule.arith_div_elim_to_real2 (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_div_elim_to_real2 a1 a2) S)
  | S, (CCmd.step CRule.arith_mod_over_mod_1 (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_arith_mod_over_mod_1 a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.arith_mod_over_mod (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_arith_mod_over_mod a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.arith_mod_over_mod_mult (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_arith_mod_over_mod_mult a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.arith_int_eq_conflict (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_arith_int_eq_conflict a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.arith_int_geq_tighten (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_arith_int_geq_tighten a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.arith_divisible_elim (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_arith_divisible_elim a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.arith_abs_eq (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_abs_eq a1 a2) S)
  | S, (CCmd.step CRule.arith_abs_int_gt (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_abs_int_gt a1 a2) S)
  | S, (CCmd.step CRule.arith_abs_real_gt (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_abs_real_gt a1 a2) S)
  | S, (CCmd.step CRule.arith_geq_ite_lift (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_geq_ite_lift a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.arith_leq_ite_lift (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_leq_ite_lift a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.arith_min_lt1 (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_min_lt1 a1 a2) S)
  | S, (CCmd.step CRule.arith_min_lt2 (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_min_lt2 a1 a2) S)
  | S, (CCmd.step CRule.arith_max_geq1 (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_max_geq1 a1 a2) S)
  | S, (CCmd.step CRule.arith_max_geq2 (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_arith_max_geq2 a1 a2) S)
  | S, (CCmd.step CRule.array_read_over_write (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) CIndexList.nil) => (__eo_push_proven (__eo_prog_array_read_over_write a1 a2 a3) S)
  | S, (CCmd.step CRule.array_read_over_write2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_array_read_over_write2 a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.array_store_overwrite (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_array_store_overwrite a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.array_store_self (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_array_store_self a1 a2) S)
  | S, (CCmd.step CRule.array_read_over_write_split (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_array_read_over_write_split a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.array_store_swap (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_array_store_swap a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bool_double_not_elim (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_bool_double_not_elim a1) S)
  | S, (CCmd.step CRule.bool_not_true (CArgList.cons a1 CArgList.nil) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bool_not_true a1 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bool_not_false (CArgList.cons a1 CArgList.nil) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bool_not_false a1 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bool_eq_true (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_bool_eq_true a1) S)
  | S, (CCmd.step CRule.bool_eq_false (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_bool_eq_false a1) S)
  | S, (CCmd.step CRule.bool_eq_nrefl (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_bool_eq_nrefl a1) S)
  | S, (CCmd.step CRule.bool_impl_false1 (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_bool_impl_false1 a1) S)
  | S, (CCmd.step CRule.bool_impl_false2 (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_bool_impl_false2 a1) S)
  | S, (CCmd.step CRule.bool_impl_true1 (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_bool_impl_true1 a1) S)
  | S, (CCmd.step CRule.bool_impl_true2 (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_bool_impl_true2 a1) S)
  | S, (CCmd.step CRule.bool_impl_elim (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bool_impl_elim a1 a2) S)
  | S, (CCmd.step CRule.bool_dual_impl_eq (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bool_dual_impl_eq a1 a2) S)
  | S, (CCmd.step CRule.bool_and_conf (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_bool_and_conf a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.bool_and_conf2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_bool_and_conf2 a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.bool_or_taut (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_bool_or_taut a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.bool_or_taut2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_bool_or_taut2 a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.bool_or_de_morgan (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) CIndexList.nil) => (__eo_push_proven (__eo_prog_bool_or_de_morgan a1 a2 a3) S)
  | S, (CCmd.step CRule.bool_implies_de_morgan (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bool_implies_de_morgan a1 a2) S)
  | S, (CCmd.step CRule.bool_and_de_morgan (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) CIndexList.nil) => (__eo_push_proven (__eo_prog_bool_and_de_morgan a1 a2 a3) S)
  | S, (CCmd.step CRule.bool_or_and_distrib (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) CIndexList.nil) => (__eo_push_proven (__eo_prog_bool_or_and_distrib a1 a2 a3 a4 a5) S)
  | S, (CCmd.step CRule.bool_implies_or_distrib (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_bool_implies_or_distrib a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.bool_xor_refl (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_bool_xor_refl a1) S)
  | S, (CCmd.step CRule.bool_xor_nrefl (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_bool_xor_nrefl a1) S)
  | S, (CCmd.step CRule.bool_xor_false (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_bool_xor_false a1) S)
  | S, (CCmd.step CRule.bool_xor_true (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_bool_xor_true a1) S)
  | S, (CCmd.step CRule.bool_xor_comm (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bool_xor_comm a1 a2) S)
  | S, (CCmd.step CRule.bool_xor_elim (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bool_xor_elim a1 a2) S)
  | S, (CCmd.step CRule.bool_not_xor_elim (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bool_not_xor_elim a1 a2) S)
  | S, (CCmd.step CRule.bool_not_eq_elim1 (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bool_not_eq_elim1 a1 a2) S)
  | S, (CCmd.step CRule.bool_not_eq_elim2 (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bool_not_eq_elim2 a1 a2) S)
  | S, (CCmd.step CRule.ite_neg_branch (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_ite_neg_branch a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.ite_then_true (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_ite_then_true a1 a2) S)
  | S, (CCmd.step CRule.ite_else_false (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_ite_else_false a1 a2) S)
  | S, (CCmd.step CRule.ite_then_false (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_ite_then_false a1 a2) S)
  | S, (CCmd.step CRule.ite_else_true (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_ite_else_true a1 a2) S)
  | S, (CCmd.step CRule.ite_then_lookahead_self (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_ite_then_lookahead_self a1 a2) S)
  | S, (CCmd.step CRule.ite_else_lookahead_self (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_ite_else_lookahead_self a1 a2) S)
  | S, (CCmd.step CRule.ite_then_lookahead_not_self (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_ite_then_lookahead_not_self a1 a2) S)
  | S, (CCmd.step CRule.ite_else_lookahead_not_self (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_ite_else_lookahead_not_self a1 a2) S)
  | S, (CCmd.step CRule.ite_expand (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) CIndexList.nil) => (__eo_push_proven (__eo_prog_ite_expand a1 a2 a3) S)
  | S, (CCmd.step CRule.bool_not_ite_elim (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) CIndexList.nil) => (__eo_push_proven (__eo_prog_bool_not_ite_elim a1 a2 a3) S)
  | S, (CCmd.step CRule.ite_true_cond (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_ite_true_cond a1 a2) S)
  | S, (CCmd.step CRule.ite_false_cond (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_ite_false_cond a1 a2) S)
  | S, (CCmd.step CRule.ite_not_cond (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) CIndexList.nil) => (__eo_push_proven (__eo_prog_ite_not_cond a1 a2 a3) S)
  | S, (CCmd.step CRule.ite_eq_branch (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_ite_eq_branch a1 a2) S)
  | S, (CCmd.step CRule.ite_then_lookahead (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_ite_then_lookahead a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.ite_else_lookahead (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_ite_else_lookahead a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.ite_then_neg_lookahead (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_ite_then_neg_lookahead a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.ite_else_neg_lookahead (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_ite_else_neg_lookahead a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.bv_concat_extract_merge (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 (CArgList.cons a6 (CArgList.cons a7 CArgList.nil))))))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bv_concat_extract_merge a1 a2 a3 a4 a5 a6 a7 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bv_extract_extract (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 (CArgList.cons a6 (CArgList.cons a7 CArgList.nil))))))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_bv_extract_extract a1 a2 a3 a4 a5 a6 a7 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.bv_extract_whole (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bv_extract_whole a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bv_extract_concat_1 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bv_extract_concat_1 a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bv_extract_concat_2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 (CArgList.cons a6 (CArgList.cons a7 CArgList.nil))))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 (CIndexList.cons n4 CIndexList.nil))))) => (__eo_push_proven (__eo_prog_bv_extract_concat_2 a1 a2 a3 a4 a5 a6 a7 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3)) (Proof.pf (__eo_state_proven_nth S n4))) S)
  | S, (CCmd.step CRule.bv_extract_concat_3 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 (CArgList.cons a6 (CArgList.cons a7 CArgList.nil))))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_bv_extract_concat_3 a1 a2 a3 a4 a5 a6 a7 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.bv_extract_concat_4 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bv_extract_concat_4 a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bv_eq_extract_elim1 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 (CArgList.cons a6 (CArgList.cons a7 CArgList.nil))))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 (CIndexList.cons n4 (CIndexList.cons n5 CIndexList.nil)))))) => (__eo_push_proven (__eo_prog_bv_eq_extract_elim1 a1 a2 a3 a4 a5 a6 a7 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3)) (Proof.pf (__eo_state_proven_nth S n4)) (Proof.pf (__eo_state_proven_nth S n5))) S)
  | S, (CCmd.step CRule.bv_eq_extract_elim2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_bv_eq_extract_elim2 a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.bv_eq_extract_elim3 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_bv_eq_extract_elim3 a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.bv_extract_not (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_extract_not a1 a2 a3) S)
  | S, (CCmd.step CRule.bv_extract_sign_extend_1 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bv_extract_sign_extend_1 a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bv_extract_sign_extend_2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 (CArgList.cons a6 CArgList.nil)))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 (CIndexList.cons n4 CIndexList.nil))))) => (__eo_push_proven (__eo_prog_bv_extract_sign_extend_2 a1 a2 a3 a4 a5 a6 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3)) (Proof.pf (__eo_state_proven_nth S n4))) S)
  | S, (CCmd.step CRule.bv_extract_sign_extend_3 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 (CArgList.cons a6 CArgList.nil)))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_bv_extract_sign_extend_3 a1 a2 a3 a4 a5 a6 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.bv_not_xor (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_not_xor a1 a2 a3) S)
  | S, (CCmd.step CRule.bv_and_simplify_1 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bv_and_simplify_1 a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bv_and_simplify_2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bv_and_simplify_2 a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bv_or_simplify_1 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bv_or_simplify_1 a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bv_or_simplify_2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bv_or_simplify_2 a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bv_xor_simplify_1 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_xor_simplify_1 a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.bv_xor_simplify_2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_xor_simplify_2 a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.bv_xor_simplify_3 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_xor_simplify_3 a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.bv_ult_add_one (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_bv_ult_add_one a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.bv_mult_slt_mult_1 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 (CArgList.cons a6 (CArgList.cons a7 CArgList.nil))))))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_bv_mult_slt_mult_1 a1 a2 a3 a4 a5 a6 a7 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.bv_mult_slt_mult_2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 (CArgList.cons a6 (CArgList.cons a7 CArgList.nil))))))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_bv_mult_slt_mult_2 a1 a2 a3 a4 a5 a6 a7 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.bv_commutative_xor (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_commutative_xor a1 a2) S)
  | S, (CCmd.step CRule.bv_commutative_comp (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_commutative_comp a1 a2) S)
  | S, (CCmd.step CRule.bv_zero_extend_eliminate_0 (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_zero_extend_eliminate_0 a1) S)
  | S, (CCmd.step CRule.bv_sign_extend_eliminate_0 (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_sign_extend_eliminate_0 a1) S)
  | S, (CCmd.step CRule.bv_not_neq (CArgList.cons a1 CArgList.nil) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bv_not_neq a1 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bv_ult_ones (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bv_ult_ones a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bv_concat_merge_const (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 (CArgList.cons a6 (CArgList.cons a7 CArgList.nil))))))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bv_concat_merge_const a1 a2 a3 a4 a5 a6 a7 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bv_commutative_add (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_commutative_add a1 a2) S)
  | S, (CCmd.step CRule.bv_sub_eliminate (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_sub_eliminate a1 a2) S)
  | S, (CCmd.step CRule.bv_ite_width_one (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_ite_width_one a1) S)
  | S, (CCmd.step CRule.bv_ite_width_one_not (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_ite_width_one_not a1) S)
  | S, (CCmd.step CRule.bv_eq_xor_solve (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_eq_xor_solve a1 a2 a3) S)
  | S, (CCmd.step CRule.bv_eq_not_solve (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_eq_not_solve a1 a2) S)
  | S, (CCmd.step CRule.bv_ugt_eliminate (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_ugt_eliminate a1 a2) S)
  | S, (CCmd.step CRule.bv_uge_eliminate (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_uge_eliminate a1 a2) S)
  | S, (CCmd.step CRule.bv_sgt_eliminate (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_sgt_eliminate a1 a2) S)
  | S, (CCmd.step CRule.bv_sge_eliminate (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_sge_eliminate a1 a2) S)
  | S, (CCmd.step CRule.bv_sle_eliminate (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_sle_eliminate a1 a2) S)
  | S, (CCmd.step CRule.bv_redor_eliminate (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bv_redor_eliminate a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bv_redand_eliminate (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bv_redand_eliminate a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bv_ule_eliminate (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_ule_eliminate a1 a2) S)
  | S, (CCmd.step CRule.bv_comp_eliminate (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_comp_eliminate a1 a2) S)
  | S, (CCmd.step CRule.bv_rotate_left_eliminate_1 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 (CIndexList.cons n4 CIndexList.nil))))) => (__eo_push_proven (__eo_prog_bv_rotate_left_eliminate_1 a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3)) (Proof.pf (__eo_state_proven_nth S n4))) S)
  | S, (CCmd.step CRule.bv_rotate_left_eliminate_2 (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bv_rotate_left_eliminate_2 a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bv_rotate_right_eliminate_1 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 (CIndexList.cons n4 CIndexList.nil))))) => (__eo_push_proven (__eo_prog_bv_rotate_right_eliminate_1 a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3)) (Proof.pf (__eo_state_proven_nth S n4))) S)
  | S, (CCmd.step CRule.bv_rotate_right_eliminate_2 (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bv_rotate_right_eliminate_2 a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bv_nand_eliminate (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_nand_eliminate a1 a2) S)
  | S, (CCmd.step CRule.bv_nor_eliminate (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_nor_eliminate a1 a2) S)
  | S, (CCmd.step CRule.bv_xnor_eliminate (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_xnor_eliminate a1 a2) S)
  | S, (CCmd.step CRule.bv_sdiv_eliminate (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bv_sdiv_eliminate a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bv_zero_extend_eliminate (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_zero_extend_eliminate a1 a2) S)
  | S, (CCmd.step CRule.bv_uaddo_eliminate (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bv_uaddo_eliminate a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bv_saddo_eliminate (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bv_saddo_eliminate a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bv_sdivo_eliminate (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_bv_sdivo_eliminate a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.bv_smod_eliminate (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_bv_smod_eliminate a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.bv_srem_eliminate (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bv_srem_eliminate a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bv_usubo_eliminate (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bv_usubo_eliminate a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bv_ssubo_eliminate (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bv_ssubo_eliminate a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bv_nego_eliminate (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bv_nego_eliminate a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bv_ite_equal_children (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_ite_equal_children a1 a2) S)
  | S, (CCmd.step CRule.bv_ite_const_children_1 (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_ite_const_children_1 a1) S)
  | S, (CCmd.step CRule.bv_ite_const_children_2 (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_ite_const_children_2 a1) S)
  | S, (CCmd.step CRule.bv_ite_equal_cond_1 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_ite_equal_cond_1 a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.bv_ite_equal_cond_2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_ite_equal_cond_2 a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.bv_ite_equal_cond_3 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_ite_equal_cond_3 a1 a2 a3 a4 a5) S)
  | S, (CCmd.step CRule.bv_ite_merge_then_if (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_ite_merge_then_if a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.bv_ite_merge_else_if (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_ite_merge_else_if a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.bv_ite_merge_then_else (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_ite_merge_then_else a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.bv_ite_merge_else_else (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_ite_merge_else_else a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.bv_shl_by_const_0 (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_shl_by_const_0 a1 a2) S)
  | S, (CCmd.step CRule.bv_shl_by_const_1 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_bv_shl_by_const_1 a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.bv_shl_by_const_2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_bv_shl_by_const_2 a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.bv_lshr_by_const_0 (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_lshr_by_const_0 a1 a2) S)
  | S, (CCmd.step CRule.bv_lshr_by_const_1 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_bv_lshr_by_const_1 a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.bv_lshr_by_const_2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_bv_lshr_by_const_2 a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.bv_ashr_by_const_0 (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_ashr_by_const_0 a1 a2) S)
  | S, (CCmd.step CRule.bv_ashr_by_const_1 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_bv_ashr_by_const_1 a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.bv_ashr_by_const_2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_bv_ashr_by_const_2 a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.bv_and_concat_pullup (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 (CArgList.cons a6 (CArgList.cons a7 (CArgList.cons a8 CArgList.nil)))))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_bv_and_concat_pullup a1 a2 a3 a4 a5 a6 a7 a8 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.bv_or_concat_pullup (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 (CArgList.cons a6 (CArgList.cons a7 (CArgList.cons a8 CArgList.nil)))))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_bv_or_concat_pullup a1 a2 a3 a4 a5 a6 a7 a8 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.bv_xor_concat_pullup (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 (CArgList.cons a6 (CArgList.cons a7 (CArgList.cons a8 CArgList.nil)))))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_bv_xor_concat_pullup a1 a2 a3 a4 a5 a6 a7 a8 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.bv_and_concat_pullup2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 (CArgList.cons a6 (CArgList.cons a7 (CArgList.cons a8 CArgList.nil)))))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_bv_and_concat_pullup2 a1 a2 a3 a4 a5 a6 a7 a8 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.bv_or_concat_pullup2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 (CArgList.cons a6 (CArgList.cons a7 (CArgList.cons a8 CArgList.nil)))))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_bv_or_concat_pullup2 a1 a2 a3 a4 a5 a6 a7 a8 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.bv_xor_concat_pullup2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 (CArgList.cons a6 (CArgList.cons a7 (CArgList.cons a8 CArgList.nil)))))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_bv_xor_concat_pullup2 a1 a2 a3 a4 a5 a6 a7 a8 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.bv_and_concat_pullup3 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 (CArgList.cons a6 (CArgList.cons a7 (CArgList.cons a8 (CArgList.cons a9 (CArgList.cons a10 CArgList.nil)))))))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 (CIndexList.cons n4 (CIndexList.cons n5 CIndexList.nil)))))) => (__eo_push_proven (__eo_prog_bv_and_concat_pullup3 a1 a2 a3 a4 a5 a6 a7 a8 a9 a10 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3)) (Proof.pf (__eo_state_proven_nth S n4)) (Proof.pf (__eo_state_proven_nth S n5))) S)
  | S, (CCmd.step CRule.bv_or_concat_pullup3 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 (CArgList.cons a6 (CArgList.cons a7 (CArgList.cons a8 (CArgList.cons a9 (CArgList.cons a10 CArgList.nil)))))))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 (CIndexList.cons n4 (CIndexList.cons n5 CIndexList.nil)))))) => (__eo_push_proven (__eo_prog_bv_or_concat_pullup3 a1 a2 a3 a4 a5 a6 a7 a8 a9 a10 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3)) (Proof.pf (__eo_state_proven_nth S n4)) (Proof.pf (__eo_state_proven_nth S n5))) S)
  | S, (CCmd.step CRule.bv_xor_concat_pullup3 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 (CArgList.cons a6 (CArgList.cons a7 (CArgList.cons a8 (CArgList.cons a9 (CArgList.cons a10 CArgList.nil)))))))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 (CIndexList.cons n4 (CIndexList.cons n5 CIndexList.nil)))))) => (__eo_push_proven (__eo_prog_bv_xor_concat_pullup3 a1 a2 a3 a4 a5 a6 a7 a8 a9 a10 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3)) (Proof.pf (__eo_state_proven_nth S n4)) (Proof.pf (__eo_state_proven_nth S n5))) S)
  | S, (CCmd.step CRule.bv_xor_duplicate (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bv_xor_duplicate a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bv_xor_ones (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bv_xor_ones a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bv_xor_not (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_xor_not a1 a2) S)
  | S, (CCmd.step CRule.bv_not_idemp (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_not_idemp a1) S)
  | S, (CCmd.step CRule.bv_ult_zero_1 (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_ult_zero_1 a1 a2) S)
  | S, (CCmd.step CRule.bv_ult_zero_2 (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_ult_zero_2 a1 a2) S)
  | S, (CCmd.step CRule.bv_ult_self (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_ult_self a1) S)
  | S, (CCmd.step CRule.bv_lt_self (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_lt_self a1) S)
  | S, (CCmd.step CRule.bv_ule_self (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_ule_self a1) S)
  | S, (CCmd.step CRule.bv_ule_zero (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_ule_zero a1 a2) S)
  | S, (CCmd.step CRule.bv_zero_ule (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_zero_ule a1 a2) S)
  | S, (CCmd.step CRule.bv_sle_self (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_sle_self a1) S)
  | S, (CCmd.step CRule.bv_ule_max (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_bv_ule_max a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.bv_not_ult (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_not_ult a1 a2) S)
  | S, (CCmd.step CRule.bv_mult_pow2_1 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 (CArgList.cons a6 (CArgList.cons a7 CArgList.nil))))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_bv_mult_pow2_1 a1 a2 a3 a4 a5 a6 a7 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.bv_mult_pow2_2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 (CArgList.cons a6 (CArgList.cons a7 CArgList.nil))))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_bv_mult_pow2_2 a1 a2 a3 a4 a5 a6 a7 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.bv_mult_pow2_2b (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_bv_mult_pow2_2b a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.bv_extract_mult_leading_bit (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 (CArgList.cons a6 (CArgList.cons a7 (CArgList.cons a8 (CArgList.cons a9 CArgList.nil))))))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_bv_extract_mult_leading_bit a1 a2 a3 a4 a5 a6 a7 a8 a9 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.bv_udiv_pow2_not_one (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 (CIndexList.cons n4 CIndexList.nil))))) => (__eo_push_proven (__eo_prog_bv_udiv_pow2_not_one a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3)) (Proof.pf (__eo_state_proven_nth S n4))) S)
  | S, (CCmd.step CRule.bv_udiv_zero (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_udiv_zero a1 a2) S)
  | S, (CCmd.step CRule.bv_udiv_one (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_udiv_one a1 a2) S)
  | S, (CCmd.step CRule.bv_urem_pow2_not_one (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 (CIndexList.cons n4 CIndexList.nil))))) => (__eo_push_proven (__eo_prog_bv_urem_pow2_not_one a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3)) (Proof.pf (__eo_state_proven_nth S n4))) S)
  | S, (CCmd.step CRule.bv_urem_one (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_urem_one a1 a2) S)
  | S, (CCmd.step CRule.bv_urem_self (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bv_urem_self a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bv_shl_zero (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_shl_zero a1 a2) S)
  | S, (CCmd.step CRule.bv_lshr_zero (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_lshr_zero a1 a2) S)
  | S, (CCmd.step CRule.bv_ashr_zero (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_bv_ashr_zero a1 a2) S)
  | S, (CCmd.step CRule.bv_ugt_urem (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bv_ugt_urem a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bv_ult_one (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bv_ult_one a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bv_merge_sign_extend_1 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_bv_merge_sign_extend_1 a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.bv_merge_sign_extend_2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_bv_merge_sign_extend_2 a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.bv_sign_extend_eq_const_1 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 (CArgList.cons a6 (CArgList.cons a7 CArgList.nil))))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_bv_sign_extend_eq_const_1 a1 a2 a3 a4 a5 a6 a7 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.bv_sign_extend_eq_const_2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 (CArgList.cons a6 (CArgList.cons a7 CArgList.nil))))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_bv_sign_extend_eq_const_2 a1 a2 a3 a4 a5 a6 a7 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.bv_zero_extend_eq_const_1 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 (CArgList.cons a6 CArgList.nil)))))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_bv_zero_extend_eq_const_1 a1 a2 a3 a4 a5 a6 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.bv_zero_extend_eq_const_2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 (CArgList.cons a6 CArgList.nil)))))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_bv_zero_extend_eq_const_2 a1 a2 a3 a4 a5 a6 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.bv_zero_extend_ult_const_1 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_bv_zero_extend_ult_const_1 a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.bv_zero_extend_ult_const_2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_bv_zero_extend_ult_const_2 a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.bv_sign_extend_ult_const_1 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_bv_sign_extend_ult_const_1 a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.bv_sign_extend_ult_const_2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_bv_sign_extend_ult_const_2 a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.bv_sign_extend_ult_const_3 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_bv_sign_extend_ult_const_3 a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.bv_sign_extend_ult_const_4 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_bv_sign_extend_ult_const_4 a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.sets_eq_singleton_emp (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_sets_eq_singleton_emp a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.sets_member_singleton (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_sets_member_singleton a1 a2) S)
  | S, (CCmd.step CRule.sets_member_emp (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_sets_member_emp a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.sets_subset_elim (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_sets_subset_elim a1 a2) S)
  | S, (CCmd.step CRule.sets_union_comm (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_sets_union_comm a1 a2) S)
  | S, (CCmd.step CRule.sets_inter_comm (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_sets_inter_comm a1 a2) S)
  | S, (CCmd.step CRule.sets_inter_emp1 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_sets_inter_emp1 a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.sets_inter_emp2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_sets_inter_emp2 a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.sets_minus_emp1 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_sets_minus_emp1 a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.sets_minus_emp2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_sets_minus_emp2 a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.sets_union_emp1 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_sets_union_emp1 a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.sets_union_emp2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_sets_union_emp2 a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.sets_inter_member (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) CIndexList.nil) => (__eo_push_proven (__eo_prog_sets_inter_member a1 a2 a3) S)
  | S, (CCmd.step CRule.sets_minus_member (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) CIndexList.nil) => (__eo_push_proven (__eo_prog_sets_minus_member a1 a2 a3) S)
  | S, (CCmd.step CRule.sets_union_member (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) CIndexList.nil) => (__eo_push_proven (__eo_prog_sets_union_member a1 a2 a3) S)
  | S, (CCmd.step CRule.sets_choose_singleton (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_sets_choose_singleton a1) S)
  | S, (CCmd.step CRule.sets_minus_self (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_sets_minus_self a1 a2) S)
  | S, (CCmd.step CRule.sets_is_empty_elim (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_sets_is_empty_elim a1 a2) S)
  | S, (CCmd.step CRule.sets_is_singleton_elim (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_sets_is_singleton_elim a1) S)
  | S, (CCmd.step CRule.str_eq_ctn_false (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_eq_ctn_false a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_eq_ctn_full_false1 (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_eq_ctn_full_false1 a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_eq_ctn_full_false2 (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_eq_ctn_full_false2 a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_eq_len_false (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_eq_len_false a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_substr_empty_str (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_substr_empty_str a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_substr_empty_range (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_substr_empty_range a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_substr_empty_start (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_substr_empty_start a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_substr_empty_start_neg (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_substr_empty_start_neg a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_substr_substr_start_geq_len (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 (CArgList.cons a6 CArgList.nil)))))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_substr_substr_start_geq_len a1 a2 a3 a4 a5 a6 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_substr_eq_empty (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_str_substr_eq_empty a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.str_substr_z_eq_empty_leq (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_str_substr_z_eq_empty_leq a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.str_substr_eq_empty_leq_len (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_str_substr_eq_empty_leq_len a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.str_len_replace_inv (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_len_replace_inv a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_len_replace_all_inv (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_len_replace_all_inv a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_len_update_inv (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_len_update_inv a1 a2 a3) S)
  | S, (CCmd.step CRule.str_update_in_first_concat (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 (CArgList.cons a6 CArgList.nil)))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 (CIndexList.cons n4 CIndexList.nil))))) => (__eo_push_proven (__eo_prog_str_update_in_first_concat a1 a2 a3 a4 a5 a6 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3)) (Proof.pf (__eo_state_proven_nth S n4))) S)
  | S, (CCmd.step CRule.str_len_substr_in_range (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_str_len_substr_in_range a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.str_concat_clash (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_str_concat_clash a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.str_concat_clash_rev (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_str_concat_clash_rev a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.str_concat_clash2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_str_concat_clash2 a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.str_concat_clash2_rev (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_str_concat_clash2_rev a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.str_concat_unify (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_concat_unify a1 a2 a3 a4 a5) S)
  | S, (CCmd.step CRule.str_concat_unify_rev (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_concat_unify_rev a1 a2 a3 a4 a5) S)
  | S, (CCmd.step CRule.str_concat_unify_base (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_concat_unify_base a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.str_concat_unify_base_rev (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_concat_unify_base_rev a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.str_prefixof_elim (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_prefixof_elim a1 a2) S)
  | S, (CCmd.step CRule.str_suffixof_elim (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_suffixof_elim a1 a2) S)
  | S, (CCmd.step CRule.str_prefixof_eq (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_prefixof_eq a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_suffixof_eq (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_suffixof_eq a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_prefixof_one (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_prefixof_one a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_suffixof_one (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_suffixof_one a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_substr_combine1 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_str_substr_combine1 a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.str_substr_combine2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_str_substr_combine2 a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.str_substr_combine3 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_str_substr_combine3 a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.str_substr_combine4 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_str_substr_combine4 a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.str_substr_concat1 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_str_substr_concat1 a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.str_substr_concat2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_substr_concat2 a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_substr_replace (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_str_substr_replace a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.str_substr_full (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_substr_full a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_substr_full_eq (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_substr_full_eq a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_contains_refl (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_contains_refl a1) S)
  | S, (CCmd.step CRule.str_contains_concat_find (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_contains_concat_find a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_contains_concat_find_contra (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_contains_concat_find_contra a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_contains_split_char (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_contains_split_char a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_contains_leq_len_eq (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_contains_leq_len_eq a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_contains_emp (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_contains_emp a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_contains_char (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_contains_char a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_at_elim (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_at_elim a1 a2) S)
  | S, (CCmd.step CRule.str_replace_self (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_replace_self a1 a2) S)
  | S, (CCmd.step CRule.str_replace_id (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_replace_id a1 a2) S)
  | S, (CCmd.step CRule.str_replace_prefix (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_replace_prefix a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.str_replace_no_contains (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_replace_no_contains a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_replace_find_base (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_str_replace_find_base a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.str_replace_find_first_concat (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 (CArgList.cons a6 CArgList.nil)))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_str_replace_find_first_concat a1 a2 a3 a4 a5 a6 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.str_replace_empty (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_replace_empty a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_replace_one_pre (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_replace_one_pre a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_replace_find_pre (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_replace_find_pre a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.str_replace_all_no_contains (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_replace_all_no_contains a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_replace_all_empty (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_replace_all_empty a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_replace_all_id (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_replace_all_id a1 a2) S)
  | S, (CCmd.step CRule.str_replace_all_self (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_replace_all_self a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_replace_re_none (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_replace_re_none a1 a2) S)
  | S, (CCmd.step CRule.str_replace_re_all_none (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_replace_re_all_none a1 a2) S)
  | S, (CCmd.step CRule.str_len_concat_rec (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_len_concat_rec a1 a2 a3) S)
  | S, (CCmd.step CRule.str_len_eq_zero_concat_rec (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_len_eq_zero_concat_rec a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.str_len_eq_zero_base (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_len_eq_zero_base a1 a2) S)
  | S, (CCmd.step CRule.str_indexof_self (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_indexof_self a1 a2 a3) S)
  | S, (CCmd.step CRule.str_indexof_no_contains (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_indexof_no_contains a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_indexof_oob (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_indexof_oob a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_indexof_oob2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_indexof_oob2 a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_indexof_contains_pre (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_str_indexof_contains_pre a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.str_indexof_contains_concat_pre (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_indexof_contains_concat_pre a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.str_indexof_find_emp (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_str_indexof_find_emp a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.str_indexof_eq_irr (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_str_indexof_eq_irr a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.str_indexof_re_none (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_indexof_re_none a1 a2) S)
  | S, (CCmd.step CRule.str_indexof_re_emp_re (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_str_indexof_re_emp_re a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.str_to_lower_concat (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_to_lower_concat a1 a2 a3) S)
  | S, (CCmd.step CRule.str_to_upper_concat (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_to_upper_concat a1 a2 a3) S)
  | S, (CCmd.step CRule.str_to_lower_upper (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_to_lower_upper a1) S)
  | S, (CCmd.step CRule.str_to_upper_lower (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_to_upper_lower a1) S)
  | S, (CCmd.step CRule.str_to_lower_len (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_to_lower_len a1) S)
  | S, (CCmd.step CRule.str_to_upper_len (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_to_upper_len a1) S)
  | S, (CCmd.step CRule.str_to_lower_from_int (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_to_lower_from_int a1) S)
  | S, (CCmd.step CRule.str_to_upper_from_int (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_to_upper_from_int a1) S)
  | S, (CCmd.step CRule.str_to_int_concat_neg_one (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_str_to_int_concat_neg_one a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.str_is_digit_elim (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_is_digit_elim a1) S)
  | S, (CCmd.step CRule.str_leq_empty (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_leq_empty a1) S)
  | S, (CCmd.step CRule.str_leq_empty_eq (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_leq_empty_eq a1) S)
  | S, (CCmd.step CRule.str_leq_concat_false (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_str_leq_concat_false a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.str_leq_concat_true (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_str_leq_concat_true a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.str_leq_concat_base_1 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_str_leq_concat_base_1 a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.str_leq_concat_base_2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_str_leq_concat_base_2 a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.str_lt_elim (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_lt_elim a1 a2) S)
  | S, (CCmd.step CRule.str_from_int_no_ctn_nondigit (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_str_from_int_no_ctn_nondigit a1 a2 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.str_substr_ctn_contra (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_substr_ctn_contra a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_substr_ctn (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_substr_ctn a1 a2 a3) S)
  | S, (CCmd.step CRule.str_replace_dual_ctn (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_str_replace_dual_ctn a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.str_replace_dual_ctn_false (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_str_replace_dual_ctn_false a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.str_replace_self_ctn_simp (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_replace_self_ctn_simp a1 a2) S)
  | S, (CCmd.step CRule.str_replace_emp_ctn_src (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_replace_emp_ctn_src a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_substr_char_start_eq_len (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_substr_char_start_eq_len a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_contains_repl_char (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_str_contains_repl_char a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.str_contains_repl_self_tgt_char (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_contains_repl_self_tgt_char a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_contains_repl_self (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_contains_repl_self a1 a2) S)
  | S, (CCmd.step CRule.str_contains_repl_tgt (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_contains_repl_tgt a1 a2 a3) S)
  | S, (CCmd.step CRule.str_repl_repl_len_id (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_repl_repl_len_id a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_repl_repl_src_tgt_no_ctn (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_repl_repl_src_tgt_no_ctn a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_repl_repl_tgt_self (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_repl_repl_tgt_self a1 a2) S)
  | S, (CCmd.step CRule.str_repl_repl_tgt_no_ctn (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_repl_repl_tgt_no_ctn a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_repl_repl_src_self (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_repl_repl_src_self a1 a2 a3) S)
  | S, (CCmd.step CRule.str_repl_repl_src_inv_no_ctn1 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_repl_repl_src_inv_no_ctn1 a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_repl_repl_src_inv_no_ctn2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_repl_repl_src_inv_no_ctn2 a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_repl_repl_src_inv_no_ctn3 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 (CArgList.cons a5 CArgList.nil))))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_str_repl_repl_src_inv_no_ctn3 a1 a2 a3 a4 a5 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.str_repl_repl_dual_self (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_repl_repl_dual_self a1 a2) S)
  | S, (CCmd.step CRule.str_repl_repl_dual_ite1 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_repl_repl_dual_ite1 a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_repl_repl_dual_ite2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_str_repl_repl_dual_ite2 a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.str_repl_repl_lookahead_id_simp (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_str_repl_repl_lookahead_id_simp a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.re_all_elim CArgList.nil CIndexList.nil) => (__eo_push_proven (Term.Apply (Term.Apply Term.eq Term.re_all) (Term.Apply Term.re_mult Term.re_allchar)) S)
  | S, (CCmd.step CRule.re_opt_elim (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_re_opt_elim a1) S)
  | S, (CCmd.step CRule.re_diff_elim (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_re_diff_elim a1 a2) S)
  | S, (CCmd.step CRule.re_plus_elim (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_re_plus_elim a1) S)
  | S, (CCmd.step CRule.re_repeat_elim (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_re_repeat_elim a1 a2) S)
  | S, (CCmd.step CRule.re_concat_star_swap (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) CIndexList.nil) => (__eo_push_proven (__eo_prog_re_concat_star_swap a1 a2 a3) S)
  | S, (CCmd.step CRule.re_concat_star_repeat (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) CIndexList.nil) => (__eo_push_proven (__eo_prog_re_concat_star_repeat a1 a2 a3) S)
  | S, (CCmd.step CRule.re_concat_star_subsume1 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) CIndexList.nil) => (__eo_push_proven (__eo_prog_re_concat_star_subsume1 a1 a2 a3) S)
  | S, (CCmd.step CRule.re_concat_star_subsume2 (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) CIndexList.nil) => (__eo_push_proven (__eo_prog_re_concat_star_subsume2 a1 a2 a3) S)
  | S, (CCmd.step CRule.re_concat_merge (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_re_concat_merge a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.re_union_all (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_re_union_all a1 a2) S)
  | S, (CCmd.step CRule.re_union_const_elim (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_re_union_const_elim a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.re_inter_all (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_re_inter_all a1 a2) S)
  | S, (CCmd.step CRule.re_star_none CArgList.nil CIndexList.nil) => (__eo_push_proven (Term.Apply (Term.Apply Term.eq (Term.Apply Term.re_mult Term.re_none)) (Term.Apply Term.str_to_re (Term.String ""))) S)
  | S, (CCmd.step CRule.re_star_emp CArgList.nil CIndexList.nil) => (__eo_push_proven (Term.Apply (Term.Apply Term.eq (Term.Apply Term.re_mult (Term.Apply Term.str_to_re (Term.String "")))) (Term.Apply Term.str_to_re (Term.String ""))) S)
  | S, (CCmd.step CRule.re_star_star (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_re_star_star a1) S)
  | S, (CCmd.step CRule.re_range_refl (CArgList.cons a1 CArgList.nil) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_re_range_refl a1 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.re_range_emp (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 (CIndexList.cons n2 (CIndexList.cons n3 CIndexList.nil)))) => (__eo_push_proven (__eo_prog_re_range_emp a1 a2 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2)) (Proof.pf (__eo_state_proven_nth S n3))) S)
  | S, (CCmd.step CRule.re_range_non_singleton_1 (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_re_range_non_singleton_1 a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.re_range_non_singleton_2 (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_re_range_non_singleton_2 a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.re_star_union_char (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_re_star_union_char a1 a2) S)
  | S, (CCmd.step CRule.re_star_union_drop_emp (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_re_star_union_drop_emp a1 a2) S)
  | S, (CCmd.step CRule.re_loop_neg (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_re_loop_neg a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.re_inter_cstring (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_re_inter_cstring a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.re_inter_cstring_neg (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_re_inter_cstring_neg a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_substr_len_include (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_substr_len_include a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_substr_len_include_pre (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_substr_len_include_pre a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_substr_len_norm (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_substr_len_norm a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.seq_len_rev (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_seq_len_rev a1) S)
  | S, (CCmd.step CRule.seq_rev_rev (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_seq_rev_rev a1) S)
  | S, (CCmd.step CRule.seq_rev_concat (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) CIndexList.nil) => (__eo_push_proven (__eo_prog_seq_rev_concat a1 a2 a3) S)
  | S, (CCmd.step CRule.str_eq_repl_self_emp (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_eq_repl_self_emp a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_eq_repl_no_change (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_eq_repl_no_change a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_eq_repl_tgt_eq_len (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_eq_repl_tgt_eq_len a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_eq_repl_len_one_emp_prefix (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_str_eq_repl_len_one_emp_prefix a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.str_eq_repl_emp_tgt_nemp (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_str_eq_repl_emp_tgt_nemp a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.str_eq_repl_nemp_src_emp (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_str_eq_repl_nemp_src_emp a1 a2 a3 a4 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.str_eq_repl_self_src (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_eq_repl_self_src a1 a2) S)
  | S, (CCmd.step CRule.seq_len_unit (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_seq_len_unit a1) S)
  | S, (CCmd.step CRule.seq_nth_unit (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_seq_nth_unit a1) S)
  | S, (CCmd.step CRule.seq_rev_unit (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_seq_rev_unit a1) S)
  | S, (CCmd.step CRule.re_in_empty (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_re_in_empty a1) S)
  | S, (CCmd.step CRule.re_in_sigma (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_re_in_sigma a1) S)
  | S, (CCmd.step CRule.re_in_sigma_star (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_re_in_sigma_star a1) S)
  | S, (CCmd.step CRule.re_in_cstring (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_re_in_cstring a1 a2) S)
  | S, (CCmd.step CRule.re_in_comp (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_re_in_comp a1 a2) S)
  | S, (CCmd.step CRule.str_in_re_union_elim (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_in_re_union_elim a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.str_in_re_inter_elim (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_in_re_inter_elim a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.str_in_re_range_elim (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_str_in_re_range_elim a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.str_in_re_contains (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_in_re_contains a1 a2) S)
  | S, (CCmd.step CRule.str_in_re_from_int_nemp_dig_range (CArgList.cons a1 CArgList.nil) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_str_in_re_from_int_nemp_dig_range a1 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.str_in_re_from_int_dig_range (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_str_in_re_from_int_dig_range a1) S)
  | S, (CCmd.step CRule.eq_refl (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_eq_refl a1) S)
  | S, (CCmd.step CRule.eq_symm (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_eq_symm a1 a2) S)
  | S, (CCmd.step CRule.eq_cond_deq (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_eq_cond_deq a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.eq_ite_lift (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 (CArgList.cons a4 CArgList.nil)))) CIndexList.nil) => (__eo_push_proven (__eo_prog_eq_ite_lift a1 a2 a3 a4) S)
  | S, (CCmd.step CRule.distinct_binary_elim (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_distinct_binary_elim a1 a2) S)
  | S, (CCmd.step CRule.uf_bv2nat_int2bv (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_uf_bv2nat_int2bv a1 a2 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.uf_bv2nat_int2bv_extend (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_uf_bv2nat_int2bv_extend a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.uf_bv2nat_int2bv_extract (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_uf_bv2nat_int2bv_extract a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.uf_int2bv_bv2nat (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_uf_int2bv_bv2nat a1 a2) S)
  | S, (CCmd.step CRule.uf_bv2nat_geq_elim (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 CIndexList.nil)) => (__eo_push_proven (__eo_prog_uf_bv2nat_geq_elim a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1))) S)
  | S, (CCmd.step CRule.uf_int2bv_bvult_equiv (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_uf_int2bv_bvult_equiv a1 a2) S)
  | S, (CCmd.step CRule.uf_int2bv_bvule_equiv (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_uf_int2bv_bvule_equiv a1 a2) S)
  | S, (CCmd.step CRule.uf_sbv_to_int_elim (CArgList.cons a1 (CArgList.cons a2 (CArgList.cons a3 CArgList.nil))) (CIndexList.cons n1 (CIndexList.cons n2 CIndexList.nil))) => (__eo_push_proven (__eo_prog_uf_sbv_to_int_elim a1 a2 a3 (Proof.pf (__eo_state_proven_nth S n1)) (Proof.pf (__eo_state_proven_nth S n2))) S)
  | S, (CCmd.step CRule.evaluate (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_evaluate a1) S)
  | S, (CCmd.step CRule.distinct_values (CArgList.cons a1 (CArgList.cons a2 CArgList.nil)) CIndexList.nil) => (__eo_push_proven (__eo_prog_distinct_values a1 a2) S)
  | S, (CCmd.step CRule.aci_norm (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_aci_norm a1) S)
  | S, (CCmd.step CRule.absorb (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_absorb a1) S)
  | S, (CCmd.step CRule.distinct_card_conflict (CArgList.cons a1 CArgList.nil) CIndexList.nil) => (__eo_push_proven (__eo_prog_distinct_card_conflict a1) S)
  | S, c => CState.Stuck
