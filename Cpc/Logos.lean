...
partial def native_ite {T : Type} (c : native_Bool) (t e : T) : T :=
  if c then t else e
...
abbrev native_nat_plus := SmtEval.native_nat_plus
...
def __arith_mk_zero : Term -> Term
  ...
  | Term.Real => (Term.Rational (native_mk_rational 0 1))
  | _ => Term.Stuck


def __arith_mk_one : Term -> Term
  | Term.Int => (Term.Numeral 1)
  | Term.Real => (Term.Rational (native_mk_rational 1 1))
  | _ => Term.Stuck
...
def __arith_reduction_pred : Term -> Term
  | (Term.Apply Term.is_int u) => 
    ...
    (Term.Apply (Term.Apply Term.and (Term.Apply (Term.Apply Term.eq (Term.Apply Term.is_int u)) (Term.Apply (Term.Apply Term.eq u) _v0))) (Term.Apply (Term.Apply Term.and (Term.Apply (Term.Apply Term.and (Term.Apply (Term.Apply Term.leq (Term.Rational (native_mk_rational 0 1))) _v1)) (Term.Apply (Term.Apply Term.and (Term.Apply (Term.Apply Term.lt _v1) (Term.Rational (native_mk_rational 1 1)))) (Term.Boolean true)))) (Term.Boolean true)))
  | (Term.Apply Term.to_int u) => 
    ...
    (Term.Apply (Term.Apply Term.and (Term.Apply (Term.Apply Term.eq _v0) _v1)) (Term.Apply (Term.Apply Term.and (Term.Apply (Term.Apply Term.and (Term.Apply (Term.Apply Term.leq (Term.Rational (native_mk_rational 0 1))) _v2)) (Term.Apply (Term.Apply Term.and (Term.Apply (Term.Apply Term.lt _v2) (Term.Rational (native_mk_rational 1 1)))) (Term.Boolean true)))) (Term.Boolean true)))
  ...
  | (Term.Apply (Term.Apply Term.qdiv_total u) v) => 
    ...
    (__eo_mk_apply (Term.Apply Term.and (Term.Apply (Term.Apply Term.eq _v1) _v2)) (__eo_mk_apply (__eo_mk_apply Term.and (__eo_mk_apply (__eo_mk_apply Term.imp (__eo_mk_apply Term.not (__eo_mk_apply (__eo_mk_apply Term.eq _v0) (Term.Rational (native_mk_rational 0 1))))) (__eo_mk_apply (__eo_mk_apply Term.eq (__eo_mk_apply (__eo_mk_apply Term.mult _v0) (__eo_mk_apply (Term.Apply Term.mult _v2) (__eo_nil Term.mult (__eo_typeof _v0))))) (__eo_ite (__eo_eq (__eo_typeof u) Term.Int) (Term.Apply Term.to_real u) u)))) (Term.Boolean true)))
  | (Term.Apply (Term.Apply Term.div_total a) b) => 
    ...
    (__eo_mk_apply (Term.Apply Term.and (Term.Apply (Term.Apply Term.eq _v0) _v1)) (__eo_mk_apply (__eo_mk_apply Term.and (__eo_ite (__eo_is_z b) (__eo_requires (__eo_eq b (Term.Numeral 0)) (Term.Boolean false) (__eo_mk_apply _v5 (__eo_mk_apply (__eo_mk_apply Term.and (__eo_mk_apply _v4 (__eo_mk_apply _v3 (__eo_mk_apply (__eo_mk_apply Term.mult (__eo_mk_apply _v2 (__eo_mk_apply (__eo_mk_apply Term.plus (__eo_ite (__eo_is_neg b) (Term.Numeral (-1 : native_Int)) (Term.Numeral 1))) (Term.Numeral 0)))) (Term.Numeral 1))))) (Term.Boolean true)))) (Term.Apply (Term.Apply Term.and (Term.Apply (Term.Apply Term.imp (Term.Apply (Term.Apply Term.gt b) (Term.Numeral 0))) (Term.Apply _v5 (Term.Apply (Term.Apply Term.and (Term.Apply _v4 (Term.Apply _v3 (Term.Apply (Term.Apply Term.mult (Term.Apply _v2 (Term.Apply (Term.Apply Term.plus (Term.Numeral 1)) (Term.Numeral 0)))) (Term.Numeral 1))))) (Term.Boolean true))))) (Term.Apply (Term.Apply Term.and (Term.Apply (Term.Apply Term.imp (Term.Apply (Term.Apply Term.lt b) (Term.Numeral 0))) (Term.Apply _v5 (Term.Apply (Term.Apply Term.and (Term.Apply _v4 (Term.Apply _v3 (Term.Apply (Term.Apply Term.mult (Term.Apply _v2 (Term.Apply (Term.Apply Term.plus (Term.Numeral (-1 : native_Int))) (Term.Numeral 0)))) (Term.Numeral 1))))) (Term.Boolean true))))) (Term.Boolean true))))) (Term.Boolean true)))
  | (Term.Apply (Term.Apply Term.mod_total a) b) => 
    ...
    (__eo_mk_apply (Term.Apply Term.and (Term.Apply (Term.Apply Term.eq (Term.Apply (Term.Apply Term.mod_total a) b)) (Term.Apply (Term.Apply Term.neg a) _v4))) (__eo_mk_apply (__eo_mk_apply Term.and (__eo_ite (__eo_is_z b) (__eo_requires (__eo_eq b (Term.Numeral 0)) (Term.Boolean false) (__eo_mk_apply _v5 (__eo_mk_apply (__eo_mk_apply Term.and (__eo_mk_apply _v3 (__eo_mk_apply _v2 (__eo_mk_apply (__eo_mk_apply Term.mult (__eo_mk_apply _v1 (__eo_mk_apply (__eo_mk_apply Term.plus (__eo_ite (__eo_is_neg b) (Term.Numeral (-1 : native_Int)) (Term.Numeral 1))) (Term.Numeral 0)))) (Term.Numeral 1))))) (Term.Boolean true)))) (Term.Apply (Term.Apply Term.and (Term.Apply (Term.Apply Term.imp (Term.Apply (Term.Apply Term.gt b) (Term.Numeral 0))) (Term.Apply _v5 (Term.Apply (Term.Apply Term.and (Term.Apply _v3 (Term.Apply _v2 (Term.Apply (Term.Apply Term.mult (Term.Apply _v1 (Term.Apply (Term.Apply Term.plus (Term.Numeral 1)) (Term.Numeral 0)))) (Term.Numeral 1))))) (Term.Boolean true))))) (Term.Apply (Term.Apply Term.and (Term.Apply (Term.Apply Term.imp (Term.Apply (Term.Apply Term.lt b) (Term.Numeral 0))) (Term.Apply _v5 (Term.Apply (Term.Apply Term.and (Term.Apply _v3 (Term.Apply _v2 (Term.Apply (Term.Apply Term.mult (Term.Apply _v1 (Term.Apply (Term.Apply Term.plus (Term.Numeral (-1 : native_Int))) (Term.Numeral 0)))) (Term.Numeral 1))))) (Term.Boolean true))))) (Term.Boolean true))))) (Term.Boolean true)))
...
def __is_poly_norm_rel_consts_rel : Term -> Term
  | Term.Stuck  => Term.Stuck
  | (Term.Apply (Term.Apply Term.lt cx) cy) => (__eo_eq (__eo_ite (__eo_is_neg cx) (Term.Numeral (-1 : native_Int)) (__eo_ite (__eo_is_neg (__eo_neg cx)) (Term.Numeral 1) (Term.Numeral 0))) (__eo_ite (__eo_is_neg cy) (Term.Numeral (-1 : native_Int)) (__eo_ite (__eo_is_neg (__eo_neg cy)) (Term.Numeral 1) (Term.Numeral 0))))
  | (Term.Apply (Term.Apply Term.leq cx) cy) => (__eo_eq (__eo_ite (__eo_is_neg cx) (Term.Numeral (-1 : native_Int)) (__eo_ite (__eo_is_neg (__eo_neg cx)) (Term.Numeral 1) (Term.Numeral 0))) (__eo_ite (__eo_is_neg cy) (Term.Numeral (-1 : native_Int)) (__eo_ite (__eo_is_neg (__eo_neg cy)) (Term.Numeral 1) (Term.Numeral 0))))
  | (Term.Apply (Term.Apply Term.eq cx) cy) => (Term.Boolean true)
  | (Term.Apply (Term.Apply Term.geq cx) cy) => (__eo_eq (__eo_ite (__eo_is_neg cx) (Term.Numeral (-1 : native_Int)) (__eo_ite (__eo_is_neg (__eo_neg cx)) (Term.Numeral 1) (Term.Numeral 0))) (__eo_ite (__eo_is_neg cy) (Term.Numeral (-1 : native_Int)) (__eo_ite (__eo_is_neg (__eo_neg cy)) (Term.Numeral 1) (Term.Numeral 0))))
  | (Term.Apply (Term.Apply Term.gt cx) cy) => (__eo_eq (__eo_ite (__eo_is_neg cx) (Term.Numeral (-1 : native_Int)) (__eo_ite (__eo_is_neg (__eo_neg cx)) (Term.Numeral 1) (Term.Numeral 0))) (__eo_ite (__eo_is_neg cy) (Term.Numeral (-1 : native_Int)) (__eo_ite (__eo_is_neg (__eo_neg cy)) (Term.Numeral 1) (Term.Numeral 0))))
...
def __re_concat_merge : Term -> Term -> Term
  ...
  | r1, (Term.Apply (Term.Apply Term.re_concat r2) rr2) => (Term.Apply (Term.Apply Term.re_concat r1) (Term.Apply (Term.Apply Term.re_concat r2) rr2))
...
def __str_nary_intro : Term -> Term
  ...
  | t => 
    ...
    (__eo_ite (__eo_eq t _v0) t (__eo_mk_apply (Term.Apply Term.str_concat t) _v0))
...
def __re_nary_intro : Term -> Term
  ...
  | t => (Term.Apply (Term.Apply Term.re_concat t) (Term.Apply Term.str_to_re (Term.String "")))
...
def __eo_prog_exists_string_length : Term -> Term -> Term -> Term
  | _ , Term.Stuck , _  => Term.Stuck
  | _ , _ , Term.Stuck  => Term.Stuck
  | (Term.Apply Term.Seq U), n, id => (__eo_requires (__eo_gt n (Term.Numeral (-1 : native_Int))) (Term.Boolean true) (Term.Apply (Term.Apply Term.eq (Term.Apply Term.str_len (Term.Apply (Term.Apply (Term.Apply Term._at_witness_string_length (Term.Apply Term.Seq U)) n) id))) n))
  | _, _, _ => Term.Stuck
...
def __eo_prog_string_code_inj : Term -> Term -> Term
  ...
  | t, s => 
    ...
    (Term.Apply (Term.Apply Term.or (Term.Apply _v0 (Term.Numeral (-1 : native_Int)))) (Term.Apply (Term.Apply Term.or (Term.Apply Term.not (Term.Apply _v0 (Term.Apply Term.str_to_code s)))) (Term.Apply (Term.Apply Term.or (Term.Apply (Term.Apply Term.eq t) s)) (Term.Boolean false))))
...
def __eo_prog_arith_div_total_zero_real : Term -> Term
  | Term.Stuck  => Term.Stuck
  | t1 => (Term.Apply (Term.Apply Term.eq (Term.Apply (Term.Apply Term.qdiv_total t1) (Term.Rational (native_mk_rational 0 1)))) (Term.Rational (native_mk_rational 0 1)))


def __eo_prog_arith_div_total_zero_int : Term -> Term
  | Term.Stuck  => Term.Stuck
  | t1 => (Term.Apply (Term.Apply Term.eq (Term.Apply (Term.Apply Term.qdiv_total t1) (Term.Numeral 0))) (Term.Rational (native_mk_rational 0 1)))
...
def __eo_prog_arith_geq_norm1_real : Term -> Term -> Term
  | Term.Stuck , _  => Term.Stuck
  | _ , Term.Stuck  => Term.Stuck
  | t1, s1 => (Term.Apply (Term.Apply Term.eq (Term.Apply (Term.Apply Term.geq t1) s1)) (Term.Apply (Term.Apply Term.geq (Term.Apply (Term.Apply Term.neg t1) s1)) (Term.Rational (native_mk_rational 0 1))))
...
def __eo_prog_arith_abs_real_gt : Term -> Term -> Term
  ...
  | x1, y1 => 
    let _v0 := (Term.Apply Term.__eoo_neg_2 y1)
    let _v1 := (Term.Apply Term.gt (Term.Apply Term.__eoo_neg_2 x1))
    let _v2 := (Term.Apply Term.ite (Term.Apply (Term.Apply Term.geq y1) (Term.Rational (native_mk_rational 0 1))))
    let _v3 := (Term.Apply Term.gt x1)
    (Term.Apply (Term.Apply Term.eq (Term.Apply (Term.Apply Term.gt (Term.Apply Term.abs x1)) (Term.Apply Term.abs y1))) (Term.Apply (Term.Apply (Term.Apply Term.ite (Term.Apply (Term.Apply Term.geq x1) (Term.Rational (native_mk_rational 0 1)))) (Term.Apply (Term.Apply _v2 (Term.Apply _v3 y1)) (Term.Apply _v3 _v0))) (Term.Apply (Term.Apply _v2 (Term.Apply _v1 y1)) (Term.Apply _v1 _v0))))
...
def __eo_prog_str_indexof_oob2 : Term -> Term -> Term -> Proof -> Term
  ...
  | _ , Term.Stuck , _ , _  => Term.Stuck
  | _ , _ , Term.Stuck , _  => Term.Stuck
  | t1, s1, n1, (Proof.pf (Term.Apply (Term.Apply Term.eq (Term.Apply (Term.Apply Term.gt (Term.Numeral 0)) __eo_lv_n1_2)) (Term.Boolean true))) => (__eo_requires (__eo_eq n1 __eo_lv_n1_2) (Term.Boolean true) (Term.Apply (Term.Apply Term.eq (Term.Apply (Term.Apply (Term.Apply Term.str_indexof t1) s1) n1)) (Term.Numeral (-1 : native_Int))))
  | _, _, _, _ => Term.Stuck
...
def __eo_prog_str_indexof_re_none : Term -> Term -> Term
  | Term.Stuck , _  => Term.Stuck
  | _ , Term.Stuck  => Term.Stuck
  | t1, n1 => (Term.Apply (Term.Apply Term.eq (Term.Apply (Term.Apply (Term.Apply Term.str_indexof_re t1) Term.re_none) n1)) (Term.Numeral (-1 : native_Int)))
...
def __eo_prog_str_to_int_concat_neg_one : Term -> Term -> Term -> Proof -> Proof -> Term
  ...
  | _ , Term.Stuck , _ , _ , _  => Term.Stuck
  | _ , _ , Term.Stuck , _ , _  => Term.Stuck
  | s1, s2, s3, (Proof.pf (Term.Apply (Term.Apply Term.eq (Term.Apply Term.str_to_int __eo_lv_s2_2)) (Term.Numeral (-1 : native_Int)))), (Proof.pf (Term.Apply (Term.Apply Term.eq (Term.Apply (Term.Apply Term.eq (Term.Apply Term.str_len __eo_lv_s2_3)) (Term.Numeral 0))) (Term.Boolean false))) => (__eo_requires (__eo_and (__eo_eq s2 __eo_lv_s2_2) (__eo_eq s2 __eo_lv_s2_3)) (Term.Boolean true) (__eo_mk_apply (__eo_mk_apply Term.eq (__eo_mk_apply Term.str_to_int (__eo_list_concat Term.str_concat s1 (Term.Apply (Term.Apply Term.str_concat s2) s3)))) (Term.Numeral (-1 : native_Int))))
  | _, _, _, _, _ => Term.Stuck
...
def __eo_typeof_tuple : Term -> Term -> Term
  | Term.Stuck , _  => Term.Stuck
  | _ , Term.Stuck  => Term.Stuck
  | T, U => (Term.Apply (Term.Apply Term.Tuple T) U)
...
def __eo_typeof : Term -> Term
  ...
  | (Term.Apply (Term.Apply Term._at__at_pair __eo_x1) __eo_x2) => (__eo_typeof__at__at_pair (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply Term._at__at_TypedList __eo_x1) => (__eo_typeof_Seq (__eo_typeof __eo_x1))
  ...
  | (Term.Apply (Term.Apply Term.leq __eo_x1) __eo_x2) => (__eo_typeof_lt (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.gt __eo_x1) __eo_x2) => (__eo_typeof_lt (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.geq __eo_x1) __eo_x2) => (__eo_typeof_lt (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  ...
  | (Term.Apply Term.__eoo_neg_2 __eo_x1) => (__eo_typeof_abs (__eo_typeof __eo_x1))
  | (Term.Apply (Term.Apply Term.div __eo_x1) __eo_x2) => (__eo_typeof_div (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.mod __eo_x1) __eo_x2) => (__eo_typeof_div (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.multmult __eo_x1) __eo_x2) => (__eo_typeof_div (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  ...
  | (Term.Apply Term.int_log2 __eo_x1) => (__eo_typeof_int_pow2 (__eo_typeof __eo_x1))
  | (Term.Apply Term.int_ispow2 __eo_x1) => (__eo_typeof_int_ispow2 (__eo_typeof __eo_x1))
  | (Term.Apply (Term.Apply Term.div_total __eo_x1) __eo_x2) => (__eo_typeof_div (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.mod_total __eo_x1) __eo_x2) => (__eo_typeof_div (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.multmult_total __eo_x1) __eo_x2) => (__eo_typeof_div (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply Term._at_int_div_by_zero __eo_x1) => (__eo_typeof_int_pow2 (__eo_typeof __eo_x1))
  | (Term.Apply Term._at_mod_by_zero __eo_x1) => (__eo_typeof_int_pow2 (__eo_typeof __eo_x1))
  | (Term.Apply (Term.Apply Term.Array __eo_x1) __eo_x2) => (__eo_typeof__at__at_Pair (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  ...
  | (Term.Apply (Term.Apply Term.bvor __eo_x1) __eo_x2) => (__eo_typeof_bvand (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.bvnand __eo_x1) __eo_x2) => (__eo_typeof_bvand (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.bvnor __eo_x1) __eo_x2) => (__eo_typeof_bvand (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.bvxor __eo_x1) __eo_x2) => (__eo_typeof_bvand (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.bvxnor __eo_x1) __eo_x2) => (__eo_typeof_bvand (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.bvcomp __eo_x1) __eo_x2) => (__eo_typeof_bvcomp (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply Term.bvneg __eo_x1) => (__eo_typeof_bvnot (__eo_typeof __eo_x1))
  | (Term.Apply (Term.Apply Term.bvadd __eo_x1) __eo_x2) => (__eo_typeof_bvand (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.bvmul __eo_x1) __eo_x2) => (__eo_typeof_bvand (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.bvudiv __eo_x1) __eo_x2) => (__eo_typeof_bvand (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.bvurem __eo_x1) __eo_x2) => (__eo_typeof_bvand (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.bvsub __eo_x1) __eo_x2) => (__eo_typeof_bvand (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.bvsdiv __eo_x1) __eo_x2) => (__eo_typeof_bvand (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.bvsrem __eo_x1) __eo_x2) => (__eo_typeof_bvand (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.bvsmod __eo_x1) __eo_x2) => (__eo_typeof_bvand (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.bvult __eo_x1) __eo_x2) => (__eo_typeof_bvult (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.bvule __eo_x1) __eo_x2) => (__eo_typeof_bvult (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.bvugt __eo_x1) __eo_x2) => (__eo_typeof_bvult (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.bvuge __eo_x1) __eo_x2) => (__eo_typeof_bvult (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.bvslt __eo_x1) __eo_x2) => (__eo_typeof_bvult (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.bvsle __eo_x1) __eo_x2) => (__eo_typeof_bvult (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.bvsgt __eo_x1) __eo_x2) => (__eo_typeof_bvult (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.bvsge __eo_x1) __eo_x2) => (__eo_typeof_bvult (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.bvshl __eo_x1) __eo_x2) => (__eo_typeof_bvand (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.bvlshr __eo_x1) __eo_x2) => (__eo_typeof_bvand (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.bvashr __eo_x1) __eo_x2) => (__eo_typeof_bvand (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  ...
  | (Term.Apply (Term.Apply Term.sign_extend __eo_x1) __eo_x2) => (__eo_typeof_zero_extend (__eo_typeof __eo_x1) __eo_x1 (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.rotate_left __eo_x1) __eo_x2) => (__eo_typeof_rotate_left (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.rotate_right __eo_x1) __eo_x2) => (__eo_typeof_rotate_left (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  ...
  | (Term.Apply (Term.Apply Term.bvuaddo __eo_x1) __eo_x2) => (__eo_typeof_bvult (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply Term.bvnego __eo_x1) => (__eo_typeof_bvnego (__eo_typeof __eo_x1))
  | (Term.Apply (Term.Apply Term.bvsaddo __eo_x1) __eo_x2) => (__eo_typeof_bvult (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.bvumulo __eo_x1) __eo_x2) => (__eo_typeof_bvult (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.bvsmulo __eo_x1) __eo_x2) => (__eo_typeof_bvult (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.bvusubo __eo_x1) __eo_x2) => (__eo_typeof_bvult (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.bvssubo __eo_x1) __eo_x2) => (__eo_typeof_bvult (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.bvsdivo __eo_x1) __eo_x2) => (__eo_typeof_bvult (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.bvultbv __eo_x1) __eo_x2) => (__eo_typeof_bvcomp (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.bvsltbv __eo_x1) __eo_x2) => (__eo_typeof_bvcomp (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply Term.bvredand __eo_x1) => (__eo_typeof_bvredand (__eo_typeof __eo_x1))
  | (Term.Apply Term.bvredor __eo_x1) => (__eo_typeof_bvredand (__eo_typeof __eo_x1))
  ...
  | (Term.Apply (Term.Apply Term.str_prefixof __eo_x1) __eo_x2) => (__eo_typeof_str_contains (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.str_suffixof __eo_x1) __eo_x2) => (__eo_typeof_str_contains (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  ...
  | (Term.Apply Term.str_to_upper __eo_x1) => (__eo_typeof_str_to_lower (__eo_typeof __eo_x1))
  ...
  | (Term.Apply Term.str_to_int __eo_x1) => (__eo_typeof_str_to_code (__eo_typeof __eo_x1))
  | (Term.Apply Term.str_from_int __eo_x1) => (__eo_typeof_str_from_code (__eo_typeof __eo_x1))
  | (Term.Apply (Term.Apply Term.str_lt __eo_x1) __eo_x2) => (__eo_typeof_str_lt (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.str_leq __eo_x1) __eo_x2) => (__eo_typeof_str_lt (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply (Term.Apply Term.str_replace_all __eo_x1) __eo_x2) __eo_x3) => (__eo_typeof_str_replace (__eo_typeof __eo_x1) (__eo_typeof __eo_x2) (__eo_typeof __eo_x3))
  ...
  | (Term.Apply (Term.Apply (Term.Apply Term.str_replace_re_all __eo_x1) __eo_x2) __eo_x3) => (__eo_typeof_str_replace_re (__eo_typeof __eo_x1) (__eo_typeof __eo_x2) (__eo_typeof __eo_x3))
  ...
  | (Term.Apply Term.re_plus __eo_x1) => (__eo_typeof_re_mult (__eo_typeof __eo_x1))
  | (Term.Apply (Term.Apply Term.re_exp __eo_x1) __eo_x2) => (__eo_typeof_re_exp (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply Term.re_opt __eo_x1) => (__eo_typeof_re_mult (__eo_typeof __eo_x1))
  | (Term.Apply Term.re_comp __eo_x1) => (__eo_typeof_re_mult (__eo_typeof __eo_x1))
  ...
  | (Term.Apply (Term.Apply Term.re_inter __eo_x1) __eo_x2) => (__eo_typeof_re_concat (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.re_union __eo_x1) __eo_x2) => (__eo_typeof_re_concat (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.re_diff __eo_x1) __eo_x2) => (__eo_typeof_re_concat (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  ...
  | (Term.Apply Term._at_strings_stoi_non_digit __eo_x1) => (__eo_typeof_str_to_code (__eo_typeof __eo_x1))
  | (Term.Apply (Term.Apply Term._at_strings_itos_result __eo_x1) __eo_x2) => (__eo_typeof_div (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  ...
  | (Term.Apply (Term.Apply (Term.Apply Term._at_strings_occur_index __eo_x1) __eo_x2) __eo_x3) => (__eo_typeof_str_indexof (__eo_typeof __eo_x1) (__eo_typeof __eo_x2) (__eo_typeof __eo_x3))
  ...
  | (Term.Apply Term.Set __eo_x1) => (__eo_typeof_Seq (__eo_typeof __eo_x1))
  ...
  | (Term.Apply (Term.Apply Term.set_inter __eo_x1) __eo_x2) => (__eo_typeof_set_union (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  | (Term.Apply (Term.Apply Term.set_minus __eo_x1) __eo_x2) => (__eo_typeof_set_union (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
  ...
  | (Term.Apply Term.set_is_singleton __eo_x1) => (__eo_typeof_set_is_empty (__eo_typeof __eo_x1))
  ...
  | (Term.Apply (Term.Apply Term.qdiv_total __eo_x1) __eo_x2) => (__eo_typeof_qdiv (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
...
partial def __lower_not_and : Term -> Term
  ...
  | (Term.Apply (Term.Apply Term.and l) ls) => (__eo_mk_apply (Term.Apply Term.or (Term.Apply Term.not l)) (__lower_not_and ls))
  | _ => Term.Stuck
...
partial def __eo_prog_cnf_and_neg : Term -> Term
  | Term.Stuck  => Term.Stuck
  | Fs => (__eo_mk_apply (Term.Apply Term.or Fs) (__lower_not_and Fs))
...
partial def __tuple_get_selectors_rec : Term -> Term -> Term
  ...
  | (Term.Apply (Term.Apply Term.Tuple T1) T2), n => (__eo_mk_apply (Term.Apply Term.__eo_List_cons (Term.Apply Term.tuple_select n)) (__tuple_get_selectors_rec T2 (__eo_add n (Term.Numeral 1))))
  | _, _ => Term.Stuck
...
partial def __is_cons_app : Term -> Term
  ...
  | y => (__eo_ite (__eo_is_eq y Term.tuple) (Term.Boolean true) (__eo_is_ok (__eo_dt_selectors y)))


partial def __dt_arg_list : Term -> Term
  | Term.Stuck  => Term.Stuck
  | (Term.Apply (Term.Apply Term.tuple t1) t2) => (__eo_mk_apply (Term.Apply Term.__eo_List_cons t1) (__dt_arg_list t2))
...
partial def __tuple_nth : Term -> Term -> Term
  ...
  | (Term.Apply (Term.Apply Term.tuple s) ts), n => (__tuple_nth ts (__eo_add n (Term.Numeral (-1 : native_Int))))
  | _, _ => Term.Stuck
...
partial def __mk_nary_cong_rhs : Term -> Term -> Term
  | Term.Stuck , _  => Term.Stuck
  | _ , Term.Stuck  => Term.Stuck
  | (Term.Apply (Term.Apply f s1) t), (Term.Apply (Term.Apply Term.and (Term.Apply (Term.Apply Term.eq __eo_lv_s1_2) s2)) tail) => (__eo_ite (__eo_eq s1 __eo_lv_s1_2) (__eo_mk_apply (Term.Apply f s2) (__mk_nary_cong_rhs t tail)) (__eo_l_1___mk_nary_cong_rhs (Term.Apply (Term.Apply f s1) t) (Term.Apply (Term.Apply Term.and (Term.Apply (Term.Apply Term.eq __eo_lv_s1_2) s2)) tail)))
...
partial def __poly_neg : Term -> Term
  ...
  | (Term.Apply (Term.Apply Term._at__at_poly (Term.Apply (Term.Apply Term._at__at_mon a) c)) p) => (__eo_mk_apply (__eo_mk_apply Term._at__at_poly (__eo_mk_apply (Term.Apply Term._at__at_mon a) (__eo_neg c))) (__poly_neg p))
  | _ => Term.Stuck
...
partial def __poly_mod_coeffs : Term -> Term -> Term
  ...
  | (Term.Apply (Term.Apply Term._at__at_poly (Term.Apply (Term.Apply Term._at__at_mon a) c)) p), w => 
    ...
    (__eo_ite (__eo_eq _v1 (Term.Numeral 0)) _v0 (__eo_mk_apply (__eo_mk_apply Term._at__at_poly (__eo_mk_apply (Term.Apply Term._at__at_mon a) (__eo_to_q _v1))) _v0))
  | _, _ => Term.Stuck
...
partial def __poly_add : Term -> Term -> Term
  ...
  | (Term.Apply (Term.Apply Term._at__at_poly (Term.Apply (Term.Apply Term._at__at_mon a1) c1)) p1), (Term.Apply (Term.Apply Term._at__at_poly (Term.Apply (Term.Apply Term._at__at_mon a2) c2)) p2) => 
    ...
    let _v1 := (Term.Apply Term._at__at_poly (Term.Apply _v0 c1))
    let _v2 := (Term.Apply Term._at__at_poly (Term.Apply (Term.Apply Term._at__at_mon a2) c2))
    let _v3 := (__poly_add p1 p2)
    let _v4 := (__eo_add c1 c2)
    (__eo_ite (__eo_eq a1 a2) (__eo_ite (__eo_eq _v4 (Term.Rational (native_mk_rational 0 1))) _v3 (__eo_mk_apply (__eo_mk_apply Term._at__at_poly (__eo_mk_apply _v0 _v4)) _v3)) (__eo_ite (__eo_cmp a2 a1) (__eo_mk_apply _v1 (__poly_add p1 (Term.Apply _v2 p2))) (__eo_mk_apply _v2 (__poly_add (Term.Apply _v1 p1) p2))))
...
partial def __get_arith_poly_norm : Term -> Term
  ...
  | (Term.Apply (Term.Apply Term.qdiv a1) a2) => 
    ...
    (__eo_ite (__eo_ite (__eo_is_q _v0) (__eo_not (__eo_eq _v0 (Term.Rational (native_mk_rational 0 1)))) (Term.Boolean false)) (__poly_mul_mon (__eo_mk_apply (Term.Apply Term._at__at_mon Term.__eo_List_nil) (__eo_qdiv (Term.Rational (native_mk_rational 1 1)) _v0)) (__get_arith_poly_norm a1)) (Term.Apply (Term.Apply Term._at__at_poly (Term.Apply (Term.Apply Term._at__at_mon (Term.Apply (Term.Apply Term.__eo_List_cons (Term.Apply (Term.Apply Term.qdiv a1) a2)) Term.__eo_List_nil)) (Term.Rational (native_mk_rational 1 1)))) Term._at__at_Polynomial))
  ...
  | a => 
    let _v0 := (__eo_to_q a)
    (__eo_ite (__eo_is_q _v0) (__eo_ite (__eo_is_eq _v0 (Term.Rational (native_mk_rational 0 1))) Term._at__at_Polynomial (__eo_mk_apply (__eo_mk_apply Term._at__at_poly (__eo_mk_apply (Term.Apply Term._at__at_mon Term.__eo_List_nil) _v0)) Term._at__at_Polynomial)) (Term.Apply (Term.Apply Term._at__at_poly (Term.Apply (Term.Apply Term._at__at_mon (Term.Apply (Term.Apply Term.__eo_List_cons a) Term.__eo_List_nil)) (Term.Rational (native_mk_rational 1 1)))) Term._at__at_Polynomial))
...
partial def __bv_unfold_repeat_rec : Term -> Term -> Term
  ...
  | n, b => (__eo_mk_apply (Term.Apply Term.concat b) (__bv_unfold_repeat_rec (__eo_add n (Term.Numeral (-1 : native_Int))) b))
...
partial def __bv_bitblast_concat : Term -> Term -> Term
  | _ , Term.Stuck  => Term.Stuck
  | (Term.Apply (Term.Apply Term._at_from_bools x) y), z => (__eo_mk_apply (Term.Apply Term._at_from_bools x) (__bv_bitblast_concat y z))
  | (Term.Binary 0 0), z => z
  | _, _ => Term.Stuck
...
partial def __bv_bitblast_repeat : Term -> Term -> Term
  ...
  | b, n => (__eo_mk_apply (Term.Apply Term._at_from_bools b) (__bv_bitblast_repeat b (__eo_add n (Term.Numeral (-1 : native_Int)))))
...
partial def __bv_bitblast_prefix : Term -> Term -> Term
  ...
  | l, (Term.Apply (Term.Apply Term._at_from_bools b) a) => (__eo_mk_apply (Term.Apply Term._at_from_bools b) (__bv_bitblast_prefix (__eo_add l (Term.Numeral (-1 : native_Int))) a))
  | _, _ => Term.Stuck
...
partial def __bv_bitblast_subsequence : Term -> Term -> Term -> Term
  ...
  | l, u, (Term.Apply (Term.Apply Term._at_from_bools b) a) => (__bv_bitblast_subsequence (__eo_add l (Term.Numeral (-1 : native_Int))) (__eo_add u (Term.Numeral (-1 : native_Int))) a)
  | _, _, _ => Term.Stuck
...
partial def __bv_bitblast_apply_unary : Term -> Term -> Term
  ...
  | f, (Term.Apply (Term.Apply Term._at_from_bools b1) a1) => (__eo_mk_apply (Term.Apply Term._at_from_bools (Term.Apply f b1)) (__bv_bitblast_apply_unary f a1))
  | _, _ => Term.Stuck
...
partial def __bv_bitblast_apply_binary : Term -> Term -> Term -> Term
  ...
  | f, (Term.Apply (Term.Apply Term._at_from_bools b1) a1), (Term.Apply (Term.Apply Term._at_from_bools b2) a2) => (__eo_mk_apply (__eo_mk_apply Term._at_from_bools (__bv_bitblast_binary_app f b1 b2)) (__bv_bitblast_apply_binary f a1 a2))
  | _, _, _ => Term.Stuck
...
partial def __bv_bitblast_apply_ite : Term -> Term -> Term -> Term
  ...
  | bc, (Term.Apply (Term.Apply Term._at_from_bools b1) a1), (Term.Apply (Term.Apply Term._at_from_bools b2) a2) => (__eo_mk_apply (Term.Apply Term._at_from_bools (Term.Apply (Term.Apply (Term.Apply Term.ite bc) b1) b2)) (__bv_bitblast_apply_ite bc a1 a2))
  | _, _, _ => Term.Stuck


partial def __bv_mk_bitblast_step_eq_rec : Term -> Term -> Term
  | (Term.Binary 0 0), (Term.Binary 0 0) => (Term.Boolean true)
  | (Term.Apply (Term.Apply Term._at_from_bools b1) a1), (Term.Apply (Term.Apply Term._at_from_bools b2) a2) => (__eo_mk_apply (Term.Apply Term.and (Term.Apply (Term.Apply Term.eq b1) b2)) (__bv_mk_bitblast_step_eq_rec a1 a2))
  | _, _ => Term.Stuck
...
partial def __bv_shift_add_multiplier_rec_step : Term -> Term -> Term -> Term -> Term -> Term
  ...
  | b1, (Term.Apply (Term.Apply Term._at_from_bools b2) a2), (Term.Numeral 0), (Term.Apply (Term.Apply Term._at_from_bools br) ar), carry => 
    ...
    (__eo_mk_apply (Term.Apply Term._at_from_bools (Term.Apply (Term.Apply Term.xor _v1) carry)) (__bv_shift_add_multiplier_rec_step b1 a2 (Term.Numeral 0) ar (Term.Apply (Term.Apply Term.or (Term.Apply (Term.Apply Term.and br) (Term.Apply (Term.Apply Term.and _v0) (Term.Boolean true)))) (Term.Apply (Term.Apply Term.or (Term.Apply (Term.Apply Term.and _v1) (Term.Apply (Term.Apply Term.and carry) (Term.Boolean true)))) (Term.Boolean false)))))
  | b1, a2, k, (Term.Apply (Term.Apply Term._at_from_bools br) ar), carry => (__eo_mk_apply (Term.Apply Term._at_from_bools br) (__bv_shift_add_multiplier_rec_step b1 a2 (__eo_add k (Term.Numeral (-1 : native_Int))) ar carry))
  | _, _, _, _, _ => Term.Stuck
...
partial def __eo_l_1___bv_div_mod_impl : Term -> Term -> Term -> Term -> Term
  ...
  | a1, a2, zero, sz => 
    ...
    let _v2 := (__bv_div_mod_impl (__bv_bitblast_concat (__bv_bitblast_subsequence (Term.Numeral 1) (__eo_list_len Term._at_from_bools a1) a1) _v1) a2 zero (__eo_add sz (Term.Numeral (-1 : native_Int))))
    let _v3 := (__pair_second _v2)
    let _v4 := (__pair_second (__bv_ripple_carry_adder_2 (__bv_bitblast_concat _v1 (__bv_bitblast_subsequence (Term.Numeral 0) (__eo_add (__eo_add (__eo_list_len Term._at_from_bools _v3) (Term.Numeral (-1 : native_Int))) (Term.Numeral (-1 : native_Int))) _v3)) zero (__eo_mk_apply (__eo_mk_apply (__eo_mk_apply Term.ite (__eo_mk_apply (__eo_mk_apply Term.eq (__bv_bitblast_head a1)) (Term.Boolean true))) (Term.Boolean true)) (Term.Boolean false)) (Term.Binary 0 0)))
    ...
    let _v9 := (__bv_bitblast_concat _v1 (__bv_bitblast_subsequence (Term.Numeral 0) (__eo_add (__eo_add (__eo_list_len Term._at_from_bools _v8) (Term.Numeral (-1 : native_Int))) (Term.Numeral (-1 : native_Int))) _v8))
...
partial def __bv_mk_bitblast_step_ite : Term -> Term -> Term -> Term
  | (Term.Apply (Term.Apply Term._at_from_bools bc) (Term.Binary 0 0)), (Term.Apply (Term.Apply Term._at_from_bools b1) a1), (Term.Apply (Term.Apply Term._at_from_bools b2) a2) => (__eo_mk_apply (Term.Apply Term._at_from_bools (Term.Apply (Term.Apply Term.and (Term.Apply (Term.Apply Term.or (Term.Apply Term.not bc)) (Term.Apply (Term.Apply Term.or b1) (Term.Boolean false)))) (Term.Apply (Term.Apply Term.and (Term.Apply (Term.Apply Term.or bc) (Term.Apply (Term.Apply Term.or b2) (Term.Boolean false)))) (Term.Boolean true)))) (__bv_mk_bitblast_step_ite (Term.Apply (Term.Apply Term._at_from_bools bc) (Term.Binary 0 0)) a1 a2))
...
partial def __bv_mk_bitblast_step_shl_rec_step : Term -> Term -> Term -> Term -> Term
  ...
  | (Term.Apply (Term.Apply Term._at_from_bools b1) a1), (Term.Apply (Term.Apply Term._at_from_bools b1c) a1c), (Term.Numeral 0), b2 => (__eo_mk_apply (Term.Apply Term._at_from_bools (Term.Apply (Term.Apply (Term.Apply Term.ite b2) b1c) b1)) (__bv_mk_bitblast_step_shl_rec_step a1 a1c (Term.Numeral 0) b2))
  | (Term.Apply (Term.Apply Term._at_from_bools b1) a1), a1c, i, b2 => (__eo_mk_apply (Term.Apply Term._at_from_bools (Term.Apply (Term.Apply (Term.Apply Term.ite b2) (Term.Boolean false)) b1)) (__bv_mk_bitblast_step_shl_rec_step a1 a1c (__eo_add i (Term.Numeral (-1 : native_Int))) b2))
  | _, _, _, _ => Term.Stuck
...
partial def __bv_mk_bitblast_step_shr_rec_step : Term -> Term -> Term -> Term -> Term -> Term
  ...
  | (Term.Apply (Term.Apply Term._at_from_bools b1) a1), (Term.Apply (Term.Apply Term._at_from_bools b1c) a1c), (Term.Numeral 0), b2, sbit => (__eo_mk_apply (Term.Apply Term._at_from_bools (Term.Apply (Term.Apply (Term.Apply Term.ite (Term.Apply Term.not b2)) b1) b1c)) (__bv_mk_bitblast_step_shr_rec_step a1 a1c (Term.Numeral 0) b2 sbit))
  | (Term.Apply (Term.Apply Term._at_from_bools b1) a1), (Term.Binary 0 0), (Term.Numeral 0), b2, sbit => (__eo_mk_apply (Term.Apply Term._at_from_bools (Term.Apply (Term.Apply (Term.Apply Term.ite b2) sbit) b1)) (__bv_mk_bitblast_step_shr_rec_step a1 (Term.Binary 0 0) (Term.Numeral 0) b2 sbit))
  | a1, (Term.Apply (Term.Apply Term._at_from_bools b1c) a1c), i, b2, sbit => (__bv_mk_bitblast_step_shr_rec_step a1 a1c (__eo_add i (Term.Numeral (-1 : native_Int))) b2 sbit)
  | _, _, _, _, _ => Term.Stuck
...
partial def __bv_mk_bitblast_step_var_rec : Term -> Term -> Term
  ...
  | a, i => (__eo_mk_apply (Term.Apply Term._at_from_bools (Term.Apply (Term.Apply Term._at_bit i) a)) (__bv_mk_bitblast_step_var_rec a (__eo_add i (Term.Numeral (-1 : native_Int)))))
...
partial def __bv_mk_bitblast_step : Term -> Term
  ...
  | a1 => (__eo_ite (__eo_is_bin a1) (__bv_const_to_bitlist_rec a1 (Term.Numeral 0) (__eo_len a1)) (__eo_list_rev Term._at_from_bools (__bv_mk_bitblast_step_var_rec a1 (__eo_add (__bv_bitwidth (__eo_typeof a1)) (Term.Numeral (-1 : native_Int))))))
...
partial def __bv_mk_bitwise_slicing_rec : Term -> Term -> Term -> Term -> Term -> Term -> Term -> Term
  ...
  | f, c, a, bs, bn, start, (Term.Numeral (-1 : native_Int)) => 
    ...
    (__eo_mk_apply (__eo_mk_apply Term.concat (__eo_mk_apply (Term.Apply f _v1) (__eo_mk_apply (Term.Apply f (Term.Apply _v0 a)) (__eo_nil f (__eo_typeof _v1))))) (Term.Binary 0 0))
  | f, c, a, (Term.Apply (Term.Apply Term._at_from_bools b) bs), bn, start, __eo_end => 
    ...
    (__eo_ite (__eo_eq b bn) (__bv_mk_bitwise_slicing_rec f c a bs b start _v0) (__eo_mk_apply (__eo_mk_apply Term.concat (__eo_mk_apply (__eo_mk_apply f _v2) (__eo_mk_apply (__eo_mk_apply f (__eo_mk_apply _v1 a)) (__eo_nil f (__eo_typeof _v2))))) (__bv_mk_bitwise_slicing_rec f c a bs b __eo_end _v0)))
  | _, _, _, _, _, _, _ => Term.Stuck
...
partial def __derivative : Term -> Term -> Term
  ...
  | c, (Term.Apply Term.str_to_re s1) => (__eo_ite (__eo_is_eq (__eo_extract s1 (Term.Numeral 0) (Term.Numeral 0)) c) (__eo_mk_apply Term.str_to_re (__eo_extract s1 (Term.Numeral 1) (__eo_add (Term.Numeral (-1 : native_Int)) (__eo_len s1)))) Term.re_none)
...
partial def __re_unfold_pos_concat_rec : Term -> Term -> Term -> Term -> Term
  ...
  | t, (Term.Apply (Term.Apply Term.re_concat (Term.Apply Term.str_to_re s)) r2), ro, i => 
    ...
    (__eo_mk_apply (__eo_mk_apply Term._at__at_pair (__eo_mk_apply (Term.Apply Term.str_concat s) (__pair_first _v0))) (__pair_second _v0))
  | t, (Term.Apply (Term.Apply Term.re_concat r1) r2), ro, i => 
    ...
    (__eo_mk_apply (__eo_mk_apply Term._at__at_pair (__eo_mk_apply (Term.Apply Term.str_concat _v1) (__pair_first _v0))) (__eo_mk_apply (Term.Apply Term.and (Term.Apply (Term.Apply Term.str_in_re _v1) r1)) (__pair_second _v0)))
  | _, _, _, _ => Term.Stuck
...
partial def __str_flatten : Term -> Term
  ...
  | (Term.Apply (Term.Apply Term.str_concat t) tail) => 
    ...
    (__eo_ite (__eo_is_eq (__eo_is_neg (__eo_add (Term.Numeral 1) (__eo_neg (__eo_len t)))) (Term.Boolean true)) (__eo_list_concat Term.str_concat (__str_flatten_word t) _v0) (__eo_mk_apply (Term.Apply Term.str_concat t) _v0))
  | t => (__eo_requires t (__seq_empty (__eo_typeof t)) t)
...
partial def __str_mk_re_loop_elim_rec : Term -> Term -> Term -> Term -> Term
  ...
  | (Term.Numeral 0), d, r, rr => (__eo_mk_apply (__eo_mk_apply Term.re_union (__eo_list_singleton_elim Term.re_concat rr)) (__str_mk_re_loop_elim_rec (Term.Numeral 0) (__eo_add d (Term.Numeral (-1 : native_Int))) r (Term.Apply (Term.Apply Term.re_concat r) rr)))
  | n, d, r, rr => (__str_mk_re_loop_elim_rec (__eo_add n (Term.Numeral (-1 : native_Int))) d r (Term.Apply (Term.Apply Term.re_concat r) rr))


partial def __str_mk_str_in_re_concat_star_char : Term -> Term -> Term
  | _ , Term.Stuck  => Term.Stuck
  | (Term.Apply (Term.Apply Term.str_concat s1) s2), r => (__eo_mk_apply (Term.Apply Term.and (Term.Apply (Term.Apply Term.str_in_re s1) r)) (__str_mk_str_in_re_concat_star_char s2 r))
...
partial def __re_str_to_flat_form : Term -> Term -> Term
  ...
  | rev, (Term.Apply (Term.Apply Term.re_concat (Term.Apply Term.str_to_re s)) r2) => 
    ...
    (__eo_mk_apply (__eo_mk_apply Term.re_concat (__eo_mk_apply Term.str_to_re (__eo_ite rev (__eo_list_rev Term.str_concat _v0) _v0))) (__re_str_to_flat_form rev r2))
  | rev, (Term.Apply (Term.Apply Term.re_concat r1) r2) => (__eo_mk_apply (Term.Apply Term.re_concat r1) (__re_str_to_flat_form rev r2))
  | rev, r1 => r1
...
partial def __re_str_from_flat_form : Term -> Term -> Term
  | Term.Stuck , _  => Term.Stuck
  | _ , Term.Stuck  => Term.Stuck
  | rev, (Term.Apply (Term.Apply Term.re_concat (Term.Apply Term.str_to_re s)) r2) => (__eo_mk_apply (__eo_mk_apply Term.re_concat (__eo_mk_apply Term.str_to_re (__str_nary_elim (__str_collect (__eo_ite rev (__eo_list_rev Term.str_concat s) s))))) (__re_str_from_flat_form rev r2))
  | rev, (Term.Apply (Term.Apply Term.re_concat r1) r2) => (__eo_mk_apply (Term.Apply Term.re_concat r1) (__re_str_from_flat_form rev r2))
  | rev, r1 => r1
...
partial def __eo_l_1___str_re_includes_rec : Term -> Term -> Term
  ...
  | (Term.Apply (Term.Apply Term.re_concat r1) r2), (Term.Apply (Term.Apply Term.re_concat r3) r4) => 
...
partial def __eo_l_1___str_arith_entail_is_approx : Term -> Term -> Term -> Term
  ...
  | (Term.Apply (Term.Apply (Term.Apply Term.str_indexof s) t) n3), n1, isUnder => 
    ...
    (__eo_ite (__eo_eq n1 (Term.Numeral (-1 : native_Int))) isUnder (__eo_ite (__eo_eq n1 _v1) _v2 (__eo_ite (__eo_eq n1 (Term.Apply (Term.Apply Term.neg _v1) _v0)) (__eo_and _v2 (__str_arith_entail_simple_pred (Term.Apply (Term.Apply Term.geq _v1) _v0))) (Term.Boolean false))))
  | (Term.Apply Term.str_to_int s), n1, isUnder => (__eo_ite (__eo_eq n1 (Term.Numeral (-1 : native_Int))) isUnder (Term.Boolean false))
...
partial def __str_re_consume_rec : Term -> Term -> Term -> Term -> Term
  ...
  | (Term.Apply (Term.Apply Term.str_concat s1) s2), (Term.Apply (Term.Apply Term.re_concat (Term.Apply (Term.Apply Term.re_range s3) s5)) r2), Term._at__at_result_null, rev => 
    let _v0 := (Term.Apply (Term.Apply Term.re_range s3) s5)
    (__eo_ite (__eo_and (__eo_is_eq (__eo_len s1) (Term.Numeral 1)) (__eo_and (__eo_is_eq (__eo_len s3) (Term.Numeral 1)) (__eo_is_eq (__eo_len s5) (Term.Numeral 1)))) (__eo_ite (__str_eval_str_in_re s1 _v0) (__str_re_consume_rec s2 r2 Term._at__at_result_null rev) (Term.Boolean false)) (Term.Apply (Term.Apply Term.str_in_re (Term.Apply (Term.Apply Term.str_concat s1) s2)) (Term.Apply (Term.Apply Term.re_concat _v0) r2)))
  ...
  | (Term.Apply (Term.Apply Term.str_concat s1) s2), (Term.Apply (Term.Apply Term.re_concat (Term.Apply Term.re_mult r3)) r2), Term._at__at_result_null, rev => 
    ...
    let _v4 := (__str_re_consume_rec _v1 (__re_str_to_flat_form rev (__eo_ite rev (__eo_list_rev Term.re_concat _v3) _v3)) Term._at__at_result_null rev)
    let _v5 := (__str_membership_str _v4)
    let _v6 := (__str_re_consume_rec _v1 r2 Term._at__at_result_null rev)
    (__eo_ite (__eo_eq _v4 (Term.Boolean false)) _v6 (__eo_ite (__eo_eq (__str_membership_re _v4) (Term.Apply Term.str_to_re (Term.String ""))) (__eo_ite (__eo_is_eq _v6 (Term.Boolean false)) (__eo_ite (__eo_eq _v1 _v5) _v2 (__str_re_consume_rec _v5 _v0 Term._at__at_result_null rev)) _v2) _v2))
  | (Term.Apply (Term.Apply Term.str_concat s1) s2), (Term.Apply (Term.Apply Term.re_concat r1) r2), Term._at__at_result_null, rev => 
    let _v0 := (Term.Apply (Term.Apply Term.str_concat s1) s2)
    let _v1 := (__str_re_consume_rec _v0 r1 Term._at__at_result_null rev)
    (__eo_ite (__eo_is_eq _v1 (Term.Boolean false)) (Term.Boolean false) (__eo_ite (__eo_is_eq (__str_membership_re _v1) (Term.Apply Term.str_to_re (Term.String ""))) (__str_re_consume_rec (__str_membership_str _v1) r2 Term._at__at_result_null rev) (Term.Apply (Term.Apply Term.str_in_re _v0) (Term.Apply (Term.Apply Term.re_concat r1) r2))))
  ...
  | s1, (Term.Apply (Term.Apply Term.re_inter r1) r2), b, rev => 
    ...
    let _v1 := (__str_re_consume_rec s1 (__re_str_to_flat_form rev (__eo_ite rev (__eo_list_rev Term.re_concat _v0) _v0)) Term._at__at_result_null rev)
...
partial def __mk_re_concat : Term -> Term -> Term
  | (Term.Apply (Term.Apply Term.and (Term.Apply (Term.Apply Term.str_in_re s) r)) Es), (Term.Apply (Term.Apply Term.str_in_re s1) r1) => (__mk_re_concat Es (Term.Apply (Term.Apply Term.str_in_re (Term.Apply (Term.Apply Term.str_concat s) s1)) (Term.Apply (Term.Apply Term.re_concat r) r1)))
...
partial def __mk_re_unfold_pos : Term -> Term -> Term
  ...
  | t, (Term.Apply (Term.Apply Term.re_concat r1) r2) => 
    ...
    (__eo_ite (__eo_eq _v2 (Term.Boolean true)) _v3 (__eo_mk_apply (__eo_mk_apply Term.and _v3) _v2))
  | _, _ => Term.Stuck
...
partial def __eo_l_1___seq_find : Term -> Term -> Term -> Term
  | _ , Term.Stuck , _  => Term.Stuck
  | _ , _ , Term.Stuck  => Term.Stuck
  | (Term.seq_empty (Term.Apply Term.Seq T)), s, n => (Term.Numeral (-1 : native_Int))
...
partial def __seq_subsequence_rec : Term -> Term -> Term -> Term
  ...
  | (Term.Numeral 0), u, (Term.Apply (Term.Apply Term.str_concat (Term.Apply Term.seq_unit e)) ts) => (__eo_mk_apply (Term.Apply Term.str_concat (Term.Apply Term.seq_unit e)) (__seq_subsequence_rec (Term.Numeral 0) (__eo_add u (Term.Numeral (-1 : native_Int))) ts))
  | l, u, (Term.Apply (Term.Apply Term.str_concat (Term.Apply Term.seq_unit e)) ts) => (__seq_subsequence_rec (__eo_add l (Term.Numeral (-1 : native_Int))) (__eo_add u (Term.Numeral (-1 : native_Int))) ts)
  | _, _, _ => Term.Stuck
...
partial def __seq_eval_replace_all_rec : Term -> Term -> Term -> Term -> Term -> Term
  ...
  | s, t, u, n, lent => 
    ...
    (__eo_list_concat Term.str_concat (__eo_ite (__eo_is_neg n) _v1 (__seq_subsequence_rec (Term.Numeral 0) n s)) (__eo_list_concat Term.str_concat u (__seq_eval_replace_all_rec _v2 t u (__seq_find _v2 t (Term.Numeral 0)) lent)))
...
partial def __set_union_to_list : Term -> Term
  | (Term.Apply (Term.Apply Term.set_union (Term.Apply Term.set_singleton e)) t) => (__eo_mk_apply (Term.Apply Term.__eo_List_cons e) (__set_union_to_list t))
...
partial def __eo_l_1___abconv_ubv_to_int_elim : Term -> Term -> Term -> Term -> Term
  ...
  | _ , _ , Term.Stuck , _  => Term.Stuck
  | _ , _ , _ , Term.Stuck  => Term.Stuck
  | b, i, w, p => (__eo_mk_apply (Term.Apply Term.plus (Term.Apply (Term.Apply (Term.Apply Term.ite (Term.Apply (Term.Apply Term.eq (Term.Apply (Term.Apply (Term.Apply Term.extract i) i) b)) (Term.Binary 1 1))) p) (Term.Numeral 0))) (__abconv_ubv_to_int_elim b (__eo_add i (Term.Numeral 1)) w (__eo_mul p (Term.Numeral 2))))
...
partial def __abconv_int_to_bv_elim : Term -> Term -> Term -> Term
  ...
  | n, w, p => 
    ...
    (__eo_mk_apply (__eo_mk_apply Term.concat (__eo_mk_apply (__eo_mk_apply (__eo_mk_apply Term.ite (__eo_mk_apply (Term.Apply Term.geq (Term.Apply (Term.Apply Term.mod_total n) p)) _v0)) (Term.Binary 1 1)) (Term.Binary 1 0))) (__abconv_int_to_bv_elim n (__eo_add w (Term.Numeral (-1 : native_Int))) _v0))
...
partial def __mk_quant_miniscope_and : Term -> Term -> Term
  | Term.Stuck , _  => Term.Stuck
  | x, (Term.Apply (Term.Apply Term.and f) fs) => (__eo_mk_apply (Term.Apply Term.and (Term.Apply (Term.Apply Term.forall x) f)) (__mk_quant_miniscope_and x fs))
...
partial def __mk_dt_split : Term -> Term -> Term
  ...
  | (Term.Apply (Term.Apply Term.__eo_List_cons c) xs), x => (__eo_mk_apply (Term.Apply Term.or (Term.Apply (Term.Apply Term.is c) x)) (__mk_dt_split xs x))
  | _, _ => Term.Stuck
...
partial def __mk_dt_inst_tuple_rec : Term -> Term -> Term -> Term
  ...
  | (Term.Apply (Term.Apply Term.Tuple T1) T2), x, n => (__eo_mk_apply (Term.Apply Term.tuple (Term.Apply (Term.Apply Term.tuple_select n) x)) (__mk_dt_inst_tuple_rec T2 x (__eo_add n (Term.Numeral 1))))
  | _, _, _ => Term.Stuck
...
partial def __mk_dt_cons_eq : Term -> Term -> Term
  | Term.Stuck , _  => Term.Stuck
  | _ , Term.Stuck  => Term.Stuck
  | (Term.Apply (Term.Apply Term.tuple a) as), (Term.Apply (Term.Apply Term.tuple b) bs) => (__eo_mk_apply (Term.Apply Term.and (Term.Apply (Term.Apply Term.eq a) b)) (__mk_dt_cons_eq as bs))
...
partial def __eo_prog_dt_cycle : Term -> Term
  | (Term.Apply (Term.Apply Term.eq (Term.Apply (Term.Apply Term.eq s) t)) (Term.Boolean false)) => (__eo_requires (__dt_find_cycle t s (__is_cons_app t) (Term.Boolean false)) (Term.Boolean true) (Term.Apply (Term.Apply Term.eq (Term.Apply (Term.Apply Term.eq s) t)) (Term.Boolean false)))
  | _ => Term.Stuck
...
partial def __tuple_collapse_updater_rhs : Term -> Term -> Term -> Term
  ...
  | (Term.Apply (Term.Apply Term.tuple b) ts), a, n => (__eo_mk_apply (Term.Apply Term.tuple b) (__tuple_collapse_updater_rhs ts a (__eo_add n (Term.Numeral (-1 : native_Int)))))
...
partial def __eo_l_1___tuple_updater_elim_rhs : Term -> Term -> Term
  | (Term.Apply (Term.Apply (Term.Apply Term.tuple_update n) t) a), (Term.Apply (Term.Apply Term.__eo_List_cons s) ss) => (__eo_mk_apply (Term.Apply Term.tuple (Term.Apply s t)) (__tuple_updater_elim_rhs (Term.Apply (Term.Apply (Term.Apply Term.tuple_update n) t) a) ss))
...
partial def __tuple_updater_elim_rhs : Term -> Term -> Term
  ...
  | (Term.Apply (Term.Apply (Term.Apply Term.tuple_update n) t) a), (Term.Apply (Term.Apply Term.__eo_List_cons (Term.Apply Term.tuple_select __eo_lv_n_2)) ss) => 
    ...
    (__eo_ite (__eo_eq n __eo_lv_n_2) (__eo_mk_apply (Term.Apply Term.tuple a) (__tuple_updater_elim_rhs _v0 ss)) (__eo_l_1___tuple_updater_elim_rhs _v0 (Term.Apply (Term.Apply Term.__eo_List_cons (Term.Apply Term.tuple_select __eo_lv_n_2)) ss)))
...
partial def __run_evaluate : Term -> Term
  ...
  | (Term.Apply Term.str_to_code ssx) => 
    ...
    let _v1 := (__eo_len _v0)
    (__eo_ite (__eo_eq _v1 (Term.Numeral 1)) (__eo_to_z _v0) (__eo_ite (__eo_is_z _v1) (Term.Numeral (-1 : native_Int)) (__eo_mk_apply Term.str_to_code _v0)))
  | (Term.Apply Term.str_from_code n) => 
    let _v0 := (__run_evaluate n)
  ...
  | (Term.Apply Term.str_to_int ssx) => 
    let _v0 := (__run_evaluate ssx)
    (__eo_ite (__eo_is_str _v0) (__eo_ite (__eo_eq _v0 (Term.String "")) (Term.Numeral (-1 : native_Int)) (__str_to_int_eval_rec (__eo_list_rev Term.str_concat (__str_flatten (__str_nary_intro _v0))) (Term.Numeral 1) (Term.Numeral 0))) (__eo_mk_apply Term.str_to_int _v0))
  | (Term.Apply Term.str_from_int n) => 
    let _v0 := (__run_evaluate n)
  ...
  | (Term.Apply (Term.Apply Term.bvudiv xb) yb) => 
    ...
    (__eo_ite (__eo_eq (__eo_to_z _v0) (Term.Numeral 0)) (__eo_to_bin _v1 (__eo_add (__eo_ite (__eo_is_z _v1) (__eo_ite (__eo_is_neg _v1) (Term.Numeral 0) (__arith_eval_int_pow_2_rec _v1)) (__eo_mk_apply Term.int_pow2 _v1)) (Term.Numeral (-1 : native_Int)))) (__eo_zdiv (__run_evaluate xb) _v0))
  ...
  | (Term.Apply (Term.Apply Term.bvlshr xb) yb) => 
    let _v0 := (__eo_to_z (__run_evaluate yb))
    let _v1 := (__bv_bitwidth (__eo_typeof xb))
...
partial def __get_zero : Term -> Term
  ...
  | (Term.Apply (Term.Apply Term.bvor xb1) xb2) => 
    ...
    (__eo_to_bin _v0 (__eo_add (__eo_ite (__eo_is_z _v0) (__eo_ite (__eo_is_neg _v0) (Term.Numeral 0) (__arith_eval_int_pow_2_rec _v0)) (__eo_mk_apply Term.int_pow2 _v0)) (Term.Numeral (-1 : native_Int))))
