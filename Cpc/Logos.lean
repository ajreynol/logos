...
def __str_reduction_pred : Term -> Term
  ...
  | (Term.Apply (Term.Apply (Term.Apply (Term.UOp UserOp.str_replace_all) x) y) z) => 
    ...
    let _v9 := (Term.Apply (Term.UOp UserOp._at_strings_replace_all_result) _v8)
  ...
  | (Term.Apply (Term.Apply (Term.Apply (Term.UOp UserOp.str_replace_re_all) s) r) t) => 
    ...
    let _v3 := (Term.Apply (Term.UOp UserOp._at_strings_replace_all_result) _v2)
...
def __re_unfold_pos_concat_rec : Term -> Term -> Term -> Term -> Term
  ...
  | t, (Term.Apply (Term.Apply (Term.UOp UserOp.re_concat) r1) r2), ro, i => 
    let _v0 := (__re_unfold_pos_concat_rec t r2 ro (__eo_add i (Term.Numeral 1)))
    let _v1 := (Term.Apply (Term.Apply (Term.UOp1 UserOp1._at_re_unfold_pos_component i) t) ro)
...
def __eo_typeof__at_re_unfold_pos_component : Term -> Term -> Term -> Term
  | (Term.UOp UserOp.Int), (Term.Apply (Term.UOp UserOp.Seq) (Term.UOp UserOp.Char)), (Term.UOp UserOp.RegLan) => (Term.Apply (Term.UOp UserOp.Seq) (Term.UOp UserOp.Char))
  | _, _, _ => Term.Stuck
...
def __eo_typeof : Term -> Term
  ...
  | (Term.Apply (Term.Apply (Term.UOp UserOp._at_strings_replace_all_result) __eo_x1) __eo_x2) => (__eo_typeof_str_at (__eo_typeof __eo_x1) (__eo_typeof __eo_x2))
