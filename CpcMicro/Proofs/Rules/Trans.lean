...
/-- Shows that the transitivity helper only produces non-stuck EO terms. -/
...
/-- Expands the base transitivity constructor into an explicit equality. -/
...
/-- Provides the size decrease used in the recursive transitivity proof. -/
...
/-- Packages the properties needed for `cmd_step_trans`. -/
