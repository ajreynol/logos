...
| [`smt-lib-conformance.md`](smt-lib-conformance.md) | where the model semantics is narrower than SMT-LIB, what each narrowing costs, and what is refused outright |
