...
/- User operators with 1,2,... indexed arguments -/
...
The next constructor \code{Apply}
...
They are stratified based on the number of indexed arguments they have.\footnote{
