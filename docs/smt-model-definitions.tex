...
In other words, \code{(cons (Numeral 0) (Numeral 1) (default (Numeral 2)))}
...
for instance
\code{(cons (Numeral 0) (Numeral 1) (cons (Numeral 0) (Numeral 3) (default (Numeral 2))))}
...
\code{(cons (Numeral 0) (Numeral 1) (default (Numeral 0)))}
is also redundant.
...
e.g. \code{(const (Numeral 0) (Numeral 1) (default (Boolean true)))}
...
\subsection{Types for Values and Terms}
