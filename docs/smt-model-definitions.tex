...
\end{lstlisting}
\caption{The step-only rule-correctness theorem in \texttt{RuleLemmas.lean}; plain \texttt{CCmd.step} reasoning now uses local truth plus assumption stability, and rule proofs receive contextual premise evidence that is stable across variable-model changes.}
\end{figure}
