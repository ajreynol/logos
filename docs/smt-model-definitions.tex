...
\lstdefinelanguage{Lean}{
  ...
  morekeywords=[2]{
    ...
    Datatype, ObjectModel, ObjectTerm, Option, Prop, RefList, SmtDatatype,
    SmtDatatypeCons, SmtMap, SmtModel, SmtModelKey, SmtNativeFun, SmtSeq,
    SmtTerm, SmtType, SmtValue, Term, Type, native_Bool, native_Char,
    native_Int, native_Nat, native_Rat, native_RegLan, native_String
  },
  morekeywords=[3]{
    false, native_nat_succ, native_nat_zero, none, some, true
  },
  sensitive=true,
  morestring=[b]",
  morecomment=[l]{--},
