...
% Inline code for illustrative example snippets, styled distinctly from
% identifier references (\code) via a separate colour.
\definecolor{ExampleCode}{HTML}{0B6E4F}
\newcommand{\excode}[1]{\textcolor{ExampleCode}{\texttt{\detokenize{#1}}}}
...
\excode{(DtcAppType Int (DtcAppType (Datatype "list" D) (Datatype "list" D)))}
In detail, this type
