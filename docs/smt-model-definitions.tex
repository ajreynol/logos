...
take a datatype and replaces all references (\code{(SmtType.TypeRef s)}) in that datatype
...
Again, this behavior is arbtirary as we do not consider datatypes with nested 
